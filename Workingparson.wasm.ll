...
_Dynamic_check.succeeded5:                        ; preds = %sw.bb
  ...
  %17 = bitcast %Tstruct.Spl_json_value_t_t* %call6 to %Tstruct.Spl_json_value_t_t*
...
sw.bb7:                                           ; preds = %_Dynamic_check.succeeded2
  ...
  %19 = load i64, i64* %nesting.addr, align 8
  %add8 = add i64 %19, 1
  %20 = ptrtoint i8* %18 to i32
  %21 = call i8* @c_fetch_pointer_from_offset(i32 %20)
  %22 = call i1 @c_isTaintedPointerToTaintedMem(i8* %21)
  br i1 %22, label %_Dynamic_check.succeeded10, label %_Dynamic_check.failed9

_Dynamic_check.succeeded10:                       ; preds = %sw.bb7
  %call11 = call %Tstruct.Spl_json_value_t_t* bitcast (%Tstruct.Spl_json_value_t_t* (i8*, i64)* @parse_array_value to %Tstruct.Spl_json_value_t_t* (i8*, i64)*)(i8* %21, i64 %add8)
  %23 = bitcast %Tstruct.Spl_json_value_t_t* %call11 to %Tstruct.Spl_json_value_t_t*
...
_Dynamic_check.succeeded14:                       ; preds = %sw.bb12
  %call15 = call %Tstruct.Spl_json_value_t_t* bitcast (%Tstruct.json_value_t_t* (i8*, i8* (i8*, i64)*)* @parse_string_value to %Tstruct.Spl_json_value_t_t* (i8*, i8* (i8*, i64)*)*)(i8* %26, i8* (i8*, i64)* @process_string)
  %28 = bitcast %Tstruct.Spl_json_value_t_t* %call15 to %Tstruct.Spl_json_value_t_t*
...
_Dynamic_check.succeeded18:                       ; preds = %sw.bb16
  %call19 = call %Tstruct.Spl_json_value_t_t* bitcast (%Tstruct.json_value_t_t* (i8*)* @parse_boolean_value to %Tstruct.Spl_json_value_t_t* (i8*)*)(i8* %31)
  %33 = bitcast %Tstruct.Spl_json_value_t_t* %call19 to %Tstruct.Spl_json_value_t_t*
...
_Dynamic_check.succeeded22:                       ; preds = %sw.bb20
  %call23 = call %Tstruct.Spl_json_value_t_t* bitcast (%Tstruct.Spl_json_value_t_t* (i8*)* @parse_number_value to %Tstruct.Spl_json_value_t_t* (i8*)*)(i8* %36)
  %38 = bitcast %Tstruct.Spl_json_value_t_t* %call23 to %Tstruct.Spl_json_value_t_t*
...
sw.bb24:                                          ; preds = %_Dynamic_check.succeeded2
  ...
  %41 = call i8* @c_fetch_pointer_from_offset(i32 %40)
  %42 = call i1 @c_isTaintedPointerToTaintedMem(i8* %41)
  br i1 %42, label %_Dynamic_check.succeeded26, label %_Dynamic_check.failed25

_Dynamic_check.succeeded26:                       ; preds = %sw.bb24
  %call27 = call %Tstruct.Spl_json_value_t_t* bitcast (%Tstruct.json_value_t_t* (i8*)* @parse_null_value to %Tstruct.Spl_json_value_t_t* (i8*)*)(i8* %41)
  %43 = bitcast %Tstruct.Spl_json_value_t_t* %call27 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %43, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
return:                                           ; preds = %sw.default, %_Dynamic_check.succeeded26, %_Dynamic_check.succeeded22, %_Dynamic_check.succeeded18, %_Dynamic_check.succeeded14, %_Dynamic_check.succeeded10, %_Dynamic_check.succeeded5, %if.then
  %44 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %retval, align 4
  ret %Tstruct.Spl_json_value_t_t* %44
}
...
_Dynamic_check.succeeded2:                        ; preds = %sw.bb
  ...
  %12 = bitcast %Tstruct.json_array_t_t* %11 to %Tstruct.Spl_json_array_t_t*
  store %Tstruct.Spl_json_array_t_t* %12, %Tstruct.Spl_json_array_t_t** %array, align 4
  %13 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %array, align 4
...
_Dynamic_check.succeeded5:                        ; preds = %_Dynamic_check.succeeded2
  ...
  %call6 = call i64 bitcast (i64 (%Tstruct.Spl_json_array_t_t*)* @json_array_get_count to i64 (%Tstruct.Spl_json_array_t_t*)*)(%Tstruct.Spl_json_array_t_t* %17)
  store i64 %call6, i64* %count, align 8
  br label %do.body

do.body:                                          ; preds = %_Dynamic_check.succeeded5
  %18 = load i8*, i8** %buf.addr, align 4
  %19 = load i8*, i8** %buf_start.addr, align 4
  %20 = load i64, i64* %buf_len.addr, align 8
...
_Dynamic_check.succeeded8:                        ; preds = %do.body
  %24 = ptrtoint i8* %19 to i32
  %25 = call i8* @c_fetch_pointer_from_offset(i32 %24)
  %26 = call i1 @c_isTaintedPointerToTaintedMem(i8* %25)
  br i1 %26, label %_Dynamic_check.succeeded10, label %_Dynamic_check.failed9

_Dynamic_check.succeeded10:                       ; preds = %_Dynamic_check.succeeded8
  %call11 = call i32 @append_string(i8* %22, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* %25, i64 %20)
  store i32 %call11, i32* %written, align 4
  %27 = load i32, i32* %written, align 4
...
if.end14:                                         ; preds = %if.then13, %if.end
  %32 = load i32, i32* %written, align 4
  %33 = load i32, i32* %written_total, align 4
...
do.end:                                           ; preds = %if.end14
  ...
  %cmp15 = icmp ugt i64 %34, 0
  br i1 %cmp15, label %land.lhs.true, label %if.end33

land.lhs.true:                                    ; preds = %do.end
  %35 = load i32, i32* %is_pretty.addr, align 4
...
do.body17:                                        ; preds = %if.then16
  ...
  br i1 %41, label %_Dynamic_check.succeeded19, label %_Dynamic_check.failed18
...
_Dynamic_check.succeeded21:                       ; preds = %_Dynamic_check.succeeded19
  %call22 = call i32 @append_string(i8* %40, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0), i8* %43, i64 %38)
...
if.end30:                                         ; preds = %if.then27, %if.end25
  ...
  %51 = load i32, i32* %written_total, align 4
  %add31 = add nsw i32 %51, %50
...
for.cond:                                         ; preds = %for.inc, %if.end33
  ...
  %cmp34 = icmp ult i64 %52, %53
  br i1 %cmp34, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %54 = load i32, i32* %is_pretty.addr, align 4
...
do.body37:                                        ; preds = %if.then36
  ...
  br i1 %61, label %_Dynamic_check.succeeded40, label %_Dynamic_check.failed39
...
_Dynamic_check.succeeded40:                       ; preds = %do.body37
  ...
  br i1 %64, label %_Dynamic_check.succeeded42, label %_Dynamic_check.failed41

_Dynamic_check.succeeded42:                       ; preds = %_Dynamic_check.succeeded40
  %call43 = call i32 @append_indent(i8* %60, i32 %add38, i8* %63, i64 %58)
  store i32 %call43, i32* %written, align 4
  %65 = load i32, i32* %written, align 4
  %cmp44 = icmp slt i32 %65, 0
...
if.end51:                                         ; preds = %if.then48, %if.end46
  ...
  %71 = load i32, i32* %written_total, align 4
  %add52 = add nsw i32 %71, %70
...
if.end54:                                         ; preds = %do.end53, %for.body
  %72 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %array, align 4
  %73 = load i64, i64* %i, align 8
  %74 = ptrtoint %Tstruct.Spl_json_array_t_t* %72 to i32
  %75 = call i8* @c_fetch_pointer_from_offset(i32 %74)
  %76 = call i1 @c_isTaintedPointerToTaintedMem(i8* %75)
  br i1 %76, label %_Dynamic_check.succeeded56, label %_Dynamic_check.failed55

_Dynamic_check.succeeded56:                       ; preds = %if.end54
  %77 = bitcast i8* %75 to %Tstruct.Spl_json_array_t_t*
  %call57 = call %Tstruct.Spl_json_value_t_t* bitcast (%Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_array_t_t*, i64)* @json_array_get_value to %Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_array_t_t*, i64)*)(%Tstruct.Spl_json_array_t_t* %77, i64 %73)
  %78 = bitcast %Tstruct.Spl_json_value_t_t* %call57 to %Tstruct.json_value_t_t*
  %79 = bitcast %Tstruct.json_value_t_t* %78 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %79, %Tstruct.Spl_json_value_t_t** %temp_value, align 4
  ...
  %add58 = add nsw i32 %82, 1
  %83 = load i32, i32* %is_pretty.addr, align 4
  %84 = load i8*, i8** %num_buf.addr, align 4
  %85 = load i8*, i8** %buf_start.addr, align 4
  %86 = load i64, i64* %buf_len.addr, align 8
  %87 = ptrtoint %Tstruct.Spl_json_value_t_t* %80 to i32
  %88 = call i8* @c_fetch_pointer_from_offset(i32 %87)
  %89 = call i1 @c_isTaintedPointerToTaintedMem(i8* %88)
  br i1 %89, label %_Dynamic_check.succeeded60, label %_Dynamic_check.failed59

_Dynamic_check.succeeded60:                       ; preds = %_Dynamic_check.succeeded56
  %90 = bitcast i8* %88 to %Tstruct.Spl_json_value_t_t*
  %91 = ptrtoint i8* %81 to i32
  %92 = call i8* @c_fetch_pointer_from_offset(i32 %91)
  %93 = call i1 @c_isTaintedPointerToTaintedMem(i8* %92)
  br i1 %93, label %_Dynamic_check.succeeded62, label %_Dynamic_check.failed61

_Dynamic_check.succeeded62:                       ; preds = %_Dynamic_check.succeeded60
  %94 = ptrtoint i8* %84 to i32
  %95 = call i8* @c_fetch_pointer_from_offset(i32 %94)
  %96 = call i1 @c_isTaintedPointerToTaintedMem(i8* %95)
  br i1 %96, label %_Dynamic_check.succeeded64, label %_Dynamic_check.failed63

_Dynamic_check.succeeded64:                       ; preds = %_Dynamic_check.succeeded62
  %97 = ptrtoint i8* %85 to i32
...
_Dynamic_check.succeeded66:                       ; preds = %_Dynamic_check.succeeded64
  %call67 = call i32 @json_serialize_to_buffer_r(%Tstruct.Spl_json_value_t_t* %90, i8* %92, i32 %add58, i32 %83, i8* %95, i8* %98, i64 %86)
  store i32 %call67, i32* %written, align 4
  %100 = load i32, i32* %written, align 4
  %cmp68 = icmp slt i32 %100, 0
...
if.end70:                                         ; preds = %_Dynamic_check.succeeded66
  %101 = load i8*, i8** %buf.addr, align 4
  %102 = ptrtoint i8* %101 to i32
  %cmp71 = icmp ne i32 %102, 0
  br i1 %cmp71, label %if.then72, label %if.end75

if.then72:                                        ; preds = %if.end70
  %103 = load i32, i32* %written, align 4
  %104 = load i8*, i8** %buf.addr, align 4
  %idx.ext73 = sext i32 %103 to i64
...
if.end75:                                         ; preds = %if.then72, %if.end70
  %105 = load i32, i32* %written, align 4
  %106 = load i32, i32* %written_total, align 4
  %add76 = add nsw i32 %106, %105
  store i32 %add76, i32* %written_total, align 4
  %107 = load i64, i64* %i, align 8
  %108 = load i64, i64* %count, align 8
  %sub = sub i64 %108, 1
  %cmp77 = icmp ult i64 %107, %sub
...
do.body79:                                        ; preds = %if.then78
  %109 = load i8*, i8** %buf.addr, align 4
  %110 = load i8*, i8** %buf_start.addr, align 4
  %111 = load i64, i64* %buf_len.addr, align 8
  %112 = ptrtoint i8* %109 to i32
  %113 = call i8* @c_fetch_pointer_from_offset(i32 %112)
  %114 = call i1 @c_isTaintedPointerToTaintedMem(i8* %113)
  br i1 %114, label %_Dynamic_check.succeeded81, label %_Dynamic_check.failed80
...
_Dynamic_check.succeeded81:                       ; preds = %do.body79
  ...
  br i1 %117, label %_Dynamic_check.succeeded83, label %_Dynamic_check.failed82

_Dynamic_check.succeeded83:                       ; preds = %_Dynamic_check.succeeded81
  %call84 = call i32 @append_string(i8* %113, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0), i8* %116, i64 %111)
  store i32 %call84, i32* %written, align 4
  %118 = load i32, i32* %written, align 4
  %cmp85 = icmp slt i32 %118, 0
...
if.end87:                                         ; preds = %_Dynamic_check.succeeded83
  ...
  %cmp88 = icmp ne i32 %120, 0
  br i1 %cmp88, label %if.then89, label %if.end92

if.then89:                                        ; preds = %if.end87
  %121 = load i32, i32* %written, align 4
  %122 = load i8*, i8** %buf.addr, align 4
  %idx.ext90 = sext i32 %121 to i64
  %add.ptr91 = getelementptr inbounds i8, i8* %122, i64 %idx.ext90
  store i8* %add.ptr91, i8** %buf.addr, align 4
  br label %if.end92

if.end92:                                         ; preds = %if.then89, %if.end87
  %123 = load i32, i32* %written, align 4
  %124 = load i32, i32* %written_total, align 4
  %add93 = add nsw i32 %124, %123
...
if.end95:                                         ; preds = %do.end94, %if.end75
  %125 = load i32, i32* %is_pretty.addr, align 4
  %tobool96 = icmp ne i32 %125, 0
...
do.body98:                                        ; preds = %if.then97
  ...
  %127 = load i8*, i8** %buf_start.addr, align 4
  %128 = load i64, i64* %buf_len.addr, align 8
  %129 = ptrtoint i8* %126 to i32
...
_Dynamic_check.succeeded100:                      ; preds = %do.body98
  %132 = ptrtoint i8* %127 to i32
  %133 = call i8* @c_fetch_pointer_from_offset(i32 %132)
  %134 = call i1 @c_isTaintedPointerToTaintedMem(i8* %133)
  br i1 %134, label %_Dynamic_check.succeeded102, label %_Dynamic_check.failed101

_Dynamic_check.succeeded102:                      ; preds = %_Dynamic_check.succeeded100
  %call103 = call i32 @append_string(i8* %130, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0), i8* %133, i64 %128)
  store i32 %call103, i32* %written, align 4
  %135 = load i32, i32* %written, align 4
  %cmp104 = icmp slt i32 %135, 0
...
if.end106:                                        ; preds = %_Dynamic_check.succeeded102
  %136 = load i8*, i8** %buf.addr, align 4
  %137 = ptrtoint i8* %136 to i32
  %cmp107 = icmp ne i32 %137, 0
  br i1 %cmp107, label %if.then108, label %if.end111

if.then108:                                       ; preds = %if.end106
  %138 = load i32, i32* %written, align 4
  %139 = load i8*, i8** %buf.addr, align 4
  %idx.ext109 = sext i32 %138 to i64
  %add.ptr110 = getelementptr inbounds i8, i8* %139, i64 %idx.ext109
  store i8* %add.ptr110, i8** %buf.addr, align 4
  br label %if.end111

if.end111:                                        ; preds = %if.then108, %if.end106
  %140 = load i32, i32* %written, align 4
  %141 = load i32, i32* %written_total, align 4
  %add112 = add nsw i32 %141, %140
...
for.end:                                          ; preds = %for.cond
  %143 = load i64, i64* %count, align 8
  %cmp115 = icmp ugt i64 %143, 0
  br i1 %cmp115, label %land.lhs.true116, label %if.end135

land.lhs.true116:                                 ; preds = %for.end
  %144 = load i32, i32* %is_pretty.addr, align 4
  %tobool117 = icmp ne i32 %144, 0
...
_Dynamic_check.succeeded121:                      ; preds = %do.body119
  ...
  br i1 %154, label %_Dynamic_check.succeeded123, label %_Dynamic_check.failed122

_Dynamic_check.succeeded123:                      ; preds = %_Dynamic_check.succeeded121
  %call124 = call i32 @append_indent(i8* %150, i32 %146, i8* %153, i64 %148)
  store i32 %call124, i32* %written, align 4
  %155 = load i32, i32* %written, align 4
  %cmp125 = icmp slt i32 %155, 0
...
if.end127:                                        ; preds = %_Dynamic_check.succeeded123
  ...
  %cmp128 = icmp ne i32 %157, 0
  br i1 %cmp128, label %if.then129, label %if.end132

if.then129:                                       ; preds = %if.end127
  %158 = load i32, i32* %written, align 4
  %159 = load i8*, i8** %buf.addr, align 4
  %idx.ext130 = sext i32 %158 to i64
  %add.ptr131 = getelementptr inbounds i8, i8* %159, i64 %idx.ext130
...
do.body136:                                       ; preds = %if.end135
  ...
  br i1 %167, label %_Dynamic_check.succeeded138, label %_Dynamic_check.failed137
...
_Dynamic_check.succeeded138:                      ; preds = %do.body136
  ...
  br i1 %170, label %_Dynamic_check.succeeded140, label %_Dynamic_check.failed139

_Dynamic_check.succeeded140:                      ; preds = %_Dynamic_check.succeeded138
  %call141 = call i32 @append_string(i8* %166, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0), i8* %169, i64 %164)
  store i32 %call141, i32* %written, align 4
  %171 = load i32, i32* %written, align 4
  %cmp142 = icmp slt i32 %171, 0
...
if.end144:                                        ; preds = %_Dynamic_check.succeeded140
  ...
  %cmp145 = icmp ne i32 %173, 0
  br i1 %cmp145, label %if.then146, label %if.end149

if.then146:                                       ; preds = %if.end144
  %174 = load i32, i32* %written, align 4
  %175 = load i8*, i8** %buf.addr, align 4
  %idx.ext147 = sext i32 %174 to i64
  %add.ptr148 = getelementptr inbounds i8, i8* %175, i64 %idx.ext147
...
sw.bb152:                                         ; preds = %_Dynamic_check.succeeded
  %179 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value.addr, align 4
  %180 = ptrtoint %Tstruct.Spl_json_value_t_t* %179 to i32
  %181 = call i8* @c_fetch_pointer_from_offset(i32 %180)
  %182 = call i1 @c_isTaintedPointerToTaintedMem(i8* %181)
  br i1 %182, label %_Dynamic_check.succeeded154, label %_Dynamic_check.failed153

_Dynamic_check.succeeded154:                      ; preds = %sw.bb152
  %183 = bitcast i8* %181 to %Tstruct.Spl_json_value_t_t*
  %call155 = call %Tstruct.Spl_json_object_t_t* bitcast (%Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_object to %Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %183)
  %184 = bitcast %Tstruct.Spl_json_object_t_t* %call155 to %Tstruct.json_object_t_t*
  %185 = bitcast %Tstruct.json_object_t_t* %184 to %Tstruct.Spl_json_object_t_t*
  store %Tstruct.Spl_json_object_t_t* %185, %Tstruct.Spl_json_object_t_t** %object, align 4
  %186 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %object, align 4
  %187 = ptrtoint %Tstruct.Spl_json_object_t_t* %186 to i32
...
_Dynamic_check.succeeded157:                      ; preds = %_Dynamic_check.succeeded154
  %190 = bitcast i8* %188 to %Tstruct.Spl_json_object_t_t*
  %call158 = call i64 bitcast (i64 (%Tstruct.Spl_json_object_t_t*)* @json_object_get_count to i64 (%Tstruct.Spl_json_object_t_t*)*)(%Tstruct.Spl_json_object_t_t* %190)
...
do.body159:                                       ; preds = %_Dynamic_check.succeeded157
  ...
  br i1 %196, label %_Dynamic_check.succeeded161, label %_Dynamic_check.failed160
...
_Dynamic_check.succeeded161:                      ; preds = %do.body159
  ...
  br i1 %199, label %_Dynamic_check.succeeded163, label %_Dynamic_check.failed162

_Dynamic_check.succeeded163:                      ; preds = %_Dynamic_check.succeeded161
  %call164 = call i32 @append_string(i8* %195, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0), i8* %198, i64 %193)
  store i32 %call164, i32* %written, align 4
  %200 = load i32, i32* %written, align 4
  %cmp165 = icmp slt i32 %200, 0
...
if.end167:                                        ; preds = %_Dynamic_check.succeeded163
  %201 = load i8*, i8** %buf.addr, align 4
  %202 = ptrtoint i8* %201 to i32
  %cmp168 = icmp ne i32 %202, 0
  br i1 %cmp168, label %if.then169, label %if.end172

if.then169:                                       ; preds = %if.end167
  %203 = load i32, i32* %written, align 4
  %204 = load i8*, i8** %buf.addr, align 4
  %idx.ext170 = sext i32 %203 to i64
  %add.ptr171 = getelementptr inbounds i8, i8* %204, i64 %idx.ext170
...
if.end187:                                        ; preds = %_Dynamic_check.succeeded183
  ...
  %cmp188 = icmp ne i32 %220, 0
  br i1 %cmp188, label %if.then189, label %if.end192

if.then189:                                       ; preds = %if.end187
  %221 = load i32, i32* %written, align 4
  %222 = load i8*, i8** %buf.addr, align 4
  %idx.ext190 = sext i32 %221 to i64
  %add.ptr191 = getelementptr inbounds i8, i8* %222, i64 %idx.ext190
...
for.body198:                                      ; preds = %for.cond196
  ...
  %229 = ptrtoint %Tstruct.Spl_json_object_t_t* %227 to i32
...
_Dynamic_check.succeeded200:                      ; preds = %for.body198
  %232 = bitcast i8* %230 to %Tstruct.Spl_json_object_t_t*
  %call201 = call i8* bitcast (i8* (%Tstruct.Spl_json_object_t_t*, i64)* @json_object_get_name to i8* (%Tstruct.Spl_json_object_t_t*, i64)*)(%Tstruct.Spl_json_object_t_t* %232, i64 %228)
  store i8* %call201, i8** %key, align 4
  %233 = load i8*, i8** %key, align 4
...
if.end204:                                        ; preds = %_Dynamic_check.succeeded200
  %235 = load i32, i32* %is_pretty.addr, align 4
  %tobool205 = icmp ne i32 %235, 0
...
do.body207:                                       ; preds = %if.then206
  ...
  %237 = load i32, i32* %level.addr, align 4
  %add208 = add nsw i32 %237, 1
  %238 = load i8*, i8** %buf_start.addr, align 4
  %239 = load i64, i64* %buf_len.addr, align 8
  %240 = ptrtoint i8* %236 to i32
  %241 = call i8* @c_fetch_pointer_from_offset(i32 %240)
  %242 = call i1 @c_isTaintedPointerToTaintedMem(i8* %241)
  br i1 %242, label %_Dynamic_check.succeeded210, label %_Dynamic_check.failed209
...
_Dynamic_check.succeeded210:                      ; preds = %do.body207
  ...
  br i1 %245, label %_Dynamic_check.succeeded212, label %_Dynamic_check.failed211

_Dynamic_check.succeeded212:                      ; preds = %_Dynamic_check.succeeded210
  %call213 = call i32 @append_indent(i8* %241, i32 %add208, i8* %244, i64 %239)
...
if.end224:                                        ; preds = %do.end223, %if.end204
  %253 = load i8*, i8** %key, align 4
  %254 = load i8*, i8** %buf.addr, align 4
  %255 = load i8*, i8** %buf_start.addr, align 4
  %256 = load i64, i64* %buf_len.addr, align 8
  %257 = ptrtoint i8* %253 to i32
  %258 = call i8* @c_fetch_pointer_from_offset(i32 %257)
  %259 = call i1 @c_isTaintedPointerToTaintedMem(i8* %258)
  br i1 %259, label %_Dynamic_check.succeeded226, label %_Dynamic_check.failed225

_Dynamic_check.succeeded226:                      ; preds = %if.end224
  %260 = ptrtoint i8* %254 to i32
  %261 = call i8* @c_fetch_pointer_from_offset(i32 %260)
  %262 = call i1 @c_isTaintedPointerToTaintedMem(i8* %261)
  br i1 %262, label %_Dynamic_check.succeeded228, label %_Dynamic_check.failed227

_Dynamic_check.succeeded228:                      ; preds = %_Dynamic_check.succeeded226
  %263 = ptrtoint i8* %255 to i32
...
_Dynamic_check.succeeded230:                      ; preds = %_Dynamic_check.succeeded228
  %call231 = call i32 @json_serialize_string(i8* %258, i8* %261, i8* %264, i64 %256)
  store i32 %call231, i32* %written, align 4
  %266 = load i32, i32* %written, align 4
  %cmp232 = icmp slt i32 %266, 0
...
if.end234:                                        ; preds = %_Dynamic_check.succeeded230
  ...
  %cmp235 = icmp ne i32 %268, 0
  br i1 %cmp235, label %if.then236, label %if.end239

if.then236:                                       ; preds = %if.end234
  %269 = load i32, i32* %written, align 4
  %270 = load i8*, i8** %buf.addr, align 4
  %idx.ext237 = sext i32 %269 to i64
  %add.ptr238 = getelementptr inbounds i8, i8* %270, i64 %idx.ext237
...
if.end239:                                        ; preds = %if.then236, %if.end234
  ...
  %add240 = add nsw i32 %272, %271
  store i32 %add240, i32* %written_total, align 4
  br label %do.body241

do.body241:                                       ; preds = %if.end239
  %273 = load i8*, i8** %buf.addr, align 4
  %274 = load i8*, i8** %buf_start.addr, align 4
  %275 = load i64, i64* %buf_len.addr, align 8
  %276 = ptrtoint i8* %273 to i32
  %277 = call i8* @c_fetch_pointer_from_offset(i32 %276)
  %278 = call i1 @c_isTaintedPointerToTaintedMem(i8* %277)
  br i1 %278, label %_Dynamic_check.succeeded243, label %_Dynamic_check.failed242

_Dynamic_check.succeeded243:                      ; preds = %do.body241
  %279 = ptrtoint i8* %274 to i32
...
_Dynamic_check.succeeded245:                      ; preds = %_Dynamic_check.succeeded243
  %call246 = call i32 @append_string(i8* %277, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i64 0, i64 0), i8* %280, i64 %275)
  store i32 %call246, i32* %written, align 4
  %282 = load i32, i32* %written, align 4
  %cmp247 = icmp slt i32 %282, 0
...
if.end249:                                        ; preds = %_Dynamic_check.succeeded245
  ...
  %cmp250 = icmp ne i32 %284, 0
  br i1 %cmp250, label %if.then251, label %if.end254

if.then251:                                       ; preds = %if.end249
  %285 = load i32, i32* %written, align 4
  %286 = load i8*, i8** %buf.addr, align 4
  %idx.ext252 = sext i32 %285 to i64
  %add.ptr253 = getelementptr inbounds i8, i8* %286, i64 %idx.ext252
  store i8* %add.ptr253, i8** %buf.addr, align 4
  br label %if.end254

if.end254:                                        ; preds = %if.then251, %if.end249
  %287 = load i32, i32* %written, align 4
  %288 = load i32, i32* %written_total, align 4
  %add255 = add nsw i32 %288, %287
  store i32 %add255, i32* %written_total, align 4
  br label %do.end256

do.end256:                                        ; preds = %if.end254
  %289 = load i32, i32* %is_pretty.addr, align 4
  %tobool257 = icmp ne i32 %289, 0
...
if.end267:                                        ; preds = %_Dynamic_check.succeeded263
  ...
  %cmp268 = icmp ne i32 %301, 0
  br i1 %cmp268, label %if.then269, label %if.end272

if.then269:                                       ; preds = %if.end267
  %302 = load i32, i32* %written, align 4
  %303 = load i8*, i8** %buf.addr, align 4
  %idx.ext270 = sext i32 %302 to i64
  %add.ptr271 = getelementptr inbounds i8, i8* %303, i64 %idx.ext270
...
if.end275:                                        ; preds = %do.end274, %do.end256
  %306 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %object, align 4
  %307 = load i8*, i8** %key, align 4
  %308 = ptrtoint %Tstruct.Spl_json_object_t_t* %306 to i32
  %309 = call i8* @c_fetch_pointer_from_offset(i32 %308)
  %310 = call i1 @c_isTaintedPointerToTaintedMem(i8* %309)
  br i1 %310, label %_Dynamic_check.succeeded277, label %_Dynamic_check.failed276

_Dynamic_check.succeeded277:                      ; preds = %if.end275
  %311 = bitcast i8* %309 to %Tstruct.Spl_json_object_t_t*
  %312 = ptrtoint i8* %307 to i32
  %313 = call i8* @c_fetch_pointer_from_offset(i32 %312)
  %314 = call i1 @c_isTaintedPointerToTaintedMem(i8* %313)
  br i1 %314, label %_Dynamic_check.succeeded279, label %_Dynamic_check.failed278

_Dynamic_check.succeeded279:                      ; preds = %_Dynamic_check.succeeded277
  %call280 = call %Tstruct.Spl_json_value_t_t* bitcast (%Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_object_t_t*, i8*)* @json_object_get_value to %Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_object_t_t*, i8*)*)(%Tstruct.Spl_json_object_t_t* %311, i8* %313)
  %315 = bitcast %Tstruct.Spl_json_value_t_t* %call280 to %Tstruct.json_value_t_t*
  %316 = bitcast %Tstruct.json_value_t_t* %315 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %316, %Tstruct.Spl_json_value_t_t** %temp_value, align 4
  %317 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %temp_value, align 4
  %318 = load i8*, i8** %buf.addr, align 4
  %319 = load i32, i32* %level.addr, align 4
  %add281 = add nsw i32 %319, 1
  %320 = load i32, i32* %is_pretty.addr, align 4
  %321 = load i8*, i8** %num_buf.addr, align 4
  %322 = load i8*, i8** %buf_start.addr, align 4
  %323 = load i64, i64* %buf_len.addr, align 8
  %324 = ptrtoint %Tstruct.Spl_json_value_t_t* %317 to i32
  %325 = call i8* @c_fetch_pointer_from_offset(i32 %324)
  %326 = call i1 @c_isTaintedPointerToTaintedMem(i8* %325)
  br i1 %326, label %_Dynamic_check.succeeded283, label %_Dynamic_check.failed282

_Dynamic_check.succeeded283:                      ; preds = %_Dynamic_check.succeeded279
  %327 = bitcast i8* %325 to %Tstruct.Spl_json_value_t_t*
  %328 = ptrtoint i8* %318 to i32
  %329 = call i8* @c_fetch_pointer_from_offset(i32 %328)
  %330 = call i1 @c_isTaintedPointerToTaintedMem(i8* %329)
  br i1 %330, label %_Dynamic_check.succeeded285, label %_Dynamic_check.failed284

_Dynamic_check.succeeded285:                      ; preds = %_Dynamic_check.succeeded283
  %331 = ptrtoint i8* %321 to i32
  %332 = call i8* @c_fetch_pointer_from_offset(i32 %331)
  %333 = call i1 @c_isTaintedPointerToTaintedMem(i8* %332)
  br i1 %333, label %_Dynamic_check.succeeded287, label %_Dynamic_check.failed286

_Dynamic_check.succeeded287:                      ; preds = %_Dynamic_check.succeeded285
  %334 = ptrtoint i8* %322 to i32
  %335 = call i8* @c_fetch_pointer_from_offset(i32 %334)
  %336 = call i1 @c_isTaintedPointerToTaintedMem(i8* %335)
  br i1 %336, label %_Dynamic_check.succeeded289, label %_Dynamic_check.failed288

_Dynamic_check.succeeded289:                      ; preds = %_Dynamic_check.succeeded287
  %call290 = call i32 @json_serialize_to_buffer_r(%Tstruct.Spl_json_value_t_t* %327, i8* %329, i32 %add281, i32 %320, i8* %332, i8* %335, i64 %323)
  store i32 %call290, i32* %written, align 4
  %337 = load i32, i32* %written, align 4
  %cmp291 = icmp slt i32 %337, 0
...
if.end293:                                        ; preds = %_Dynamic_check.succeeded289
  ...
  %cmp294 = icmp ne i32 %339, 0
  br i1 %cmp294, label %if.then295, label %if.end298

if.then295:                                       ; preds = %if.end293
  %340 = load i32, i32* %written, align 4
  %341 = load i8*, i8** %buf.addr, align 4
  %idx.ext296 = sext i32 %340 to i64
  %add.ptr297 = getelementptr inbounds i8, i8* %341, i64 %idx.ext296
  store i8* %add.ptr297, i8** %buf.addr, align 4
  br label %if.end298

if.end298:                                        ; preds = %if.then295, %if.end293
  %342 = load i32, i32* %written, align 4
  %343 = load i32, i32* %written_total, align 4
  %add299 = add nsw i32 %343, %342
  store i32 %add299, i32* %written_total, align 4
  %344 = load i64, i64* %i, align 8
  %345 = load i64, i64* %count, align 8
  %sub300 = sub i64 %345, 1
  %cmp301 = icmp ult i64 %344, %sub300
...
do.body303:                                       ; preds = %if.then302
  %346 = load i8*, i8** %buf.addr, align 4
  %347 = load i8*, i8** %buf_start.addr, align 4
  %348 = load i64, i64* %buf_len.addr, align 8
  %349 = ptrtoint i8* %346 to i32
  %350 = call i8* @c_fetch_pointer_from_offset(i32 %349)
  %351 = call i1 @c_isTaintedPointerToTaintedMem(i8* %350)
  br i1 %351, label %_Dynamic_check.succeeded305, label %_Dynamic_check.failed304
...
_Dynamic_check.succeeded307:                      ; preds = %_Dynamic_check.succeeded305
  %call308 = call i32 @append_string(i8* %350, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0), i8* %353, i64 %348)
  store i32 %call308, i32* %written, align 4
  %355 = load i32, i32* %written, align 4
  %cmp309 = icmp slt i32 %355, 0
...
if.end311:                                        ; preds = %_Dynamic_check.succeeded307
  %356 = load i8*, i8** %buf.addr, align 4
  %357 = ptrtoint i8* %356 to i32
  %cmp312 = icmp ne i32 %357, 0
...
if.then313:                                       ; preds = %if.end311
  ...
  %idx.ext314 = sext i32 %358 to i64
  %add.ptr315 = getelementptr inbounds i8, i8* %359, i64 %idx.ext314
  store i8* %add.ptr315, i8** %buf.addr, align 4
  br label %if.end316

if.end316:                                        ; preds = %if.then313, %if.end311
  %360 = load i32, i32* %written, align 4
  %361 = load i32, i32* %written_total, align 4
  %add317 = add nsw i32 %361, %360
...
if.end319:                                        ; preds = %do.end318, %if.end298
  %362 = load i32, i32* %is_pretty.addr, align 4
  %tobool320 = icmp ne i32 %362, 0
...
do.body322:                                       ; preds = %if.then321
  ...
  %364 = load i8*, i8** %buf_start.addr, align 4
  %365 = load i64, i64* %buf_len.addr, align 8
  %366 = ptrtoint i8* %363 to i32
  %367 = call i8* @c_fetch_pointer_from_offset(i32 %366)
  %368 = call i1 @c_isTaintedPointerToTaintedMem(i8* %367)
  br i1 %368, label %_Dynamic_check.succeeded324, label %_Dynamic_check.failed323
...
_Dynamic_check.succeeded324:                      ; preds = %do.body322
  ...
  br i1 %371, label %_Dynamic_check.succeeded326, label %_Dynamic_check.failed325

_Dynamic_check.succeeded326:                      ; preds = %_Dynamic_check.succeeded324
  %call327 = call i32 @append_string(i8* %367, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0), i8* %370, i64 %365)
  store i32 %call327, i32* %written, align 4
  %372 = load i32, i32* %written, align 4
  %cmp328 = icmp slt i32 %372, 0
...
if.end330:                                        ; preds = %_Dynamic_check.succeeded326
  %373 = load i8*, i8** %buf.addr, align 4
  %374 = ptrtoint i8* %373 to i32
  %cmp331 = icmp ne i32 %374, 0
  br i1 %cmp331, label %if.then332, label %if.end335

if.then332:                                       ; preds = %if.end330
  %375 = load i32, i32* %written, align 4
  %376 = load i8*, i8** %buf.addr, align 4
  %idx.ext333 = sext i32 %375 to i64
  %add.ptr334 = getelementptr inbounds i8, i8* %376, i64 %idx.ext333
  store i8* %add.ptr334, i8** %buf.addr, align 4
  br label %if.end335

if.end335:                                        ; preds = %if.then332, %if.end330
  %377 = load i32, i32* %written, align 4
  %378 = load i32, i32* %written_total, align 4
  %add336 = add nsw i32 %378, %377
...
do.body346:                                       ; preds = %if.then345
  %382 = load i8*, i8** %buf.addr, align 4
  %383 = load i32, i32* %level.addr, align 4
  %384 = load i8*, i8** %buf_start.addr, align 4
  %385 = load i64, i64* %buf_len.addr, align 8
  %386 = ptrtoint i8* %382 to i32
  %387 = call i8* @c_fetch_pointer_from_offset(i32 %386)
  %388 = call i1 @c_isTaintedPointerToTaintedMem(i8* %387)
  br i1 %388, label %_Dynamic_check.succeeded348, label %_Dynamic_check.failed347

_Dynamic_check.succeeded348:                      ; preds = %do.body346
  %389 = ptrtoint i8* %384 to i32
  %390 = call i8* @c_fetch_pointer_from_offset(i32 %389)
  %391 = call i1 @c_isTaintedPointerToTaintedMem(i8* %390)
  br i1 %391, label %_Dynamic_check.succeeded350, label %_Dynamic_check.failed349

_Dynamic_check.succeeded350:                      ; preds = %_Dynamic_check.succeeded348
  %call351 = call i32 @append_indent(i8* %387, i32 %383, i8* %390, i64 %385)
  store i32 %call351, i32* %written, align 4
  %392 = load i32, i32* %written, align 4
  %cmp352 = icmp slt i32 %392, 0
...
if.end354:                                        ; preds = %_Dynamic_check.succeeded350
  %393 = load i8*, i8** %buf.addr, align 4
  %394 = ptrtoint i8* %393 to i32
  %cmp355 = icmp ne i32 %394, 0
...
if.then356:                                       ; preds = %if.end354
  ...
  %idx.ext357 = sext i32 %395 to i64
  %add.ptr358 = getelementptr inbounds i8, i8* %396, i64 %idx.ext357
  store i8* %add.ptr358, i8** %buf.addr, align 4
  br label %if.end359

if.end359:                                        ; preds = %if.then356, %if.end354
  %397 = load i32, i32* %written, align 4
  %398 = load i32, i32* %written_total, align 4
  %add360 = add nsw i32 %398, %397
...
do.body363:                                       ; preds = %if.end362
  %399 = load i8*, i8** %buf.addr, align 4
  %400 = load i8*, i8** %buf_start.addr, align 4
  %401 = load i64, i64* %buf_len.addr, align 8
  %402 = ptrtoint i8* %399 to i32
  %403 = call i8* @c_fetch_pointer_from_offset(i32 %402)
  %404 = call i1 @c_isTaintedPointerToTaintedMem(i8* %403)
  br i1 %404, label %_Dynamic_check.succeeded365, label %_Dynamic_check.failed364

_Dynamic_check.succeeded365:                      ; preds = %do.body363
  %405 = ptrtoint i8* %400 to i32
  %406 = call i8* @c_fetch_pointer_from_offset(i32 %405)
  %407 = call i1 @c_isTaintedPointerToTaintedMem(i8* %406)
  br i1 %407, label %_Dynamic_check.succeeded367, label %_Dynamic_check.failed366

_Dynamic_check.succeeded367:                      ; preds = %_Dynamic_check.succeeded365
  %call368 = call i32 @append_string(i8* %403, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i64 0, i64 0), i8* %406, i64 %401)
  store i32 %call368, i32* %written, align 4
  %408 = load i32, i32* %written, align 4
  %cmp369 = icmp slt i32 %408, 0
...
if.end371:                                        ; preds = %_Dynamic_check.succeeded367
  %409 = load i8*, i8** %buf.addr, align 4
  %410 = ptrtoint i8* %409 to i32
  %cmp372 = icmp ne i32 %410, 0
...
if.then373:                                       ; preds = %if.end371
  ...
  %idx.ext374 = sext i32 %411 to i64
  %add.ptr375 = getelementptr inbounds i8, i8* %412, i64 %idx.ext374
  store i8* %add.ptr375, i8** %buf.addr, align 4
  br label %if.end376

if.end376:                                        ; preds = %if.then373, %if.end371
  %413 = load i32, i32* %written, align 4
  %414 = load i32, i32* %written_total, align 4
  %add377 = add nsw i32 %414, %413
  store i32 %add377, i32* %written_total, align 4
  br label %do.end378

do.end378:                                        ; preds = %if.end376
  %415 = load i32, i32* %written_total, align 4
  store i32 %415, i32* %retval, align 4
  br label %return

sw.bb379:                                         ; preds = %_Dynamic_check.succeeded
  %416 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value.addr, align 4
  %417 = ptrtoint %Tstruct.Spl_json_value_t_t* %416 to i32
  %418 = call i8* @c_fetch_pointer_from_offset(i32 %417)
  %419 = call i1 @c_isTaintedPointerToTaintedMem(i8* %418)
  br i1 %419, label %_Dynamic_check.succeeded381, label %_Dynamic_check.failed380

_Dynamic_check.succeeded381:                      ; preds = %sw.bb379
  %420 = bitcast i8* %418 to %Tstruct.Spl_json_value_t_t*
  %call382 = call i8* bitcast (i8* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_string to i8* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %420)
  store i8* %call382, i8** %string, align 4
  %421 = load i8*, i8** %string, align 4
...
if.end385:                                        ; preds = %_Dynamic_check.succeeded381
  %423 = load i8*, i8** %string, align 4
  %424 = load i8*, i8** %buf.addr, align 4
  %425 = load i8*, i8** %buf_start.addr, align 4
  %426 = load i64, i64* %buf_len.addr, align 8
  %427 = ptrtoint i8* %423 to i32
  %428 = call i8* @c_fetch_pointer_from_offset(i32 %427)
  %429 = call i1 @c_isTaintedPointerToTaintedMem(i8* %428)
  br i1 %429, label %_Dynamic_check.succeeded387, label %_Dynamic_check.failed386

_Dynamic_check.succeeded387:                      ; preds = %if.end385
  %430 = ptrtoint i8* %424 to i32
  %431 = call i8* @c_fetch_pointer_from_offset(i32 %430)
  %432 = call i1 @c_isTaintedPointerToTaintedMem(i8* %431)
  br i1 %432, label %_Dynamic_check.succeeded389, label %_Dynamic_check.failed388

_Dynamic_check.succeeded389:                      ; preds = %_Dynamic_check.succeeded387
  %433 = ptrtoint i8* %425 to i32
  %434 = call i8* @c_fetch_pointer_from_offset(i32 %433)
  %435 = call i1 @c_isTaintedPointerToTaintedMem(i8* %434)
  br i1 %435, label %_Dynamic_check.succeeded391, label %_Dynamic_check.failed390

_Dynamic_check.succeeded391:                      ; preds = %_Dynamic_check.succeeded389
  %call392 = call i32 @json_serialize_string(i8* %428, i8* %431, i8* %434, i64 %426)
  store i32 %call392, i32* %written, align 4
  %436 = load i32, i32* %written, align 4
  %cmp393 = icmp slt i32 %436, 0
...
if.end395:                                        ; preds = %_Dynamic_check.succeeded391
  %437 = load i8*, i8** %buf.addr, align 4
  %438 = ptrtoint i8* %437 to i32
  %cmp396 = icmp ne i32 %438, 0
  br i1 %cmp396, label %if.then397, label %if.end400

if.then397:                                       ; preds = %if.end395
  %439 = load i32, i32* %written, align 4
  %440 = load i8*, i8** %buf.addr, align 4
  %idx.ext398 = sext i32 %439 to i64
  %add.ptr399 = getelementptr inbounds i8, i8* %440, i64 %idx.ext398
  store i8* %add.ptr399, i8** %buf.addr, align 4
  br label %if.end400

if.end400:                                        ; preds = %if.then397, %if.end395
  %441 = load i32, i32* %written, align 4
  %442 = load i32, i32* %written_total, align 4
  %add401 = add nsw i32 %442, %441
  store i32 %add401, i32* %written_total, align 4
  %443 = load i32, i32* %written_total, align 4
  store i32 %443, i32* %retval, align 4
  br label %return

sw.bb402:                                         ; preds = %_Dynamic_check.succeeded
  %444 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value.addr, align 4
  %445 = ptrtoint %Tstruct.Spl_json_value_t_t* %444 to i32
  %446 = call i8* @c_fetch_pointer_from_offset(i32 %445)
  %447 = call i1 @c_isTaintedPointerToTaintedMem(i8* %446)
  br i1 %447, label %_Dynamic_check.succeeded404, label %_Dynamic_check.failed403

_Dynamic_check.succeeded404:                      ; preds = %sw.bb402
  %448 = bitcast i8* %446 to %Tstruct.Spl_json_value_t_t*
  %call405 = call i32 bitcast (i32 (%Tstruct.Spl_json_value_t_t*)* @json_value_get_boolean to i32 (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %448)
...
do.body408:                                       ; preds = %if.then407
  ...
  %450 = load i8*, i8** %buf_start.addr, align 4
  %451 = load i64, i64* %buf_len.addr, align 8
  %452 = ptrtoint i8* %449 to i32
  %453 = call i8* @c_fetch_pointer_from_offset(i32 %452)
  %454 = call i1 @c_isTaintedPointerToTaintedMem(i8* %453)
  br i1 %454, label %_Dynamic_check.succeeded410, label %_Dynamic_check.failed409

_Dynamic_check.succeeded410:                      ; preds = %do.body408
  %455 = ptrtoint i8* %450 to i32
  %456 = call i8* @c_fetch_pointer_from_offset(i32 %455)
  %457 = call i1 @c_isTaintedPointerToTaintedMem(i8* %456)
  br i1 %457, label %_Dynamic_check.succeeded412, label %_Dynamic_check.failed411

_Dynamic_check.succeeded412:                      ; preds = %_Dynamic_check.succeeded410
  %call413 = call i32 @append_string(i8* %453, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.8, i64 0, i64 0), i8* %456, i64 %451)
  store i32 %call413, i32* %written, align 4
  %458 = load i32, i32* %written, align 4
  %cmp414 = icmp slt i32 %458, 0
...
if.end416:                                        ; preds = %_Dynamic_check.succeeded412
  ...
  %cmp417 = icmp ne i32 %460, 0
  br i1 %cmp417, label %if.then418, label %if.end421

if.then418:                                       ; preds = %if.end416
  %461 = load i32, i32* %written, align 4
  %462 = load i8*, i8** %buf.addr, align 4
  %idx.ext419 = sext i32 %461 to i64
  %add.ptr420 = getelementptr inbounds i8, i8* %462, i64 %idx.ext419
  store i8* %add.ptr420, i8** %buf.addr, align 4
  br label %if.end421

if.end421:                                        ; preds = %if.then418, %if.end416
  %463 = load i32, i32* %written, align 4
  %464 = load i32, i32* %written_total, align 4
  %add422 = add nsw i32 %464, %463
...
do.body424:                                       ; preds = %if.else
  %465 = load i8*, i8** %buf.addr, align 4
  %466 = load i8*, i8** %buf_start.addr, align 4
  %467 = load i64, i64* %buf_len.addr, align 8
  %468 = ptrtoint i8* %465 to i32
  %469 = call i8* @c_fetch_pointer_from_offset(i32 %468)
  %470 = call i1 @c_isTaintedPointerToTaintedMem(i8* %469)
  br i1 %470, label %_Dynamic_check.succeeded426, label %_Dynamic_check.failed425
...
_Dynamic_check.succeeded426:                      ; preds = %do.body424
  ...
  br i1 %473, label %_Dynamic_check.succeeded428, label %_Dynamic_check.failed427

_Dynamic_check.succeeded428:                      ; preds = %_Dynamic_check.succeeded426
  %call429 = call i32 @append_string(i8* %469, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.9, i64 0, i64 0), i8* %472, i64 %467)
  store i32 %call429, i32* %written, align 4
  %474 = load i32, i32* %written, align 4
  %cmp430 = icmp slt i32 %474, 0
...
if.end432:                                        ; preds = %_Dynamic_check.succeeded428
  ...
  %cmp433 = icmp ne i32 %476, 0
  br i1 %cmp433, label %if.then434, label %if.end437

if.then434:                                       ; preds = %if.end432
  %477 = load i32, i32* %written, align 4
  %478 = load i8*, i8** %buf.addr, align 4
  %idx.ext435 = sext i32 %477 to i64
  %add.ptr436 = getelementptr inbounds i8, i8* %478, i64 %idx.ext435
  store i8* %add.ptr436, i8** %buf.addr, align 4
  br label %if.end437

if.end437:                                        ; preds = %if.then434, %if.end432
  %479 = load i32, i32* %written, align 4
  %480 = load i32, i32* %written_total, align 4
  %add438 = add nsw i32 %480, %479
...
sw.bb441:                                         ; preds = %_Dynamic_check.succeeded
  %482 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value.addr, align 4
  %483 = ptrtoint %Tstruct.Spl_json_value_t_t* %482 to i32
  %484 = call i8* @c_fetch_pointer_from_offset(i32 %483)
  %485 = call i1 @c_isTaintedPointerToTaintedMem(i8* %484)
  br i1 %485, label %_Dynamic_check.succeeded443, label %_Dynamic_check.failed442

_Dynamic_check.succeeded443:                      ; preds = %sw.bb441
  %486 = bitcast i8* %484 to %Tstruct.Spl_json_value_t_t*
  %call444 = call double bitcast (double (%Tstruct.Spl_json_value_t_t*)* @json_value_get_number to double (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %486)
  store double %call444, double* %num, align 8
  %487 = load i8*, i8** %buf.addr, align 4
  %488 = ptrtoint i8* %487 to i32
  %cmp445 = icmp ne i32 %488, 0
  br i1 %cmp445, label %if.then446, label %if.end447

if.then446:                                       ; preds = %_Dynamic_check.succeeded443
  %489 = load i8*, i8** %buf.addr, align 4
  store i8* %489, i8** %temp_buf, align 4
  %490 = load i8*, i8** %temp_buf, align 4
  store i8* %490, i8** %num_buf.addr, align 4
  br label %if.end447
...
if.end447:                                        ; preds = %if.then446, %_Dynamic_check.succeeded443
  %491 = load i8*, i8** %num_buf.addr, align 4
  %492 = load double, double* %num, align 8
  %493 = ptrtoint i8* %491 to i32
  %494 = call i8* @c_fetch_pointer_from_offset(i32 %493)
  %495 = call i1 @c_isTaintedPointerToTaintedMem(i8* %494)
  br i1 %495, label %_Dynamic_check.succeeded449, label %_Dynamic_check.failed448

_Dynamic_check.succeeded449:                      ; preds = %if.end447
  %496 = call i8* @c_ConditionalTaintedOff2Ptr(i64 ptrtoint ([7 x i8]* @.str.10 to i64))
  %call450 = call i32 (i8*, i8*, ...) @t_sprintf(i8* %494, i8* %496, double %492)
  store i32 %call450, i32* %written, align 4
  %497 = load i32, i32* %written, align 4
  %cmp451 = icmp slt i32 %497, 0
...
do.body461:                                       ; preds = %sw.bb460
  %505 = load i8*, i8** %buf.addr, align 4
  %506 = load i8*, i8** %buf_start.addr, align 4
  %507 = load i64, i64* %buf_len.addr, align 8
  ...
  br i1 %510, label %_Dynamic_check.succeeded463, label %_Dynamic_check.failed462

_Dynamic_check.succeeded463:                      ; preds = %do.body461
  %511 = ptrtoint i8* %506 to i32
  %512 = call i8* @c_fetch_pointer_from_offset(i32 %511)
  %513 = call i1 @c_isTaintedPointerToTaintedMem(i8* %512)
  br i1 %513, label %_Dynamic_check.succeeded465, label %_Dynamic_check.failed464

_Dynamic_check.succeeded465:                      ; preds = %_Dynamic_check.succeeded463
  %call466 = call i32 @append_string(i8* %509, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.11, i64 0, i64 0), i8* %512, i64 %507)
  store i32 %call466, i32* %written, align 4
  %514 = load i32, i32* %written, align 4
  %cmp467 = icmp slt i32 %514, 0
...
if.then471:                                       ; preds = %if.end469
  ...
  %idx.ext472 = sext i32 %517 to i64
  %add.ptr473 = getelementptr inbounds i8, i8* %518, i64 %idx.ext472
  store i8* %add.ptr473, i8** %buf.addr, align 4
  br label %if.end474

if.end474:                                        ; preds = %if.then471, %if.end469
  %519 = load i32, i32* %written, align 4
  %520 = load i32, i32* %written_total, align 4
  %add475 = add nsw i32 %520, %519
  store i32 %add475, i32* %written_total, align 4
  br label %do.end476

do.end476:                                        ; preds = %if.end474
  %521 = load i32, i32* %written_total, align 4
  store i32 %521, i32* %retval, align 4
  br label %return
...
_Dynamic_check.succeeded6:                        ; preds = %_Dynamic_check.succeeded
  ...
  store %Tstruct.Spl_json_value_t_t* %18, %Tstruct.Spl_json_value_t_t** %output_value, align 4
  %19 = load i8*, i8** %Tainted_file_contents, align 4
  %_Dynamic_check.is_null = icmp eq i8* %19, null
  br i1 %_Dynamic_check.is_null, label %_Dynamic_check.success, label %_Dynamic_check.subsumption

_Dynamic_check.subsumption:                       ; preds = %_Dynamic_check.succeeded6
  %20 = load i8*, i8** %Tainted_file_contents, align 4
  %21 = load i8*, i8** %Tainted_file_contents, align 4
  %add.ptr = getelementptr inbounds i8, i8* %21, i64 0
  %_Dynamic_check.non_null = icmp ne i8* %19, null
...
_Dynamic_check.succeeded9:                        ; preds = %_Dynamic_check.subsumption
  %add.ptr10 = getelementptr inbounds i8, i8* %19, i64 0
  %22 = call i64 @c_TPtoO(i8* %20)
  %23 = inttoptr i64 %22 to i8*
  %24 = call i64 @c_TPtoO(i8* %19)
  %25 = inttoptr i64 %24 to i8*
  %_Dynamic_check.lower = icmp ule i8* %23, %25
  %26 = call i64 @c_TPtoO(i8* %add.ptr10)
  %27 = inttoptr i64 %26 to i8*
  %28 = call i64 @c_TPtoO(i8* %add.ptr)
  %29 = inttoptr i64 %28 to i8*
  %_Dynamic_check.upper = icmp ule i8* %27, %29
  %_Dynamic_check.cast = and i1 %_Dynamic_check.lower, %_Dynamic_check.upper
...
_Dynamic_check.succeeded13:                       ; preds = %_Dynamic_check.success
  ...
  %33 = load i8*, i8** %file_contents, align 8
  %_Dynamic_check.is_null14 = icmp eq i8* %33, null
...
_Dynamic_check.subsumption15:                     ; preds = %_Dynamic_check.succeeded13
  %34 = load i8*, i8** %file_contents, align 8
  %35 = load i8*, i8** %file_contents, align 8
  %_Dynamic_check.non_null16 = icmp ne i8* %35, null
...
_Dynamic_check.succeeded18:                       ; preds = %_Dynamic_check.subsumption15
  %add.ptr19 = getelementptr inbounds i8, i8* %35, i64 0
  %_Dynamic_check.non_null20 = icmp ne i8* %33, null
...
_Dynamic_check.succeeded22:                       ; preds = %_Dynamic_check.succeeded18
  %add.ptr23 = getelementptr inbounds i8, i8* %33, i64 0
  %36 = call i64 @c_TPtoO(i8* %34)
  %37 = inttoptr i64 %36 to i8*
  %38 = call i64 @c_TPtoO(i8* %33)
  %39 = inttoptr i64 %38 to i8*
  %_Dynamic_check.lower24 = icmp ule i8* %37, %39
  %40 = call i64 @c_TPtoO(i8* %add.ptr23)
  %41 = inttoptr i64 %40 to i8*
  %42 = call i64 @c_TPtoO(i8* %add.ptr19)
  %43 = inttoptr i64 %42 to i8*
  %_Dynamic_check.upper25 = icmp ule i8* %41, %43
...
_Dynamic_check.success28:                         ; preds = %_Dynamic_check.succeeded22, %_Dynamic_check.succeeded13
  ...
  %44 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %output_value, align 4
...
_Dynamic_check.succeeded:                         ; preds = %entry
  ...
  %call2 = call i32 @c_fetch_pointer_offset(i8* %9)
  ret i32 %call2
...
_Dynamic_check.succeeded6:                        ; preds = %_Dynamic_check.succeeded
  ...
  %19 = bitcast %Tstruct.json_value_t_t* %18 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %19, %Tstruct.Spl_json_value_t_t** %output_value, align 4
  %20 = load i8*, i8** %Tainted_file_contents, align 4
  %_Dynamic_check.is_null = icmp eq i8* %20, null
  br i1 %_Dynamic_check.is_null, label %_Dynamic_check.success, label %_Dynamic_check.subsumption
...
_Dynamic_check.subsumption:                       ; preds = %_Dynamic_check.succeeded6
  ...
  %_Dynamic_check.non_null = icmp ne i8* %20, null
  br i1 %_Dynamic_check.non_null, label %_Dynamic_check.succeeded9, label %_Dynamic_check.failed8

_Dynamic_check.succeeded9:                        ; preds = %_Dynamic_check.subsumption
  %add.ptr10 = getelementptr inbounds i8, i8* %20, i64 0
  %23 = call i64 @c_TPtoO(i8* %21)
  %24 = inttoptr i64 %23 to i8*
  %25 = call i64 @c_TPtoO(i8* %20)
  %26 = inttoptr i64 %25 to i8*
  %_Dynamic_check.lower = icmp ule i8* %24, %26
  %27 = call i64 @c_TPtoO(i8* %add.ptr10)
  %28 = inttoptr i64 %27 to i8*
  %29 = call i64 @c_TPtoO(i8* %add.ptr)
  %30 = inttoptr i64 %29 to i8*
  %_Dynamic_check.upper = icmp ule i8* %28, %30
  %_Dynamic_check.cast = and i1 %_Dynamic_check.lower, %_Dynamic_check.upper
  br i1 %_Dynamic_check.cast, label %_Dynamic_check.success, label %_Dynamic_check.failed11

_Dynamic_check.success:                           ; preds = %_Dynamic_check.succeeded9, %_Dynamic_check.succeeded6
  %31 = ptrtoint i8* %20 to i32
...
_Dynamic_check.succeeded13:                       ; preds = %_Dynamic_check.success
  ...
  %34 = load i8*, i8** %file_contents, align 8
  %_Dynamic_check.is_null14 = icmp eq i8* %34, null
  br i1 %_Dynamic_check.is_null14, label %_Dynamic_check.success28, label %_Dynamic_check.subsumption15

_Dynamic_check.subsumption15:                     ; preds = %_Dynamic_check.succeeded13
  %35 = load i8*, i8** %file_contents, align 8
  %36 = load i8*, i8** %file_contents, align 8
  %_Dynamic_check.non_null16 = icmp ne i8* %36, null
  br i1 %_Dynamic_check.non_null16, label %_Dynamic_check.succeeded18, label %_Dynamic_check.failed17

_Dynamic_check.succeeded18:                       ; preds = %_Dynamic_check.subsumption15
  %add.ptr19 = getelementptr inbounds i8, i8* %36, i64 0
  %_Dynamic_check.non_null20 = icmp ne i8* %34, null
  br i1 %_Dynamic_check.non_null20, label %_Dynamic_check.succeeded22, label %_Dynamic_check.failed21

_Dynamic_check.succeeded22:                       ; preds = %_Dynamic_check.succeeded18
  %add.ptr23 = getelementptr inbounds i8, i8* %34, i64 0
  %37 = call i64 @c_TPtoO(i8* %35)
  %38 = inttoptr i64 %37 to i8*
  %39 = call i64 @c_TPtoO(i8* %34)
  %40 = inttoptr i64 %39 to i8*
  %_Dynamic_check.lower24 = icmp ule i8* %38, %40
  %41 = call i64 @c_TPtoO(i8* %add.ptr23)
  %42 = inttoptr i64 %41 to i8*
  %43 = call i64 @c_TPtoO(i8* %add.ptr19)
  %44 = inttoptr i64 %43 to i8*
  %_Dynamic_check.upper25 = icmp ule i8* %42, %44
  %_Dynamic_check.cast26 = and i1 %_Dynamic_check.lower24, %_Dynamic_check.upper25
  br i1 %_Dynamic_check.cast26, label %_Dynamic_check.success28, label %_Dynamic_check.failed27

_Dynamic_check.success28:                         ; preds = %_Dynamic_check.succeeded22, %_Dynamic_check.succeeded13
  call void @free(i8* %34) #10
  %45 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %output_value, align 4
...
_Dynamic_check.succeeded:                         ; preds = %if.end13
  ...
  %14 = bitcast %Tstruct.Spl_json_value_t_t* %call to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %14, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
return:                                           ; preds = %_Dynamic_check.succeeded, %if.then
  %15 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %retval, align 4
  ret %Tstruct.Spl_json_value_t_t* %15
}
...
_Dynamic_check.succeeded5:                        ; preds = %_Dynamic_check.succeeded3
  ...
  %20 = bitcast %Tstruct.Spl_json_value_t_t* %call6 to %Tstruct.Spl_json_value_t_t*
...
return:                                           ; preds = %_Dynamic_check.succeeded5, %if.then
  %21 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %retval, align 4
  ret %Tstruct.Spl_json_value_t_t* %21
}
...
_Dynamic_check.succeeded2:                        ; preds = %_Dynamic_check.succeeded
  ...
  %10 = bitcast %Tstruct.Spl_json_value_t_t* %call to %Tstruct.Spl_json_value_t_t*
...
_Dynamic_check.succeeded4:                        ; preds = %_Dynamic_check.succeeded2
  ...
  %call5 = call i8* bitcast (i8* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_string to i8* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %14)
  ret i8* %call5
...
_Dynamic_check.succeeded4:                        ; preds = %_Dynamic_check.succeeded2
  %14 = bitcast i8* %12 to %Tstruct.Spl_json_value_t_t*
  %call5 = call double bitcast (double (%Tstruct.Spl_json_value_t_t*)* @json_value_get_number to double (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %14)
  ret double %call5
...
_Dynamic_check.succeeded4:                        ; preds = %_Dynamic_check.succeeded2
  %14 = bitcast i8* %12 to %Tstruct.Spl_json_value_t_t*
  %call5 = call %Tstruct.Spl_json_object_t_t* bitcast (%Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_object to %Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %14)
  %15 = bitcast %Tstruct.Spl_json_object_t_t* %call5 to %Tstruct.Spl_json_object_t_t*
  ret %Tstruct.Spl_json_object_t_t* %15
...
_Dynamic_check.succeeded4:                        ; preds = %_Dynamic_check.succeeded2
  %14 = bitcast i8* %12 to %Tstruct.Spl_json_value_t_t*
  %call5 = call %Tstruct.Spl_json_array_t_t* bitcast (%Tstruct.Spl_json_array_t_t* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_array to %Tstruct.Spl_json_array_t_t* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %14)
  %15 = bitcast %Tstruct.Spl_json_array_t_t* %call5 to %Tstruct.Spl_json_array_t_t*
  ret %Tstruct.Spl_json_array_t_t* %15
...
_Dynamic_check.succeeded4:                        ; preds = %_Dynamic_check.succeeded2
  %14 = bitcast i8* %12 to %Tstruct.Spl_json_value_t_t*
  %call5 = call i32 bitcast (i32 (%Tstruct.Spl_json_value_t_t*)* @json_value_get_boolean to i32 (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %14)
  ret i32 %call5
...
_Dynamic_check.succeeded4:                        ; preds = %_Dynamic_check.succeeded2
  ...
  %15 = bitcast %Tstruct.Spl_json_value_t_t* %call5 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %15, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
_Dynamic_check.succeeded9:                        ; preds = %_Dynamic_check.succeeded7
  %call10 = call %Tstruct.Spl_json_value_t_t* bitcast (%Tstruct.json_value_t_t* (%Tstruct.json_object_t_t*, i8*, i64)* @json_object_getn_value to %Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_object_t_t*, i8*, i64)*)(%Tstruct.Spl_json_object_t_t* %24, i8* %26, i64 %sub.ptr.sub)
  %28 = bitcast %Tstruct.Spl_json_value_t_t* %call10 to %Tstruct.Spl_json_value_t_t*
...
_Dynamic_check.succeeded12:                       ; preds = %_Dynamic_check.succeeded9
  ...
  %call13 = call %Tstruct.Spl_json_object_t_t* bitcast (%Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_object to %Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %32)
  %33 = bitcast %Tstruct.Spl_json_object_t_t* %call13 to %Tstruct.json_object_t_t*
  %34 = bitcast %Tstruct.json_object_t_t* %33 to %Tstruct.Spl_json_object_t_t*
  store %Tstruct.Spl_json_object_t_t* %34, %Tstruct.Spl_json_object_t_t** %object.addr, align 4
  ...
  %36 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %object.addr, align 4
  %37 = load i8*, i8** %one_past_dot, align 4
  %38 = ptrtoint %Tstruct.Spl_json_object_t_t* %36 to i32
...
_Dynamic_check.succeeded15:                       ; preds = %_Dynamic_check.succeeded12
  ...
  %43 = call i8* @c_fetch_pointer_from_offset(i32 %42)
  %44 = call i1 @c_isTaintedPointerToTaintedMem(i8* %43)
  br i1 %44, label %_Dynamic_check.succeeded17, label %_Dynamic_check.failed16

_Dynamic_check.succeeded17:                       ; preds = %_Dynamic_check.succeeded15
  %call18 = call %Tstruct.Spl_json_value_t_t* bitcast (%Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_object_t_t*, i8*)* @json_object_dotget_value to %Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_object_t_t*, i8*)*)(%Tstruct.Spl_json_object_t_t* %41, i8* %43)
  %45 = bitcast %Tstruct.Spl_json_value_t_t* %call18 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %45, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
_Dynamic_check.succeeded2:                        ; preds = %_Dynamic_check.succeeded
  ...
  %11 = bitcast %Tstruct.json_value_t_t* %10 to %Tstruct.Spl_json_value_t_t*
...
_Dynamic_check.succeeded2:                        ; preds = %_Dynamic_check.succeeded
  ...
  %10 = bitcast %Tstruct.Spl_json_value_t_t* %call to %Tstruct.json_value_t_t*
  %11 = bitcast %Tstruct.json_value_t_t* %10 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %11, %Tstruct.Spl_json_value_t_t** %val, align 4
  %12 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %val, align 4
  %13 = ptrtoint %Tstruct.Spl_json_value_t_t* %12 to i32
  %cmp = icmp ne i32 %13, 0
  br i1 %cmp, label %land.rhs, label %land.end

land.rhs:                                         ; preds = %_Dynamic_check.succeeded2
  %14 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %val, align 4
...
_Dynamic_check.succeeded4:                        ; preds = %land.rhs
  ...
  %call5 = call i32 bitcast (i32 (%Tstruct.Spl_json_value_t_t*)* @json_value_get_type to i32 (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %18)
  %19 = load i32, i32* %type.addr, align 4
  %cmp6 = icmp eq i32 %call5, %19
  br label %land.end

land.end:                                         ; preds = %_Dynamic_check.succeeded4, %_Dynamic_check.succeeded2
  %20 = phi i1 [ false, %_Dynamic_check.succeeded2 ], [ %cmp6, %_Dynamic_check.succeeded4 ]
...
_Dynamic_check.succeeded:                         ; preds = %entry
  ...
  %7 = bitcast %Tstruct.Spl_json_value_t_t* %call to %Tstruct.Spl_json_value_t_t*
  %8 = ptrtoint %Tstruct.Spl_json_value_t_t* %7 to i32
  %9 = call i8* @c_fetch_pointer_from_offset(i32 %8)
  %10 = call i1 @c_isTaintedPointerToTaintedMem(i8* %9)
  br i1 %10, label %_Dynamic_check.succeeded2, label %_Dynamic_check.failed1
...
_Dynamic_check.succeeded2:                        ; preds = %_Dynamic_check.succeeded
  ...
  %call3 = call i8* bitcast (i8* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_string to i8* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %11)
  ret i8* %call3
...
_Dynamic_check.succeeded2:                        ; preds = %_Dynamic_check.succeeded
  %11 = bitcast i8* %9 to %Tstruct.Spl_json_value_t_t*
  %call3 = call double bitcast (double (%Tstruct.Spl_json_value_t_t*)* @json_value_get_number to double (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %11)
  ret double %call3
...
_Dynamic_check.succeeded2:                        ; preds = %_Dynamic_check.succeeded
  %11 = bitcast i8* %9 to %Tstruct.Spl_json_value_t_t*
  %call3 = call %Tstruct.Spl_json_object_t_t* bitcast (%Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_object to %Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %11)
  %12 = bitcast %Tstruct.Spl_json_object_t_t* %call3 to %Tstruct.Spl_json_object_t_t*
  ret %Tstruct.Spl_json_object_t_t* %12
...
_Dynamic_check.succeeded2:                        ; preds = %_Dynamic_check.succeeded
  %11 = bitcast i8* %9 to %Tstruct.Spl_json_value_t_t*
  %call3 = call %Tstruct.Spl_json_array_t_t* bitcast (%Tstruct.Spl_json_array_t_t* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_array to %Tstruct.Spl_json_array_t_t* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %11)
  %12 = bitcast %Tstruct.Spl_json_array_t_t* %call3 to %Tstruct.Spl_json_array_t_t*
  ret %Tstruct.Spl_json_array_t_t* %12
...
_Dynamic_check.succeeded2:                        ; preds = %_Dynamic_check.succeeded
  %11 = bitcast i8* %9 to %Tstruct.Spl_json_value_t_t*
  %call3 = call i32 bitcast (i32 (%Tstruct.Spl_json_value_t_t*)* @json_value_get_boolean to i32 (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %11)
  ret i32 %call3
...
_Dynamic_check.succeeded13:                       ; preds = %if.end11
  ...
  %24 = bitcast %Tstruct.json_value_t_t* %23 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %24, %Tstruct.Spl_json_value_t_t** %value, align 4
...
_Dynamic_check.succeeded18:                       ; preds = %_Dynamic_check.subsumption
  %add.ptr19 = getelementptr inbounds i8, i8* %27, i64 0
  %30 = call i64 @c_TPtoO(i8* %28)
  %31 = inttoptr i64 %30 to i8*
  %32 = call i64 @c_TPtoO(i8* %27)
  %33 = inttoptr i64 %32 to i8*
  %_Dynamic_check.lower = icmp ule i8* %31, %33
  %34 = call i64 @c_TPtoO(i8* %add.ptr19)
  %35 = inttoptr i64 %34 to i8*
  %36 = call i64 @c_TPtoO(i8* %add.ptr)
  %37 = inttoptr i64 %36 to i8*
  %_Dynamic_check.upper = icmp ule i8* %35, %37
  %_Dynamic_check.cast = and i1 %_Dynamic_check.lower, %_Dynamic_check.upper
...
_Dynamic_check.success:                           ; preds = %_Dynamic_check.succeeded18, %if.then16
  ...
  %39 = call i8* @c_fetch_pointer_from_offset(i32 %38)
  %40 = call i1 @c_isTaintedPointerToTaintedMem(i8* %39)
  br i1 %40, label %_Dynamic_check.succeeded22, label %_Dynamic_check.failed21
...
return:                                           ; preds = %if.end23, %if.then10, %if.then4, %if.then
  %42 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %retval, align 4
  ret %Tstruct.Spl_json_value_t_t* %42
}
...
entry:
  ...
  store %Tstruct.Spl_json_value_t_t* %1, %Tstruct.Spl_json_value_t_t** %new_value, align 4
  %2 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %new_value, align 4
  %tobool = icmp ne %Tstruct.Spl_json_value_t_t* %2, null
  br i1 %tobool, label %if.end, label %if.then
...
if.end:                                           ; preds = %entry
  %3 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %new_value, align 4
...
_Dynamic_check.succeeded:                         ; preds = %if.end
  ...
  %parent = getelementptr inbounds %Tstruct.Spl_json_value_t_t, %Tstruct.Spl_json_value_t_t* %7, i32 0, i32 0
  %parent1 = bitcast i32* %parent to %Tstruct.Spl_json_value_t_t**
  store %Tstruct.Spl_json_value_t_t* null, %Tstruct.Spl_json_value_t_t** %parent1, align 8
  %8 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %new_value, align 4
...
_Dynamic_check.succeeded3:                        ; preds = %_Dynamic_check.succeeded
  ...
  %13 = load i32, i32* %boolean.addr, align 4
...
_Dynamic_check.succeeded6:                        ; preds = %_Dynamic_check.succeeded3
  %19 = bitcast i8* %17 to %Tstruct.Spl_json_value_t_t*
  %value = getelementptr inbounds %Tstruct.Spl_json_value_t_t, %Tstruct.Spl_json_value_t_t* %19, i32 0, i32 2
  %value7 = bitcast %Tstruct.Spl_json_value_value_t_t* %value to %Tstruct.Spl_json_value_value_t_t*
  %20 = ptrtoint %Tstruct.Spl_json_value_value_t_t* %value7 to i32
  %21 = call i8* @c_fetch_pointer_from_offset(i32 %20)
  %22 = call i1 @c_isTaintedPointerToTaintedMem(i8* %21)
  br i1 %22, label %_Dynamic_check.succeeded9, label %_Dynamic_check.failed8

_Dynamic_check.succeeded9:                        ; preds = %_Dynamic_check.succeeded6
  %23 = bitcast i8* %21 to %Tstruct.Spl_json_value_value_t_t*
  %boolean10 = getelementptr inbounds %Tstruct.Spl_json_value_value_t_t, %Tstruct.Spl_json_value_value_t_t* %23, i32 0, i32 4
...
return:                                           ; preds = %_Dynamic_check.succeeded9, %if.then
  %25 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %retval, align 4
  ret %Tstruct.Spl_json_value_t_t* %25
}
...
_Dynamic_check.succeeded2:                        ; preds = %sw.bb
  ...
  %11 = bitcast %Tstruct.Spl_json_array_t_t* %call3 to %Tstruct.json_array_t_t*
  %12 = bitcast %Tstruct.json_array_t_t* %11 to %Tstruct.Spl_json_array_t_t*
  store %Tstruct.Spl_json_array_t_t* %12, %Tstruct.Spl_json_array_t_t** %temp_array, align 4
  %call4 = call %Tstruct.Spl_json_value_t_t* @json_value_init_array()
  %13 = bitcast %Tstruct.Spl_json_value_t_t* %call4 to %Tstruct.json_value_t_t*
  %14 = bitcast %Tstruct.json_value_t_t* %13 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %14, %Tstruct.Spl_json_value_t_t** %return_value, align 4
  %15 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %return_value, align 4
  %16 = ptrtoint %Tstruct.Spl_json_value_t_t* %15 to i32
  %cmp = icmp eq i32 %16, 0
  br i1 %cmp, label %if.then, label %if.end
...
if.end:                                           ; preds = %_Dynamic_check.succeeded2
  %17 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %return_value, align 4
...
_Dynamic_check.succeeded6:                        ; preds = %if.end
  ...
  %call7 = call %Tstruct.Spl_json_array_t_t* bitcast (%Tstruct.Spl_json_array_t_t* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_array to %Tstruct.Spl_json_array_t_t* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %21)
  %22 = bitcast %Tstruct.Spl_json_array_t_t* %call7 to %Tstruct.json_array_t_t*
  %23 = bitcast %Tstruct.json_array_t_t* %22 to %Tstruct.Spl_json_array_t_t*
  store %Tstruct.Spl_json_array_t_t* %23, %Tstruct.Spl_json_array_t_t** %temp_array_copy, align 4
  store i64 0, i64* %i, align 8
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %_Dynamic_check.succeeded6
  %24 = load i64, i64* %i, align 8
  %25 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %temp_array, align 4
  %26 = ptrtoint %Tstruct.Spl_json_array_t_t* %25 to i32
  %27 = call i8* @c_fetch_pointer_from_offset(i32 %26)
  %28 = call i1 @c_isTaintedPointerToTaintedMem(i8* %27)
...
_Dynamic_check.succeeded9:                        ; preds = %for.cond
  %29 = bitcast i8* %27 to %Tstruct.Spl_json_array_t_t*
  %call10 = call i64 bitcast (i64 (%Tstruct.Spl_json_array_t_t*)* @json_array_get_count to i64 (%Tstruct.Spl_json_array_t_t*)*)(%Tstruct.Spl_json_array_t_t* %29)
  %cmp11 = icmp ult i64 %24, %call10
  br i1 %cmp11, label %for.body, label %for.end

for.body:                                         ; preds = %_Dynamic_check.succeeded9
  %30 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %temp_array, align 4
  %31 = load i64, i64* %i, align 8
  %32 = ptrtoint %Tstruct.Spl_json_array_t_t* %30 to i32
  %33 = call i8* @c_fetch_pointer_from_offset(i32 %32)
  %34 = call i1 @c_isTaintedPointerToTaintedMem(i8* %33)
  br i1 %34, label %_Dynamic_check.succeeded13, label %_Dynamic_check.failed12

_Dynamic_check.succeeded13:                       ; preds = %for.body
  %35 = bitcast i8* %33 to %Tstruct.Spl_json_array_t_t*
  %call14 = call %Tstruct.Spl_json_value_t_t* bitcast (%Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_array_t_t*, i64)* @json_array_get_value to %Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_array_t_t*, i64)*)(%Tstruct.Spl_json_array_t_t* %35, i64 %31)
  %36 = bitcast %Tstruct.Spl_json_value_t_t* %call14 to %Tstruct.json_value_t_t*
  %37 = bitcast %Tstruct.json_value_t_t* %36 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %37, %Tstruct.Spl_json_value_t_t** %temp_value, align 4
  %38 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %temp_value, align 4
...
_Dynamic_check.succeeded16:                       ; preds = %_Dynamic_check.succeeded13
  ...
  %call17 = call %Tstruct.Spl_json_value_t_t* @json_value_deep_copy(%Tstruct.Spl_json_value_t_t* %42)
  %43 = bitcast %Tstruct.Spl_json_value_t_t* %call17 to %Tstruct.json_value_t_t*
  %44 = bitcast %Tstruct.json_value_t_t* %43 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %44, %Tstruct.Spl_json_value_t_t** %temp_value_copy, align 4
  %45 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %temp_value_copy, align 4
  %46 = ptrtoint %Tstruct.Spl_json_value_t_t* %45 to i32
  %cmp18 = icmp eq i32 %46, 0
  br i1 %cmp18, label %if.then19, label %if.end22

if.then19:                                        ; preds = %_Dynamic_check.succeeded16
  %47 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %return_value, align 4
  ...
  br i1 %50, label %_Dynamic_check.succeeded21, label %_Dynamic_check.failed20

_Dynamic_check.succeeded21:                       ; preds = %if.then19
  %51 = bitcast i8* %49 to %Tstruct.Spl_json_value_t_t*
  call void bitcast (void (%Tstruct.Spl_json_value_t_t*)* @json_value_free to void (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %51)
  store %Tstruct.Spl_json_value_t_t* null, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
if.end22:                                         ; preds = %_Dynamic_check.succeeded16
  %52 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %temp_array_copy, align 4
  %53 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %temp_value_copy, align 4
  %54 = ptrtoint %Tstruct.Spl_json_array_t_t* %52 to i32
  %55 = call i8* @c_fetch_pointer_from_offset(i32 %54)
  %56 = call i1 @c_isTaintedPointerToTaintedMem(i8* %55)
  br i1 %56, label %_Dynamic_check.succeeded24, label %_Dynamic_check.failed23

_Dynamic_check.succeeded24:                       ; preds = %if.end22
  %57 = bitcast i8* %55 to %Tstruct.Spl_json_array_t_t*
  %58 = ptrtoint %Tstruct.Spl_json_value_t_t* %53 to i32
...
_Dynamic_check.succeeded26:                       ; preds = %_Dynamic_check.succeeded24
  %61 = bitcast i8* %59 to %Tstruct.Spl_json_value_t_t*
  %call27 = call i32 bitcast (i32 (%Tstruct.json_array_t_t*, %Tstruct.json_value_t_t*)* @json_array_add to i32 (%Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_array_t_t* %57, %Tstruct.Spl_json_value_t_t* %61)
...
if.then29:                                        ; preds = %_Dynamic_check.succeeded26
  ...
  br i1 %65, label %_Dynamic_check.succeeded31, label %_Dynamic_check.failed30
...
_Dynamic_check.succeeded31:                       ; preds = %if.then29
  ...
  %67 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %temp_value_copy, align 4
  ...
  br i1 %70, label %_Dynamic_check.succeeded33, label %_Dynamic_check.failed32

_Dynamic_check.succeeded33:                       ; preds = %_Dynamic_check.succeeded31
  %71 = bitcast i8* %69 to %Tstruct.Spl_json_value_t_t*
  call void bitcast (void (%Tstruct.Spl_json_value_t_t*)* @json_value_free to void (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %71)
  store %Tstruct.Spl_json_value_t_t* null, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
for.end:                                          ; preds = %_Dynamic_check.succeeded9
  %73 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %return_value, align 4
  store %Tstruct.Spl_json_value_t_t* %73, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return

sw.bb35:                                          ; preds = %_Dynamic_check.succeeded
  %74 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value.addr, align 4
  ...
  br i1 %77, label %_Dynamic_check.succeeded37, label %_Dynamic_check.failed36

_Dynamic_check.succeeded37:                       ; preds = %sw.bb35
  %78 = bitcast i8* %76 to %Tstruct.Spl_json_value_t_t*
  %call38 = call %Tstruct.Spl_json_object_t_t* bitcast (%Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_object to %Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %78)
  %79 = bitcast %Tstruct.Spl_json_object_t_t* %call38 to %Tstruct.json_object_t_t*
  %80 = bitcast %Tstruct.json_object_t_t* %79 to %Tstruct.Spl_json_object_t_t*
  store %Tstruct.Spl_json_object_t_t* %80, %Tstruct.Spl_json_object_t_t** %temp_object, align 4
  %call39 = call %Tstruct.Spl_json_value_t_t* @json_value_init_object()
  %81 = bitcast %Tstruct.Spl_json_value_t_t* %call39 to %Tstruct.json_value_t_t*
  %82 = bitcast %Tstruct.json_value_t_t* %81 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %82, %Tstruct.Spl_json_value_t_t** %return_value, align 4
  %83 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %return_value, align 4
  %84 = ptrtoint %Tstruct.Spl_json_value_t_t* %83 to i32
  %cmp40 = icmp eq i32 %84, 0
...
if.end42:                                         ; preds = %_Dynamic_check.succeeded37
  %85 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %return_value, align 4
  %86 = ptrtoint %Tstruct.Spl_json_value_t_t* %85 to i32
  %87 = call i8* @c_fetch_pointer_from_offset(i32 %86)
  %88 = call i1 @c_isTaintedPointerToTaintedMem(i8* %87)
  br i1 %88, label %_Dynamic_check.succeeded44, label %_Dynamic_check.failed43

_Dynamic_check.succeeded44:                       ; preds = %if.end42
  %89 = bitcast i8* %87 to %Tstruct.Spl_json_value_t_t*
  %call45 = call %Tstruct.Spl_json_object_t_t* bitcast (%Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_object to %Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %89)
  %90 = bitcast %Tstruct.Spl_json_object_t_t* %call45 to %Tstruct.json_object_t_t*
  %91 = bitcast %Tstruct.json_object_t_t* %90 to %Tstruct.Spl_json_object_t_t*
  store %Tstruct.Spl_json_object_t_t* %91, %Tstruct.Spl_json_object_t_t** %temp_object_copy, align 4
  store i64 0, i64* %i, align 8
  br label %for.cond46

for.cond46:                                       ; preds = %for.inc82, %_Dynamic_check.succeeded44
  %92 = load i64, i64* %i, align 8
  %93 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %temp_object, align 4
  %94 = ptrtoint %Tstruct.Spl_json_object_t_t* %93 to i32
  %95 = call i8* @c_fetch_pointer_from_offset(i32 %94)
  %96 = call i1 @c_isTaintedPointerToTaintedMem(i8* %95)
  br i1 %96, label %_Dynamic_check.succeeded48, label %_Dynamic_check.failed47

_Dynamic_check.succeeded48:                       ; preds = %for.cond46
  %97 = bitcast i8* %95 to %Tstruct.Spl_json_object_t_t*
  %call49 = call i64 bitcast (i64 (%Tstruct.Spl_json_object_t_t*)* @json_object_get_count to i64 (%Tstruct.Spl_json_object_t_t*)*)(%Tstruct.Spl_json_object_t_t* %97)
  %cmp50 = icmp ult i64 %92, %call49
  br i1 %cmp50, label %for.body51, label %for.end84

for.body51:                                       ; preds = %_Dynamic_check.succeeded48
  %98 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %temp_object, align 4
  %99 = load i64, i64* %i, align 8
  %100 = ptrtoint %Tstruct.Spl_json_object_t_t* %98 to i32
  %101 = call i8* @c_fetch_pointer_from_offset(i32 %100)
  %102 = call i1 @c_isTaintedPointerToTaintedMem(i8* %101)
  br i1 %102, label %_Dynamic_check.succeeded53, label %_Dynamic_check.failed52

_Dynamic_check.succeeded53:                       ; preds = %for.body51
  %103 = bitcast i8* %101 to %Tstruct.Spl_json_object_t_t*
  %call54 = call i8* bitcast (i8* (%Tstruct.Spl_json_object_t_t*, i64)* @json_object_get_name to i8* (%Tstruct.Spl_json_object_t_t*, i64)*)(%Tstruct.Spl_json_object_t_t* %103, i64 %99)
  store i8* %call54, i8** %temp_key, align 4
  %104 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %temp_object, align 4
  %105 = load i8*, i8** %temp_key, align 4
  %106 = ptrtoint %Tstruct.Spl_json_object_t_t* %104 to i32
  %107 = call i8* @c_fetch_pointer_from_offset(i32 %106)
  %108 = call i1 @c_isTaintedPointerToTaintedMem(i8* %107)
  br i1 %108, label %_Dynamic_check.succeeded56, label %_Dynamic_check.failed55

_Dynamic_check.succeeded56:                       ; preds = %_Dynamic_check.succeeded53
  %109 = bitcast i8* %107 to %Tstruct.Spl_json_object_t_t*
  %110 = ptrtoint i8* %105 to i32
  %111 = call i8* @c_fetch_pointer_from_offset(i32 %110)
  %112 = call i1 @c_isTaintedPointerToTaintedMem(i8* %111)
  br i1 %112, label %_Dynamic_check.succeeded58, label %_Dynamic_check.failed57

_Dynamic_check.succeeded58:                       ; preds = %_Dynamic_check.succeeded56
  %call59 = call %Tstruct.Spl_json_value_t_t* bitcast (%Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_object_t_t*, i8*)* @json_object_get_value to %Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_object_t_t*, i8*)*)(%Tstruct.Spl_json_object_t_t* %109, i8* %111)
  %113 = bitcast %Tstruct.Spl_json_value_t_t* %call59 to %Tstruct.json_value_t_t*
  %114 = bitcast %Tstruct.json_value_t_t* %113 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %114, %Tstruct.Spl_json_value_t_t** %temp_value, align 4
  %115 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %temp_value, align 4
  ...
  br i1 %118, label %_Dynamic_check.succeeded61, label %_Dynamic_check.failed60

_Dynamic_check.succeeded61:                       ; preds = %_Dynamic_check.succeeded58
  %119 = bitcast i8* %117 to %Tstruct.Spl_json_value_t_t*
  %call62 = call %Tstruct.Spl_json_value_t_t* @json_value_deep_copy(%Tstruct.Spl_json_value_t_t* %119)
  %120 = bitcast %Tstruct.Spl_json_value_t_t* %call62 to %Tstruct.json_value_t_t*
  %121 = bitcast %Tstruct.json_value_t_t* %120 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %121, %Tstruct.Spl_json_value_t_t** %temp_value_copy, align 4
  %122 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %temp_value_copy, align 4
...
if.then64:                                        ; preds = %_Dynamic_check.succeeded61
  %124 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %return_value, align 4
  ...
  br i1 %127, label %_Dynamic_check.succeeded66, label %_Dynamic_check.failed65
...
if.end67:                                         ; preds = %_Dynamic_check.succeeded61
  %129 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %temp_object_copy, align 4
  %130 = load i8*, i8** %temp_key, align 4
  %131 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %temp_value_copy, align 4
  %132 = ptrtoint %Tstruct.Spl_json_object_t_t* %129 to i32
  %133 = call i8* @c_fetch_pointer_from_offset(i32 %132)
  %134 = call i1 @c_isTaintedPointerToTaintedMem(i8* %133)
  br i1 %134, label %_Dynamic_check.succeeded69, label %_Dynamic_check.failed68

_Dynamic_check.succeeded69:                       ; preds = %if.end67
  %135 = bitcast i8* %133 to %Tstruct.Spl_json_object_t_t*
  %136 = ptrtoint i8* %130 to i32
  %137 = call i8* @c_fetch_pointer_from_offset(i32 %136)
  %138 = call i1 @c_isTaintedPointerToTaintedMem(i8* %137)
  br i1 %138, label %_Dynamic_check.succeeded71, label %_Dynamic_check.failed70

_Dynamic_check.succeeded71:                       ; preds = %_Dynamic_check.succeeded69
  %139 = ptrtoint %Tstruct.Spl_json_value_t_t* %131 to i32
  %140 = call i8* @c_fetch_pointer_from_offset(i32 %139)
  %141 = call i1 @c_isTaintedPointerToTaintedMem(i8* %140)
  br i1 %141, label %_Dynamic_check.succeeded73, label %_Dynamic_check.failed72

_Dynamic_check.succeeded73:                       ; preds = %_Dynamic_check.succeeded71
  %142 = bitcast i8* %140 to %Tstruct.Spl_json_value_t_t*
  %call74 = call i32 bitcast (i32 (%Tstruct.json_object_t_t*, i8*, %Tstruct.json_value_t_t*)* @json_object_add to i32 (%Tstruct.Spl_json_object_t_t*, i8*, %Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_object_t_t* %135, i8* %137, %Tstruct.Spl_json_value_t_t* %142)
  %cmp75 = icmp eq i32 %call74, -1
  br i1 %cmp75, label %if.then76, label %if.end81

if.then76:                                        ; preds = %_Dynamic_check.succeeded73
  %143 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %return_value, align 4
  %144 = ptrtoint %Tstruct.Spl_json_value_t_t* %143 to i32
  %145 = call i8* @c_fetch_pointer_from_offset(i32 %144)
  %146 = call i1 @c_isTaintedPointerToTaintedMem(i8* %145)
  br i1 %146, label %_Dynamic_check.succeeded78, label %_Dynamic_check.failed77

_Dynamic_check.succeeded78:                       ; preds = %if.then76
  %147 = bitcast i8* %145 to %Tstruct.Spl_json_value_t_t*
  call void bitcast (void (%Tstruct.Spl_json_value_t_t*)* @json_value_free to void (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %147)
  %148 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %temp_value_copy, align 4
  %149 = ptrtoint %Tstruct.Spl_json_value_t_t* %148 to i32
  %150 = call i8* @c_fetch_pointer_from_offset(i32 %149)
  %151 = call i1 @c_isTaintedPointerToTaintedMem(i8* %150)
  br i1 %151, label %_Dynamic_check.succeeded80, label %_Dynamic_check.failed79

_Dynamic_check.succeeded80:                       ; preds = %_Dynamic_check.succeeded78
  %152 = bitcast i8* %150 to %Tstruct.Spl_json_value_t_t*
  call void bitcast (void (%Tstruct.Spl_json_value_t_t*)* @json_value_free to void (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %152)
  store %Tstruct.Spl_json_value_t_t* null, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
for.end84:                                        ; preds = %_Dynamic_check.succeeded48
  ...
  store %Tstruct.Spl_json_value_t_t* %154, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return

sw.bb85:                                          ; preds = %_Dynamic_check.succeeded
  %155 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value.addr, align 4
  ...
  br i1 %158, label %_Dynamic_check.succeeded87, label %_Dynamic_check.failed86

_Dynamic_check.succeeded87:                       ; preds = %sw.bb85
  %159 = bitcast i8* %157 to %Tstruct.Spl_json_value_t_t*
  %call88 = call i32 bitcast (i32 (%Tstruct.Spl_json_value_t_t*)* @json_value_get_boolean to i32 (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %159)
  %call89 = call %Tstruct.Spl_json_value_t_t* @json_value_init_boolean(i32 %call88)
  %160 = bitcast %Tstruct.Spl_json_value_t_t* %call89 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %160, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
sw.bb90:                                          ; preds = %_Dynamic_check.succeeded
  %161 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value.addr, align 4
  %162 = ptrtoint %Tstruct.Spl_json_value_t_t* %161 to i32
  %163 = call i8* @c_fetch_pointer_from_offset(i32 %162)
  %164 = call i1 @c_isTaintedPointerToTaintedMem(i8* %163)
  br i1 %164, label %_Dynamic_check.succeeded92, label %_Dynamic_check.failed91

_Dynamic_check.succeeded92:                       ; preds = %sw.bb90
  %165 = bitcast i8* %163 to %Tstruct.Spl_json_value_t_t*
  %call93 = call double bitcast (double (%Tstruct.Spl_json_value_t_t*)* @json_value_get_number to double (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %165)
  %call94 = call %Tstruct.Spl_json_value_t_t* @json_value_init_number(double %call93)
  %166 = bitcast %Tstruct.Spl_json_value_t_t* %call94 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %166, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
sw.bb95:                                          ; preds = %_Dynamic_check.succeeded
  %167 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value.addr, align 4
  %168 = ptrtoint %Tstruct.Spl_json_value_t_t* %167 to i32
  %169 = call i8* @c_fetch_pointer_from_offset(i32 %168)
  %170 = call i1 @c_isTaintedPointerToTaintedMem(i8* %169)
  br i1 %170, label %_Dynamic_check.succeeded97, label %_Dynamic_check.failed96

_Dynamic_check.succeeded97:                       ; preds = %sw.bb95
  %171 = bitcast i8* %169 to %Tstruct.Spl_json_value_t_t*
  %call98 = call i8* bitcast (i8* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_string to i8* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %171)
  store i8* %call98, i8** %temp_string, align 4
  %172 = load i8*, i8** %temp_string, align 4
  %173 = ptrtoint i8* %172 to i32
...
if.end101:                                        ; preds = %_Dynamic_check.succeeded97
  %174 = load i8*, i8** %temp_string, align 4
  ...
  br i1 %177, label %_Dynamic_check.succeeded103, label %_Dynamic_check.failed102

_Dynamic_check.succeeded103:                      ; preds = %if.end101
  %call104 = call i8* @tainted_parson_strdup(i8* %176)
  store i8* %call104, i8** %temp_string_copy, align 4
  %178 = load i8*, i8** %temp_string_copy, align 4
  %179 = ptrtoint i8* %178 to i32
  %cmp105 = icmp eq i32 %179, 0
...
if.end107:                                        ; preds = %_Dynamic_check.succeeded103
  %180 = load i8*, i8** %temp_string_copy, align 4
  ...
  br i1 %183, label %_Dynamic_check.succeeded109, label %_Dynamic_check.failed108

_Dynamic_check.succeeded109:                      ; preds = %if.end107
  %call110 = call %Tstruct.Spl_json_value_t_t* bitcast (%Tstruct.json_value_t_t* (i8*)* @json_value_init_string_no_copy to %Tstruct.Spl_json_value_t_t* (i8*)*)(i8* %182)
  %184 = bitcast %Tstruct.Spl_json_value_t_t* %call110 to %Tstruct.json_value_t_t*
  %185 = bitcast %Tstruct.json_value_t_t* %184 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %185, %Tstruct.Spl_json_value_t_t** %return_value, align 4
  %186 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %return_value, align 4
  %187 = ptrtoint %Tstruct.Spl_json_value_t_t* %186 to i32
  %cmp111 = icmp eq i32 %187, 0
...
if.then112:                                       ; preds = %_Dynamic_check.succeeded109
  ...
  %_Dynamic_check.is_null = icmp eq i8* %188, null
  br i1 %_Dynamic_check.is_null, label %_Dynamic_check.success, label %_Dynamic_check.subsumption

_Dynamic_check.subsumption:                       ; preds = %if.then112
  %189 = load i8*, i8** %temp_string_copy, align 4
  %190 = load i8*, i8** %temp_string_copy, align 4
  %add.ptr = getelementptr inbounds i8, i8* %190, i64 0
  %_Dynamic_check.non_null = icmp ne i8* %188, null
...
_Dynamic_check.succeeded114:                      ; preds = %_Dynamic_check.subsumption
  %add.ptr115 = getelementptr inbounds i8, i8* %188, i64 0
  %191 = call i64 @c_TPtoO(i8* %189)
  %192 = inttoptr i64 %191 to i8*
  %193 = call i64 @c_TPtoO(i8* %188)
  %194 = inttoptr i64 %193 to i8*
  %_Dynamic_check.lower = icmp ule i8* %192, %194
  %195 = call i64 @c_TPtoO(i8* %add.ptr115)
  %196 = inttoptr i64 %195 to i8*
  %197 = call i64 @c_TPtoO(i8* %add.ptr)
  %198 = inttoptr i64 %197 to i8*
  %_Dynamic_check.upper = icmp ule i8* %196, %198
  %_Dynamic_check.cast = and i1 %_Dynamic_check.lower, %_Dynamic_check.upper
...
if.end119:                                        ; preds = %_Dynamic_check.succeeded118, %_Dynamic_check.succeeded109
  %202 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %return_value, align 4
...
sw.bb120:                                         ; preds = %_Dynamic_check.succeeded
  ...
  %203 = bitcast %Tstruct.Spl_json_value_t_t* %call121 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %203, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
return:                                           ; preds = %sw.default, %sw.bb122, %sw.bb120, %if.end119, %if.then106, %if.then100, %_Dynamic_check.succeeded92, %_Dynamic_check.succeeded87, %for.end84, %_Dynamic_check.succeeded80, %_Dynamic_check.succeeded66, %if.then41, %for.end, %_Dynamic_check.succeeded33, %_Dynamic_check.succeeded21, %if.then
  %204 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %retval, align 4
  ret %Tstruct.Spl_json_value_t_t* %204
}
...
_Dynamic_check.succeeded10:                       ; preds = %if.end
  ...
  %25 = bitcast %Tstruct.Spl_json_value_t_t* %call11 to %Tstruct.Spl_json_value_t_t*
  %26 = ptrtoint %Tstruct.Spl_json_value_t_t* %25 to i32
  %27 = call i8* @c_fetch_pointer_from_offset(i32 %26)
  %28 = call i1 @c_isTaintedPointerToTaintedMem(i8* %27)
  br i1 %28, label %_Dynamic_check.succeeded13, label %_Dynamic_check.failed12

_Dynamic_check.succeeded13:                       ; preds = %_Dynamic_check.succeeded10
  %29 = bitcast i8* %27 to %Tstruct.Spl_json_value_t_t*
  call void bitcast (void (%Tstruct.Spl_json_value_t_t*)* @json_value_free to void (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %29)
  ...
  %32 = call i8* @c_fetch_pointer_from_offset(i32 %31)
  %33 = call i1 @c_isTaintedPointerToTaintedMem(i8* %32)
  br i1 %33, label %_Dynamic_check.succeeded15, label %_Dynamic_check.failed14

_Dynamic_check.succeeded15:                       ; preds = %_Dynamic_check.succeeded13
  %34 = bitcast i8* %32 to %Tstruct.Spl_json_array_t_t*
  %call16 = call %Tstruct.Spl_json_value_t_t* @json_array_get_wrapping_value(%Tstruct.Spl_json_array_t_t* %34)
  %35 = bitcast %Tstruct.Spl_json_value_t_t* %call16 to %Tstruct.json_value_t_t*
...
_Dynamic_check.succeeded18:                       ; preds = %_Dynamic_check.succeeded15
  ...
  %parent19 = getelementptr inbounds %Tstruct.Spl_json_value_t_t, %Tstruct.Spl_json_value_t_t* %40, i32 0, i32 0
  %parent20 = bitcast i32* %parent19 to %Tstruct.Spl_json_value_t_t**
  %41 = bitcast %Tstruct.json_value_t_t* %35 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %41, %Tstruct.Spl_json_value_t_t** %parent20, align 8
  %42 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value.addr, align 4
  %43 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %array.addr, align 4
  ...
  br i1 %46, label %_Dynamic_check.succeeded22, label %_Dynamic_check.failed21

_Dynamic_check.succeeded22:                       ; preds = %_Dynamic_check.succeeded18
  %47 = bitcast i8* %45 to %Tstruct.Spl_json_array_t_t*
  %items = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %47, i32 0, i32 1
  %items23 = bitcast i32* %items to %Tstruct.Spl_json_value_t_t***
  %48 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.Spl_json_value_t_t*** %items23, align 4
  %49 = load i64, i64* %ix.addr, align 8
  %50 = ptrtoint %Tstruct.Spl_json_value_t_t** %48 to i32
...
_Dynamic_check.succeeded25:                       ; preds = %_Dynamic_check.succeeded22
  ...
  %54 = bitcast %Tstruct.Spl_json_value_t_t** %53 to i32*
  %arrayidx = getelementptr inbounds i32, i32* %54, i64 %49
  %55 = bitcast i32* %arrayidx to %Tstruct.Spl_json_value_t_t**
  %56 = bitcast %Tstruct.Spl_json_value_t_t** %55 to i8*
...
_Dynamic_check.succeeded27:                       ; preds = %_Dynamic_check.succeeded25
  ...
  %items28 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %63, i32 0, i32 1
  %items29 = bitcast i32* %items28 to %Tstruct.Spl_json_value_t_t***
  %64 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.Spl_json_value_t_t*** %items29, align 4
  ...
  br i1 %68, label %_Dynamic_check.succeeded31, label %_Dynamic_check.failed30

_Dynamic_check.succeeded31:                       ; preds = %_Dynamic_check.succeeded27
  %69 = bitcast i8* %67 to %Tstruct.Spl_json_array_t_t*
  %items32 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %69, i32 0, i32 1
  %items33 = bitcast i32* %items32 to %Tstruct.Spl_json_value_t_t***
  %70 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.Spl_json_value_t_t*** %items33, align 4
  ...
  br i1 %74, label %_Dynamic_check.succeeded35, label %_Dynamic_check.failed34

_Dynamic_check.succeeded35:                       ; preds = %_Dynamic_check.succeeded31
  %75 = bitcast i8* %73 to %Tstruct.Spl_json_array_t_t*
  %capacity = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %75, i32 0, i32 3
  %76 = load i32, i32* %capacity, align 4
  %idx.ext = zext i32 %76 to i64
  %add.ptr = getelementptr inbounds %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %70, i64 %idx.ext
  %77 = bitcast %Tstruct.Spl_json_value_t_t** %70 to i32*
  %78 = getelementptr inbounds i32, i32* %77, i64 %idx.ext
  %79 = bitcast i32* %78 to %Tstruct.Spl_json_value_t_t**
  %80 = bitcast %Tstruct.Spl_json_value_t_t** %79 to i8*
  %81 = call i64 @c_TPtoO(i8* %80)
  %82 = inttoptr i64 %81 to %Tstruct.Spl_json_value_t_t**
  %83 = bitcast %Tstruct.Spl_json_value_t_t** %64 to i8*
  %84 = call i64 @c_TPtoO(i8* %83)
  %85 = inttoptr i64 %84 to %Tstruct.Spl_json_value_t_t**
  %_Dynamic_check.lower = icmp ule %Tstruct.Spl_json_value_t_t** %85, %58
  %_Dynamic_check.upper = icmp ult %Tstruct.Spl_json_value_t_t** %58, %82
  %_Dynamic_check.range = and i1 %_Dynamic_check.lower, %_Dynamic_check.upper
...
_Dynamic_check.succeeded37:                       ; preds = %_Dynamic_check.succeeded35
  store %Tstruct.Spl_json_value_t_t* %42, %Tstruct.Spl_json_value_t_t** %55, align 8
  store i32 0, i32* %retval, align 4
  br label %return
...
_Dynamic_check.succeeded2:                        ; preds = %if.end
  ...
  %17 = call i8* @c_fetch_pointer_from_offset(i32 %16)
  %18 = call i1 @c_isTaintedPointerToTaintedMem(i8* %17)
  br i1 %18, label %_Dynamic_check.succeeded4, label %_Dynamic_check.failed3

_Dynamic_check.succeeded4:                        ; preds = %_Dynamic_check.succeeded2
  %19 = bitcast i8* %17 to %Tstruct.Spl_json_value_t_t*
  %call5 = call i32 @json_array_replace_value(%Tstruct.Spl_json_array_t_t* %15, i64 %10, %Tstruct.Spl_json_value_t_t* %19)
...
entry:
  ...
  %3 = bitcast %Tstruct.json_value_t_t* %2 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %3, %Tstruct.Spl_json_value_t_t** %value, align 4
  %4 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value, align 4
  %5 = ptrtoint %Tstruct.Spl_json_value_t_t* %4 to i32
  %cmp = icmp eq i32 %5, 0
  br i1 %cmp, label %if.then, label %if.end
...
if.end:                                           ; preds = %entry
  ...
  %8 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value, align 4
  %9 = ptrtoint %Tstruct.Spl_json_array_t_t* %6 to i32
  %10 = call i8* @c_fetch_pointer_from_offset(i32 %9)
  %11 = call i1 @c_isTaintedPointerToTaintedMem(i8* %10)
...
_Dynamic_check.succeeded:                         ; preds = %if.end
  ...
  %13 = ptrtoint %Tstruct.Spl_json_value_t_t* %8 to i32
  %14 = call i8* @c_fetch_pointer_from_offset(i32 %13)
  %15 = call i1 @c_isTaintedPointerToTaintedMem(i8* %14)
...
_Dynamic_check.succeeded2:                        ; preds = %_Dynamic_check.succeeded
  %16 = bitcast i8* %14 to %Tstruct.Spl_json_value_t_t*
  %call3 = call i32 @json_array_replace_value(%Tstruct.Spl_json_array_t_t* %12, i64 %7, %Tstruct.Spl_json_value_t_t* %16)
...
if.then5:                                         ; preds = %_Dynamic_check.succeeded2
  ...
  %19 = call i8* @c_fetch_pointer_from_offset(i32 %18)
  %20 = call i1 @c_isTaintedPointerToTaintedMem(i8* %19)
  br i1 %20, label %_Dynamic_check.succeeded7, label %_Dynamic_check.failed6

_Dynamic_check.succeeded7:                        ; preds = %if.then5
  %21 = bitcast i8* %19 to %Tstruct.Spl_json_value_t_t*
  call void bitcast (void (%Tstruct.Spl_json_value_t_t*)* @json_value_free to void (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %21)
  store i32 -1, i32* %retval, align 4
  br label %return
...
entry:
  ...
  %2 = bitcast %Tstruct.json_value_t_t* %1 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %2, %Tstruct.Spl_json_value_t_t** %value, align 4
  %3 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value, align 4
  %4 = ptrtoint %Tstruct.Spl_json_value_t_t* %3 to i32
  %cmp = icmp eq i32 %4, 0
  br i1 %cmp, label %if.then, label %if.end
...
_Dynamic_check.succeeded:                         ; preds = %if.end
  ...
  %12 = ptrtoint %Tstruct.Spl_json_value_t_t* %7 to i32
  %13 = call i8* @c_fetch_pointer_from_offset(i32 %12)
  %14 = call i1 @c_isTaintedPointerToTaintedMem(i8* %13)
  br i1 %14, label %_Dynamic_check.succeeded2, label %_Dynamic_check.failed1
...
_Dynamic_check.succeeded2:                        ; preds = %_Dynamic_check.succeeded
  ...
  %call3 = call i32 @json_array_replace_value(%Tstruct.Spl_json_array_t_t* %11, i64 %6, %Tstruct.Spl_json_value_t_t* %15)
  %cmp4 = icmp eq i32 %call3, -1
  br i1 %cmp4, label %if.then5, label %if.end8
...
_Dynamic_check.succeeded7:                        ; preds = %if.then5
  ...
  call void bitcast (void (%Tstruct.Spl_json_value_t_t*)* @json_value_free to void (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %20)
  store i32 -1, i32* %retval, align 4
  br label %return
...
_Dynamic_check.succeeded3:                        ; preds = %for.body
  ...
  %15 = bitcast %Tstruct.Spl_json_value_t_t* %call4 to %Tstruct.Spl_json_value_t_t*
  %16 = ptrtoint %Tstruct.Spl_json_value_t_t* %15 to i32
  %17 = call i8* @c_fetch_pointer_from_offset(i32 %16)
  %18 = call i1 @c_isTaintedPointerToTaintedMem(i8* %17)
  br i1 %18, label %_Dynamic_check.succeeded6, label %_Dynamic_check.failed5
...
_Dynamic_check.succeeded6:                        ; preds = %_Dynamic_check.succeeded3
  %19 = bitcast i8* %17 to %Tstruct.Spl_json_value_t_t*
  call void bitcast (void (%Tstruct.Spl_json_value_t_t*)* @json_value_free to void (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %19)
  br label %for.inc
...
for.end:                                          ; preds = %_Dynamic_check.succeeded
  %21 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %array.addr, align 4
  %22 = ptrtoint %Tstruct.Spl_json_array_t_t* %21 to i32
  %23 = call i8* @c_fetch_pointer_from_offset(i32 %22)
  %24 = call i1 @c_isTaintedPointerToTaintedMem(i8* %23)
  br i1 %24, label %_Dynamic_check.succeeded8, label %_Dynamic_check.failed7

_Dynamic_check.succeeded8:                        ; preds = %for.end
  %25 = bitcast i8* %23 to %Tstruct.Spl_json_array_t_t*
  %count = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %25, i32 0, i32 2
...
_Dynamic_check.succeeded4:                        ; preds = %_Dynamic_check.succeeded2
  %18 = bitcast i8* %16 to %Tstruct.Spl_json_value_t_t*
  %call5 = call i32 bitcast (i32 (%Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_value_t_t*)* @json_array_append_value to i32 (%Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_array_t_t* %14, %Tstruct.Spl_json_value_t_t* %18)
  %cmp6 = icmp eq i32 %call5, -1
  br i1 %cmp6, label %if.then7, label %if.end10
...
if.end:                                           ; preds = %entry
  %6 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %array.addr, align 4
  %7 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value, align 4
  %8 = ptrtoint %Tstruct.Spl_json_array_t_t* %6 to i32
  %9 = call i8* @c_fetch_pointer_from_offset(i32 %8)
  %10 = call i1 @c_isTaintedPointerToTaintedMem(i8* %9)
  br i1 %10, label %_Dynamic_check.succeeded, label %_Dynamic_check.failed
...
_Dynamic_check.succeeded2:                        ; preds = %_Dynamic_check.succeeded
  %15 = bitcast i8* %13 to %Tstruct.Spl_json_value_t_t*
  %call3 = call i32 bitcast (i32 (%Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_value_t_t*)* @json_array_append_value to i32 (%Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_array_t_t* %11, %Tstruct.Spl_json_value_t_t* %15)
  %cmp4 = icmp eq i32 %call3, -1
  br i1 %cmp4, label %if.then5, label %if.end8
...
_Dynamic_check.succeeded:                         ; preds = %if.end
  ...
  %11 = ptrtoint %Tstruct.Spl_json_value_t_t* %6 to i32
  %12 = call i8* @c_fetch_pointer_from_offset(i32 %11)
  %13 = call i1 @c_isTaintedPointerToTaintedMem(i8* %12)
  br i1 %13, label %_Dynamic_check.succeeded2, label %_Dynamic_check.failed1
...
_Dynamic_check.succeeded2:                        ; preds = %_Dynamic_check.succeeded
  %14 = bitcast i8* %12 to %Tstruct.Spl_json_value_t_t*
  %call3 = call i32 bitcast (i32 (%Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_value_t_t*)* @json_array_append_value to i32 (%Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_array_t_t* %10, %Tstruct.Spl_json_value_t_t* %14)
  %cmp4 = icmp eq i32 %call3, -1
  br i1 %cmp4, label %if.then5, label %if.end8
...
if.then5:                                         ; preds = %_Dynamic_check.succeeded2
  ...
  %17 = call i8* @c_fetch_pointer_from_offset(i32 %16)
  %18 = call i1 @c_isTaintedPointerToTaintedMem(i8* %17)
  br i1 %18, label %_Dynamic_check.succeeded7, label %_Dynamic_check.failed6
...
_Dynamic_check.succeeded10:                       ; preds = %_Dynamic_check.succeeded8
  ...
  %25 = bitcast %Tstruct.json_value_t_t* %24 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %25, %Tstruct.Spl_json_value_t_t** %old_value, align 4
  %26 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %old_value, align 4
...
if.then12:                                        ; preds = %_Dynamic_check.succeeded10
  %28 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %old_value, align 4
  %29 = ptrtoint %Tstruct.Spl_json_value_t_t* %28 to i32
  %30 = call i8* @c_fetch_pointer_from_offset(i32 %29)
  %31 = call i1 @c_isTaintedPointerToTaintedMem(i8* %30)
  br i1 %31, label %_Dynamic_check.succeeded14, label %_Dynamic_check.failed13
...
for.cond:                                         ; preds = %for.inc, %_Dynamic_check.succeeded14
  ...
  %35 = ptrtoint %Tstruct.Spl_json_object_t_t* %34 to i32
  %36 = call i8* @c_fetch_pointer_from_offset(i32 %35)
  %37 = call i1 @c_isTaintedPointerToTaintedMem(i8* %36)
  br i1 %37, label %_Dynamic_check.succeeded16, label %_Dynamic_check.failed15

_Dynamic_check.succeeded16:                       ; preds = %for.cond
  %38 = bitcast i8* %36 to %Tstruct.Spl_json_object_t_t*
  %call17 = call i64 bitcast (i64 (%Tstruct.Spl_json_object_t_t*)* @json_object_get_count to i64 (%Tstruct.Spl_json_object_t_t*)*)(%Tstruct.Spl_json_object_t_t* %38)
  %cmp18 = icmp ult i64 %33, %call17
...
for.body:                                         ; preds = %_Dynamic_check.succeeded16
  ...
  %41 = call i8* @c_fetch_pointer_from_offset(i32 %40)
  %42 = call i1 @c_isTaintedPointerToTaintedMem(i8* %41)
  br i1 %42, label %_Dynamic_check.succeeded20, label %_Dynamic_check.failed19

_Dynamic_check.succeeded20:                       ; preds = %for.body
  %43 = bitcast i8* %41 to %Tstruct.Spl_json_object_t_t*
  %names = getelementptr inbounds %Tstruct.Spl_json_object_t_t, %Tstruct.Spl_json_object_t_t* %43, i32 0, i32 1
  %names21 = bitcast i32* %names to i8***
  %44 = load i8**, i8*** %names21, align 4
  %45 = load i64, i64* %i, align 8
  %46 = ptrtoint i8** %44 to i32
  %47 = call i8* @c_fetch_pointer_from_offset(i32 %46)
  %48 = call i1 @c_isTaintedPointerToTaintedMem(i8* %47)
  br i1 %48, label %_Dynamic_check.succeeded23, label %_Dynamic_check.failed22

_Dynamic_check.succeeded23:                       ; preds = %_Dynamic_check.succeeded20
  %49 = bitcast i8* %47 to i8**
  %50 = bitcast i8** %49 to i32*
  %arrayidx = getelementptr inbounds i32, i32* %50, i64 %45
  %51 = bitcast i32* %arrayidx to i8**
...
_Dynamic_check.succeeded25:                       ; preds = %_Dynamic_check.succeeded23
  ...
  %names26 = getelementptr inbounds %Tstruct.Spl_json_object_t_t, %Tstruct.Spl_json_object_t_t* %59, i32 0, i32 1
  %names27 = bitcast i32* %names26 to i8***
  %60 = load i8**, i8*** %names27, align 4
  %61 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %object.addr, align 4
  %62 = ptrtoint %Tstruct.Spl_json_object_t_t* %61 to i32
  %63 = call i8* @c_fetch_pointer_from_offset(i32 %62)
  %64 = call i1 @c_isTaintedPointerToTaintedMem(i8* %63)
  br i1 %64, label %_Dynamic_check.succeeded29, label %_Dynamic_check.failed28

_Dynamic_check.succeeded29:                       ; preds = %_Dynamic_check.succeeded25
  %65 = bitcast i8* %63 to %Tstruct.Spl_json_object_t_t*
  %names30 = getelementptr inbounds %Tstruct.Spl_json_object_t_t, %Tstruct.Spl_json_object_t_t* %65, i32 0, i32 1
  %names31 = bitcast i32* %names30 to i8***
  %66 = load i8**, i8*** %names31, align 4
...
_Dynamic_check.succeeded33:                       ; preds = %_Dynamic_check.succeeded29
  ...
  %capacity = getelementptr inbounds %Tstruct.Spl_json_object_t_t, %Tstruct.Spl_json_object_t_t* %71, i32 0, i32 4
  %72 = load i32, i32* %capacity, align 8
  %idx.ext = zext i32 %72 to i64
  %add.ptr = getelementptr inbounds i8*, i8** %66, i64 %idx.ext
  %73 = bitcast i8** %add.ptr to i8*
  %74 = call i64 @c_TPtoO(i8* %73)
  %75 = inttoptr i64 %74 to i8**
  %76 = bitcast i8** %60 to i8*
  %77 = call i64 @c_TPtoO(i8* %76)
  %78 = inttoptr i64 %77 to i8**
  %_Dynamic_check.lower = icmp ule i8** %78, %54
  %_Dynamic_check.upper = icmp ult i8** %54, %75
  %_Dynamic_check.range = and i1 %_Dynamic_check.lower, %_Dynamic_check.upper
...
_Dynamic_check.succeeded35:                       ; preds = %_Dynamic_check.succeeded33
  ...
  %84 = call i8* @c_ConditionalTaintedOff2Ptr(i64 %83)
  %call36 = call i32 @t_strcmp(i8* %82, i8* %84)
  %cmp37 = icmp eq i32 %call36, 0
  br i1 %cmp37, label %if.then38, label %if.end70

if.then38:                                        ; preds = %_Dynamic_check.succeeded35
  %85 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %object.addr, align 4
  %86 = ptrtoint %Tstruct.Spl_json_object_t_t* %85 to i32
  %87 = call i8* @c_fetch_pointer_from_offset(i32 %86)
  %88 = call i1 @c_isTaintedPointerToTaintedMem(i8* %87)
  br i1 %88, label %_Dynamic_check.succeeded40, label %_Dynamic_check.failed39

_Dynamic_check.succeeded40:                       ; preds = %if.then38
  %89 = bitcast i8* %87 to %Tstruct.Spl_json_object_t_t*
  %call41 = call %Tstruct.Spl_json_value_t_t* @json_object_get_wrapping_value(%Tstruct.Spl_json_object_t_t* %89)
  %90 = bitcast %Tstruct.Spl_json_value_t_t* %call41 to %Tstruct.json_value_t_t*
  %91 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value.addr, align 4
  %92 = ptrtoint %Tstruct.Spl_json_value_t_t* %91 to i32
  %93 = call i8* @c_fetch_pointer_from_offset(i32 %92)
  %94 = call i1 @c_isTaintedPointerToTaintedMem(i8* %93)
  br i1 %94, label %_Dynamic_check.succeeded43, label %_Dynamic_check.failed42

_Dynamic_check.succeeded43:                       ; preds = %_Dynamic_check.succeeded40
  %95 = bitcast i8* %93 to %Tstruct.Spl_json_value_t_t*
  %parent44 = getelementptr inbounds %Tstruct.Spl_json_value_t_t, %Tstruct.Spl_json_value_t_t* %95, i32 0, i32 0
  %parent45 = bitcast i32* %parent44 to %Tstruct.Spl_json_value_t_t**
  %96 = bitcast %Tstruct.json_value_t_t* %90 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %96, %Tstruct.Spl_json_value_t_t** %parent45, align 8
...
_Dynamic_check.succeeded47:                       ; preds = %_Dynamic_check.succeeded43
  ...
  %values = getelementptr inbounds %Tstruct.Spl_json_object_t_t, %Tstruct.Spl_json_object_t_t* %102, i32 0, i32 2
  %values48 = bitcast i32* %values to %Tstruct.Spl_json_value_t_t***
  %103 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.Spl_json_value_t_t*** %values48, align 4
  %104 = load i64, i64* %i, align 8
  %105 = ptrtoint %Tstruct.Spl_json_value_t_t** %103 to i32
  %106 = call i8* @c_fetch_pointer_from_offset(i32 %105)
  %107 = call i1 @c_isTaintedPointerToTaintedMem(i8* %106)
  br i1 %107, label %_Dynamic_check.succeeded50, label %_Dynamic_check.failed49

_Dynamic_check.succeeded50:                       ; preds = %_Dynamic_check.succeeded47
  %108 = bitcast i8* %106 to %Tstruct.Spl_json_value_t_t**
  %109 = bitcast %Tstruct.Spl_json_value_t_t** %108 to i32*
  %arrayidx51 = getelementptr inbounds i32, i32* %109, i64 %104
  %110 = bitcast i32* %arrayidx51 to %Tstruct.Spl_json_value_t_t**
  %111 = bitcast %Tstruct.Spl_json_value_t_t** %110 to i8*
  %112 = call i64 @c_TPtoO(i8* %111)
  %113 = inttoptr i64 %112 to %Tstruct.Spl_json_value_t_t**
  ...
  %116 = call i8* @c_fetch_pointer_from_offset(i32 %115)
  %117 = call i1 @c_isTaintedPointerToTaintedMem(i8* %116)
  br i1 %117, label %_Dynamic_check.succeeded53, label %_Dynamic_check.failed52

_Dynamic_check.succeeded53:                       ; preds = %_Dynamic_check.succeeded50
  %118 = bitcast i8* %116 to %Tstruct.Spl_json_object_t_t*
  %values54 = getelementptr inbounds %Tstruct.Spl_json_object_t_t, %Tstruct.Spl_json_object_t_t* %118, i32 0, i32 2
  %values55 = bitcast i32* %values54 to %Tstruct.Spl_json_value_t_t***
  %119 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.Spl_json_value_t_t*** %values55, align 4
  ...
  br i1 %123, label %_Dynamic_check.succeeded57, label %_Dynamic_check.failed56

_Dynamic_check.succeeded57:                       ; preds = %_Dynamic_check.succeeded53
  %124 = bitcast i8* %122 to %Tstruct.Spl_json_object_t_t*
  %values58 = getelementptr inbounds %Tstruct.Spl_json_object_t_t, %Tstruct.Spl_json_object_t_t* %124, i32 0, i32 2
  %values59 = bitcast i32* %values58 to %Tstruct.Spl_json_value_t_t***
  %125 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.Spl_json_value_t_t*** %values59, align 4
  ...
  br i1 %129, label %_Dynamic_check.succeeded61, label %_Dynamic_check.failed60

_Dynamic_check.succeeded61:                       ; preds = %_Dynamic_check.succeeded57
  %130 = bitcast i8* %128 to %Tstruct.Spl_json_object_t_t*
  %capacity62 = getelementptr inbounds %Tstruct.Spl_json_object_t_t, %Tstruct.Spl_json_object_t_t* %130, i32 0, i32 4
  %131 = load i32, i32* %capacity62, align 8
  %idx.ext63 = zext i32 %131 to i64
  %add.ptr64 = getelementptr inbounds %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %125, i64 %idx.ext63
  %132 = bitcast %Tstruct.Spl_json_value_t_t** %125 to i32*
  %133 = getelementptr inbounds i32, i32* %132, i64 %idx.ext63
  %134 = bitcast i32* %133 to %Tstruct.Spl_json_value_t_t**
  %135 = bitcast %Tstruct.Spl_json_value_t_t** %134 to i8*
  %136 = call i64 @c_TPtoO(i8* %135)
  %137 = inttoptr i64 %136 to %Tstruct.Spl_json_value_t_t**
  %138 = bitcast %Tstruct.Spl_json_value_t_t** %119 to i8*
  %139 = call i64 @c_TPtoO(i8* %138)
  %140 = inttoptr i64 %139 to %Tstruct.Spl_json_value_t_t**
  %_Dynamic_check.lower65 = icmp ule %Tstruct.Spl_json_value_t_t** %140, %113
  %_Dynamic_check.upper66 = icmp ult %Tstruct.Spl_json_value_t_t** %113, %137
...
_Dynamic_check.succeeded69:                       ; preds = %_Dynamic_check.succeeded61
  store %Tstruct.Spl_json_value_t_t* %97, %Tstruct.Spl_json_value_t_t** %110, align 8
  store i32 0, i32* %retval, align 4
  br label %return
...
if.end71:                                         ; preds = %for.end, %_Dynamic_check.succeeded10
  ...
  %143 = load i8*, i8** %name.addr, align 4
  %144 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value.addr, align 4
  %145 = ptrtoint %Tstruct.Spl_json_object_t_t* %142 to i32
  %146 = call i8* @c_fetch_pointer_from_offset(i32 %145)
  %147 = call i1 @c_isTaintedPointerToTaintedMem(i8* %146)
  br i1 %147, label %_Dynamic_check.succeeded73, label %_Dynamic_check.failed72

_Dynamic_check.succeeded73:                       ; preds = %if.end71
  %148 = bitcast i8* %146 to %Tstruct.Spl_json_object_t_t*
  %149 = ptrtoint i8* %143 to i32
  %150 = call i8* @c_fetch_pointer_from_offset(i32 %149)
  %151 = call i1 @c_isTaintedPointerToTaintedMem(i8* %150)
  br i1 %151, label %_Dynamic_check.succeeded75, label %_Dynamic_check.failed74

_Dynamic_check.succeeded75:                       ; preds = %_Dynamic_check.succeeded73
  %152 = ptrtoint %Tstruct.Spl_json_value_t_t* %144 to i32
  %153 = call i8* @c_fetch_pointer_from_offset(i32 %152)
  %154 = call i1 @c_isTaintedPointerToTaintedMem(i8* %153)
  br i1 %154, label %_Dynamic_check.succeeded77, label %_Dynamic_check.failed76

_Dynamic_check.succeeded77:                       ; preds = %_Dynamic_check.succeeded75
  %155 = bitcast i8* %153 to %Tstruct.Spl_json_value_t_t*
  %call78 = call i32 bitcast (i32 (%Tstruct.json_object_t_t*, i8*, %Tstruct.json_value_t_t*)* @json_object_add to i32 (%Tstruct.Spl_json_object_t_t*, i8*, %Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_object_t_t* %148, i8* %150, %Tstruct.Spl_json_value_t_t* %155)
...
_Dynamic_check.succeeded6:                        ; preds = %_Dynamic_check.succeeded4
  %18 = bitcast i8* %16 to %Tstruct.Spl_json_value_t_t*
  %call7 = call i32 bitcast (i32 (%Tstruct.Spl_json_object_t_t*, i8*, %Tstruct.Spl_json_value_t_t*)* @json_object_set_value to i32 (%Tstruct.Spl_json_object_t_t*, i8*, %Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_object_t_t* %11, i8* %13, %Tstruct.Spl_json_value_t_t* %18)
  ret i32 %call7
...
entry:
  ...
  %4 = bitcast %Tstruct.Spl_json_value_t_t* %call to %Tstruct.Spl_json_value_t_t*
  %5 = ptrtoint %Tstruct.Spl_json_object_t_t* %1 to i32
  %6 = call i8* @c_fetch_pointer_from_offset(i32 %5)
  %7 = call i1 @c_isTaintedPointerToTaintedMem(i8* %6)
  br i1 %7, label %_Dynamic_check.succeeded, label %_Dynamic_check.failed
...
_Dynamic_check.succeeded2:                        ; preds = %_Dynamic_check.succeeded
  %12 = ptrtoint %Tstruct.Spl_json_value_t_t* %4 to i32
  %13 = call i8* @c_fetch_pointer_from_offset(i32 %12)
  %14 = call i1 @c_isTaintedPointerToTaintedMem(i8* %13)
  br i1 %14, label %_Dynamic_check.succeeded4, label %_Dynamic_check.failed3
...
_Dynamic_check.succeeded4:                        ; preds = %_Dynamic_check.succeeded2
  %15 = bitcast i8* %13 to %Tstruct.Spl_json_value_t_t*
  %call5 = call i32 bitcast (i32 (%Tstruct.Spl_json_object_t_t*, i8*, %Tstruct.Spl_json_value_t_t*)* @json_object_set_value to i32 (%Tstruct.Spl_json_object_t_t*, i8*, %Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_object_t_t* %8, i8* %10, %Tstruct.Spl_json_value_t_t* %15)
  ret i32 %call5
...
entry:
  ...
  %2 = load i8*, i8** %name.addr, align 4
  %call = call %Tstruct.Spl_json_value_t_t* @json_value_init_null()
  %3 = bitcast %Tstruct.Spl_json_value_t_t* %call to %Tstruct.Spl_json_value_t_t*
  %4 = ptrtoint %Tstruct.Spl_json_object_t_t* %1 to i32
  %5 = call i8* @c_fetch_pointer_from_offset(i32 %4)
  %6 = call i1 @c_isTaintedPointerToTaintedMem(i8* %5)
  br i1 %6, label %_Dynamic_check.succeeded, label %_Dynamic_check.failed
...
_Dynamic_check.succeeded2:                        ; preds = %_Dynamic_check.succeeded
  %11 = ptrtoint %Tstruct.Spl_json_value_t_t* %3 to i32
  %12 = call i8* @c_fetch_pointer_from_offset(i32 %11)
  %13 = call i1 @c_isTaintedPointerToTaintedMem(i8* %12)
  br i1 %13, label %_Dynamic_check.succeeded4, label %_Dynamic_check.failed3
...
_Dynamic_check.succeeded4:                        ; preds = %_Dynamic_check.succeeded2
  %14 = bitcast i8* %12 to %Tstruct.Spl_json_value_t_t*
  %call5 = call i32 bitcast (i32 (%Tstruct.Spl_json_object_t_t*, i8*, %Tstruct.Spl_json_value_t_t*)* @json_object_set_value to i32 (%Tstruct.Spl_json_object_t_t*, i8*, %Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_object_t_t* %7, i8* %9, %Tstruct.Spl_json_value_t_t* %14)
  ret i32 %call5
...
_Dynamic_check.succeeded17:                       ; preds = %_Dynamic_check.succeeded15
  ...
  %43 = bitcast %Tstruct.json_value_t_t* %42 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %43, %Tstruct.Spl_json_value_t_t** %temp_value, align 4
  %44 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %temp_value, align 4
  %tobool = icmp ne %Tstruct.Spl_json_value_t_t* %44, null
  br i1 %tobool, label %if.then19, label %if.end36

if.then19:                                        ; preds = %_Dynamic_check.succeeded17
  %45 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %temp_value, align 4
  %46 = ptrtoint %Tstruct.Spl_json_value_t_t* %45 to i32
  %47 = call i8* @c_fetch_pointer_from_offset(i32 %46)
  %48 = call i1 @c_isTaintedPointerToTaintedMem(i8* %47)
...
_Dynamic_check.succeeded21:                       ; preds = %if.then19
  ...
  %call22 = call i32 bitcast (i32 (%Tstruct.Spl_json_value_t_t*)* @json_value_get_type to i32 (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %49)
...
if.end25:                                         ; preds = %_Dynamic_check.succeeded21
  ...
  %52 = call i8* @c_fetch_pointer_from_offset(i32 %51)
  %53 = call i1 @c_isTaintedPointerToTaintedMem(i8* %52)
  br i1 %53, label %_Dynamic_check.succeeded27, label %_Dynamic_check.failed26

_Dynamic_check.succeeded27:                       ; preds = %if.end25
  %54 = bitcast i8* %52 to %Tstruct.Spl_json_value_t_t*
  %call28 = call %Tstruct.Spl_json_object_t_t* bitcast (%Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_object to %Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %54)
  %55 = bitcast %Tstruct.Spl_json_object_t_t* %call28 to %Tstruct.json_object_t_t*
  %56 = bitcast %Tstruct.json_object_t_t* %55 to %Tstruct.Spl_json_object_t_t*
  store %Tstruct.Spl_json_object_t_t* %56, %Tstruct.Spl_json_object_t_t** %temp_object, align 4
  %57 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %temp_object, align 4
  %58 = load i8*, i8** %after_dot, align 4
  %59 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value.addr, align 4
  %60 = ptrtoint %Tstruct.Spl_json_object_t_t* %57 to i32
  %61 = call i8* @c_fetch_pointer_from_offset(i32 %60)
  %62 = call i1 @c_isTaintedPointerToTaintedMem(i8* %61)
...
_Dynamic_check.succeeded30:                       ; preds = %_Dynamic_check.succeeded27
  %63 = bitcast i8* %61 to %Tstruct.Spl_json_object_t_t*
  %64 = ptrtoint i8* %58 to i32
  %65 = call i8* @c_fetch_pointer_from_offset(i32 %64)
  %66 = call i1 @c_isTaintedPointerToTaintedMem(i8* %65)
  br i1 %66, label %_Dynamic_check.succeeded32, label %_Dynamic_check.failed31

_Dynamic_check.succeeded32:                       ; preds = %_Dynamic_check.succeeded30
  %67 = ptrtoint %Tstruct.Spl_json_value_t_t* %59 to i32
  %68 = call i8* @c_fetch_pointer_from_offset(i32 %67)
  %69 = call i1 @c_isTaintedPointerToTaintedMem(i8* %68)
  br i1 %69, label %_Dynamic_check.succeeded34, label %_Dynamic_check.failed33

_Dynamic_check.succeeded34:                       ; preds = %_Dynamic_check.succeeded32
  %70 = bitcast i8* %68 to %Tstruct.Spl_json_value_t_t*
  %call35 = call i32 bitcast (i32 (%Tstruct.Spl_json_object_t_t*, i8*, %Tstruct.Spl_json_value_t_t*)* @json_object_dotset_value to i32 (%Tstruct.Spl_json_object_t_t*, i8*, %Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_object_t_t* %63, i8* %65, %Tstruct.Spl_json_value_t_t* %70)
...
if.end36:                                         ; preds = %_Dynamic_check.succeeded17
  ...
  %71 = bitcast %Tstruct.Spl_json_value_t_t* %call37 to %Tstruct.json_value_t_t*
  %72 = bitcast %Tstruct.json_value_t_t* %71 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %72, %Tstruct.Spl_json_value_t_t** %new_value, align 4
  %73 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %new_value, align 4
  %74 = ptrtoint %Tstruct.Spl_json_value_t_t* %73 to i32
...
if.end40:                                         ; preds = %if.end36
  %75 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %new_value, align 4
...
_Dynamic_check.succeeded42:                       ; preds = %if.end40
  ...
  %call43 = call %Tstruct.Spl_json_object_t_t* bitcast (%Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_object to %Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %79)
  %80 = bitcast %Tstruct.Spl_json_object_t_t* %call43 to %Tstruct.json_object_t_t*
  %81 = bitcast %Tstruct.json_object_t_t* %80 to %Tstruct.Spl_json_object_t_t*
  store %Tstruct.Spl_json_object_t_t* %81, %Tstruct.Spl_json_object_t_t** %new_object, align 4
  %82 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %new_object, align 4
  %83 = load i8*, i8** %after_dot, align 4
  %84 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value.addr, align 4
  ...
  br i1 %87, label %_Dynamic_check.succeeded45, label %_Dynamic_check.failed44

_Dynamic_check.succeeded45:                       ; preds = %_Dynamic_check.succeeded42
  %88 = bitcast i8* %86 to %Tstruct.Spl_json_object_t_t*
  %89 = ptrtoint i8* %83 to i32
  %90 = call i8* @c_fetch_pointer_from_offset(i32 %89)
  %91 = call i1 @c_isTaintedPointerToTaintedMem(i8* %90)
  br i1 %91, label %_Dynamic_check.succeeded47, label %_Dynamic_check.failed46

_Dynamic_check.succeeded47:                       ; preds = %_Dynamic_check.succeeded45
  %92 = ptrtoint %Tstruct.Spl_json_value_t_t* %84 to i32
  %93 = call i8* @c_fetch_pointer_from_offset(i32 %92)
  %94 = call i1 @c_isTaintedPointerToTaintedMem(i8* %93)
  br i1 %94, label %_Dynamic_check.succeeded49, label %_Dynamic_check.failed48

_Dynamic_check.succeeded49:                       ; preds = %_Dynamic_check.succeeded47
  %95 = bitcast i8* %93 to %Tstruct.Spl_json_value_t_t*
  %call50 = call i32 bitcast (i32 (%Tstruct.Spl_json_object_t_t*, i8*, %Tstruct.Spl_json_value_t_t*)* @json_object_dotset_value to i32 (%Tstruct.Spl_json_object_t_t*, i8*, %Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_object_t_t* %88, i8* %90, %Tstruct.Spl_json_value_t_t* %95)
...
if.then52:                                        ; preds = %_Dynamic_check.succeeded49
  %97 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %new_value, align 4
  %98 = ptrtoint %Tstruct.Spl_json_value_t_t* %97 to i32
  %99 = call i8* @c_fetch_pointer_from_offset(i32 %98)
  %100 = call i1 @c_isTaintedPointerToTaintedMem(i8* %99)
  br i1 %100, label %_Dynamic_check.succeeded54, label %_Dynamic_check.failed53

_Dynamic_check.succeeded54:                       ; preds = %if.then52
  %101 = bitcast i8* %99 to %Tstruct.Spl_json_value_t_t*
  call void bitcast (void (%Tstruct.Spl_json_value_t_t*)* @json_value_free to void (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %101)
  store i32 -1, i32* %retval, align 4
  br label %return
...
if.end55:                                         ; preds = %_Dynamic_check.succeeded49
  ...
  %103 = load i8*, i8** %name_with_len, align 4
  %104 = load i64, i64* %name_len, align 8
  %105 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %new_value, align 4
  %106 = ptrtoint %Tstruct.Spl_json_object_t_t* %102 to i32
  %107 = call i8* @c_fetch_pointer_from_offset(i32 %106)
  %108 = call i1 @c_isTaintedPointerToTaintedMem(i8* %107)
  br i1 %108, label %_Dynamic_check.succeeded57, label %_Dynamic_check.failed56

_Dynamic_check.succeeded57:                       ; preds = %if.end55
  %109 = bitcast i8* %107 to %Tstruct.Spl_json_object_t_t*
  %110 = ptrtoint i8* %103 to i32
  %111 = call i8* @c_fetch_pointer_from_offset(i32 %110)
  %112 = call i1 @c_isTaintedPointerToTaintedMem(i8* %111)
...
_Dynamic_check.succeeded59:                       ; preds = %_Dynamic_check.succeeded57
  %113 = ptrtoint %Tstruct.Spl_json_value_t_t* %105 to i32
  %114 = call i8* @c_fetch_pointer_from_offset(i32 %113)
  %115 = call i1 @c_isTaintedPointerToTaintedMem(i8* %114)
  br i1 %115, label %_Dynamic_check.succeeded61, label %_Dynamic_check.failed60

_Dynamic_check.succeeded61:                       ; preds = %_Dynamic_check.succeeded59
  %116 = bitcast i8* %114 to %Tstruct.Spl_json_value_t_t*
  %call62 = call i32 @json_object_addn(%Tstruct.Spl_json_object_t_t* %109, i8* %111, i64 %104, %Tstruct.Spl_json_value_t_t* %116)
  store i32 %call62, i32* %status, align 4
  %117 = load i32, i32* %status, align 4
  %cmp63 = icmp ne i32 %117, 0
...
if.then64:                                        ; preds = %_Dynamic_check.succeeded61
  ...
  %121 = call i8* @c_fetch_pointer_from_offset(i32 %120)
  %122 = call i1 @c_isTaintedPointerToTaintedMem(i8* %121)
  br i1 %122, label %_Dynamic_check.succeeded66, label %_Dynamic_check.failed65
...
_Dynamic_check.succeeded66:                       ; preds = %if.then64
  ...
  br i1 %126, label %_Dynamic_check.succeeded68, label %_Dynamic_check.failed67

_Dynamic_check.succeeded68:                       ; preds = %_Dynamic_check.succeeded66
  %call69 = call i32 @json_object_dotremove_internal(%Tstruct.Spl_json_object_t_t* %123, i8* %125, i32 0)
  %127 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %new_value, align 4
  %128 = ptrtoint %Tstruct.Spl_json_value_t_t* %127 to i32
  %129 = call i8* @c_fetch_pointer_from_offset(i32 %128)
  %130 = call i1 @c_isTaintedPointerToTaintedMem(i8* %129)
  br i1 %130, label %_Dynamic_check.succeeded71, label %_Dynamic_check.failed70
...
_Dynamic_check.succeeded6:                        ; preds = %_Dynamic_check.succeeded4
  %22 = bitcast i8* %20 to %Tstruct.Spl_json_value_t_t*
  %call7 = call i32 bitcast (i32 (%Tstruct.Spl_json_object_t_t*, i8*, %Tstruct.Spl_json_value_t_t*)* @json_object_dotset_value to i32 (%Tstruct.Spl_json_object_t_t*, i8*, %Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_object_t_t* %15, i8* %17, %Tstruct.Spl_json_value_t_t* %22)
...
if.end:                                           ; preds = %entry
  ...
  %7 = load i8*, i8** %name.addr, align 4
  %8 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value, align 4
  %9 = ptrtoint %Tstruct.Spl_json_object_t_t* %6 to i32
  %10 = call i8* @c_fetch_pointer_from_offset(i32 %9)
  %11 = call i1 @c_isTaintedPointerToTaintedMem(i8* %10)
  br i1 %11, label %_Dynamic_check.succeeded, label %_Dynamic_check.failed

_Dynamic_check.succeeded:                         ; preds = %if.end
  %12 = bitcast i8* %10 to %Tstruct.Spl_json_object_t_t*
...
_Dynamic_check.succeeded2:                        ; preds = %_Dynamic_check.succeeded
  %16 = ptrtoint %Tstruct.Spl_json_value_t_t* %8 to i32
  %17 = call i8* @c_fetch_pointer_from_offset(i32 %16)
  %18 = call i1 @c_isTaintedPointerToTaintedMem(i8* %17)
  br i1 %18, label %_Dynamic_check.succeeded4, label %_Dynamic_check.failed3
...
_Dynamic_check.succeeded4:                        ; preds = %_Dynamic_check.succeeded2
  %19 = bitcast i8* %17 to %Tstruct.Spl_json_value_t_t*
  %call5 = call i32 bitcast (i32 (%Tstruct.Spl_json_object_t_t*, i8*, %Tstruct.Spl_json_value_t_t*)* @json_object_dotset_value to i32 (%Tstruct.Spl_json_object_t_t*, i8*, %Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_object_t_t* %12, i8* %14, %Tstruct.Spl_json_value_t_t* %19)
  %cmp6 = icmp eq i32 %call5, -1
  br i1 %cmp6, label %if.then7, label %if.end10
...
_Dynamic_check.succeeded4:                        ; preds = %_Dynamic_check.succeeded2
  %18 = bitcast i8* %16 to %Tstruct.Spl_json_value_t_t*
  %call5 = call i32 bitcast (i32 (%Tstruct.Spl_json_object_t_t*, i8*, %Tstruct.Spl_json_value_t_t*)* @json_object_dotset_value to i32 (%Tstruct.Spl_json_object_t_t*, i8*, %Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_object_t_t* %11, i8* %13, %Tstruct.Spl_json_value_t_t* %18)
  %cmp6 = icmp eq i32 %call5, -1
  br i1 %cmp6, label %if.then7, label %if.end10
...
_Dynamic_check.succeeded10:                       ; preds = %sw.bb
  ...
  %26 = bitcast %Tstruct.json_array_t_t* %25 to %Tstruct.Spl_json_array_t_t*
  store %Tstruct.Spl_json_array_t_t* %26, %Tstruct.Spl_json_array_t_t** %schema_array, align 4
  %27 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value.addr, align 4
...
_Dynamic_check.succeeded13:                       ; preds = %_Dynamic_check.succeeded10
  %31 = bitcast i8* %29 to %Tstruct.Spl_json_value_t_t*
  %call14 = call %Tstruct.Spl_json_array_t_t* bitcast (%Tstruct.Spl_json_array_t_t* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_array to %Tstruct.Spl_json_array_t_t* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %31)
  %32 = bitcast %Tstruct.Spl_json_array_t_t* %call14 to %Tstruct.json_array_t_t*
  %33 = bitcast %Tstruct.json_array_t_t* %32 to %Tstruct.Spl_json_array_t_t*
  store %Tstruct.Spl_json_array_t_t* %33, %Tstruct.Spl_json_array_t_t** %value_array, align 4
  %34 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %schema_array, align 4
...
_Dynamic_check.succeeded16:                       ; preds = %_Dynamic_check.succeeded13
  ...
  %call17 = call i64 bitcast (i64 (%Tstruct.Spl_json_array_t_t*)* @json_array_get_count to i64 (%Tstruct.Spl_json_array_t_t*)*)(%Tstruct.Spl_json_array_t_t* %38)
  store i64 %call17, i64* %count, align 8
  %39 = load i64, i64* %count, align 8
  %cmp18 = icmp eq i64 %39, 0
...
_Dynamic_check.succeeded22:                       ; preds = %if.end20
  ...
  %call23 = call %Tstruct.Spl_json_value_t_t* bitcast (%Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_array_t_t*, i64)* @json_array_get_value to %Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_array_t_t*, i64)*)(%Tstruct.Spl_json_array_t_t* %44, i64 0)
  %45 = bitcast %Tstruct.Spl_json_value_t_t* %call23 to %Tstruct.json_value_t_t*
  %46 = bitcast %Tstruct.json_value_t_t* %45 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %46, %Tstruct.Spl_json_value_t_t** %temp_schema_value, align 4
  store i64 0, i64* %i, align 8
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %_Dynamic_check.succeeded22
  %47 = load i64, i64* %i, align 8
  %48 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %value_array, align 4
  %49 = ptrtoint %Tstruct.Spl_json_array_t_t* %48 to i32
  %50 = call i8* @c_fetch_pointer_from_offset(i32 %49)
  %51 = call i1 @c_isTaintedPointerToTaintedMem(i8* %50)
  br i1 %51, label %_Dynamic_check.succeeded25, label %_Dynamic_check.failed24

_Dynamic_check.succeeded25:                       ; preds = %for.cond
  %52 = bitcast i8* %50 to %Tstruct.Spl_json_array_t_t*
  %call26 = call i64 bitcast (i64 (%Tstruct.Spl_json_array_t_t*)* @json_array_get_count to i64 (%Tstruct.Spl_json_array_t_t*)*)(%Tstruct.Spl_json_array_t_t* %52)
  %cmp27 = icmp ult i64 %47, %call26
  br i1 %cmp27, label %for.body, label %for.end

for.body:                                         ; preds = %_Dynamic_check.succeeded25
  %53 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %value_array, align 4
  %54 = load i64, i64* %i, align 8
  %55 = ptrtoint %Tstruct.Spl_json_array_t_t* %53 to i32
  %56 = call i8* @c_fetch_pointer_from_offset(i32 %55)
  %57 = call i1 @c_isTaintedPointerToTaintedMem(i8* %56)
  br i1 %57, label %_Dynamic_check.succeeded29, label %_Dynamic_check.failed28

_Dynamic_check.succeeded29:                       ; preds = %for.body
  %58 = bitcast i8* %56 to %Tstruct.Spl_json_array_t_t*
  %call30 = call %Tstruct.Spl_json_value_t_t* bitcast (%Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_array_t_t*, i64)* @json_array_get_value to %Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_array_t_t*, i64)*)(%Tstruct.Spl_json_array_t_t* %58, i64 %54)
  %59 = bitcast %Tstruct.Spl_json_value_t_t* %call30 to %Tstruct.json_value_t_t*
  %60 = bitcast %Tstruct.json_value_t_t* %59 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %60, %Tstruct.Spl_json_value_t_t** %temp_value, align 4
  %61 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %temp_schema_value, align 4
  %62 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %temp_value, align 4
  %63 = ptrtoint %Tstruct.Spl_json_value_t_t* %61 to i32
  %64 = call i8* @c_fetch_pointer_from_offset(i32 %63)
  %65 = call i1 @c_isTaintedPointerToTaintedMem(i8* %64)
  br i1 %65, label %_Dynamic_check.succeeded32, label %_Dynamic_check.failed31

_Dynamic_check.succeeded32:                       ; preds = %_Dynamic_check.succeeded29
  %66 = bitcast i8* %64 to %Tstruct.Spl_json_value_t_t*
  %67 = ptrtoint %Tstruct.Spl_json_value_t_t* %62 to i32
  %68 = call i8* @c_fetch_pointer_from_offset(i32 %67)
  %69 = call i1 @c_isTaintedPointerToTaintedMem(i8* %68)
  br i1 %69, label %_Dynamic_check.succeeded34, label %_Dynamic_check.failed33
...
_Dynamic_check.succeeded34:                       ; preds = %_Dynamic_check.succeeded32
  %70 = bitcast i8* %68 to %Tstruct.Spl_json_value_t_t*
  %call35 = call i32 @json_validate(%Tstruct.Spl_json_value_t_t* %66, %Tstruct.Spl_json_value_t_t* %70)
...
sw.bb39:                                          ; preds = %if.end8
  %72 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %schema.addr, align 4
  %73 = ptrtoint %Tstruct.Spl_json_value_t_t* %72 to i32
  %74 = call i8* @c_fetch_pointer_from_offset(i32 %73)
  %75 = call i1 @c_isTaintedPointerToTaintedMem(i8* %74)
  br i1 %75, label %_Dynamic_check.succeeded41, label %_Dynamic_check.failed40

_Dynamic_check.succeeded41:                       ; preds = %sw.bb39
  %76 = bitcast i8* %74 to %Tstruct.Spl_json_value_t_t*
  %call42 = call %Tstruct.Spl_json_object_t_t* bitcast (%Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_object to %Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %76)
  %77 = bitcast %Tstruct.Spl_json_object_t_t* %call42 to %Tstruct.json_object_t_t*
  %78 = bitcast %Tstruct.json_object_t_t* %77 to %Tstruct.Spl_json_object_t_t*
  store %Tstruct.Spl_json_object_t_t* %78, %Tstruct.Spl_json_object_t_t** %schema_object, align 4
  %79 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value.addr, align 4
  %80 = ptrtoint %Tstruct.Spl_json_value_t_t* %79 to i32
  %81 = call i8* @c_fetch_pointer_from_offset(i32 %80)
  %82 = call i1 @c_isTaintedPointerToTaintedMem(i8* %81)
  br i1 %82, label %_Dynamic_check.succeeded44, label %_Dynamic_check.failed43

_Dynamic_check.succeeded44:                       ; preds = %_Dynamic_check.succeeded41
  %83 = bitcast i8* %81 to %Tstruct.Spl_json_value_t_t*
  %call45 = call %Tstruct.Spl_json_object_t_t* bitcast (%Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_object to %Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %83)
  %84 = bitcast %Tstruct.Spl_json_object_t_t* %call45 to %Tstruct.json_object_t_t*
  %85 = bitcast %Tstruct.json_object_t_t* %84 to %Tstruct.Spl_json_object_t_t*
  store %Tstruct.Spl_json_object_t_t* %85, %Tstruct.Spl_json_object_t_t** %value_object, align 4
  %86 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %schema_object, align 4
  %87 = ptrtoint %Tstruct.Spl_json_object_t_t* %86 to i32
  %88 = call i8* @c_fetch_pointer_from_offset(i32 %87)
  %89 = call i1 @c_isTaintedPointerToTaintedMem(i8* %88)
  br i1 %89, label %_Dynamic_check.succeeded47, label %_Dynamic_check.failed46

_Dynamic_check.succeeded47:                       ; preds = %_Dynamic_check.succeeded44
  %90 = bitcast i8* %88 to %Tstruct.Spl_json_object_t_t*
  %call48 = call i64 bitcast (i64 (%Tstruct.Spl_json_object_t_t*)* @json_object_get_count to i64 (%Tstruct.Spl_json_object_t_t*)*)(%Tstruct.Spl_json_object_t_t* %90)
  store i64 %call48, i64* %count, align 8
  %91 = load i64, i64* %count, align 8
  %cmp49 = icmp eq i64 %91, 0
...
if.else:                                          ; preds = %_Dynamic_check.succeeded47
  %92 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %value_object, align 4
  %93 = ptrtoint %Tstruct.Spl_json_object_t_t* %92 to i32
  %94 = call i8* @c_fetch_pointer_from_offset(i32 %93)
  %95 = call i1 @c_isTaintedPointerToTaintedMem(i8* %94)
  br i1 %95, label %_Dynamic_check.succeeded52, label %_Dynamic_check.failed51

_Dynamic_check.succeeded52:                       ; preds = %if.else
  %96 = bitcast i8* %94 to %Tstruct.Spl_json_object_t_t*
  %call53 = call i64 bitcast (i64 (%Tstruct.Spl_json_object_t_t*)* @json_object_get_count to i64 (%Tstruct.Spl_json_object_t_t*)*)(%Tstruct.Spl_json_object_t_t* %96)
  %97 = load i64, i64* %count, align 8
  %cmp54 = icmp ult i64 %call53, %97
...
for.cond58:                                       ; preds = %for.inc85, %if.end57
  ...
  %cmp59 = icmp ult i64 %98, %99
  br i1 %cmp59, label %for.body60, label %for.end87

for.body60:                                       ; preds = %for.cond58
  %100 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %schema_object, align 4
  ...
  br i1 %104, label %_Dynamic_check.succeeded62, label %_Dynamic_check.failed61

_Dynamic_check.succeeded62:                       ; preds = %for.body60
  %105 = bitcast i8* %103 to %Tstruct.Spl_json_object_t_t*
  %call63 = call i8* bitcast (i8* (%Tstruct.Spl_json_object_t_t*, i64)* @json_object_get_name to i8* (%Tstruct.Spl_json_object_t_t*, i64)*)(%Tstruct.Spl_json_object_t_t* %105, i64 %101)
  store i8* %call63, i8** %key, align 4
  %106 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %schema_object, align 4
  %107 = load i8*, i8** %key, align 4
  %108 = ptrtoint %Tstruct.Spl_json_object_t_t* %106 to i32
  %109 = call i8* @c_fetch_pointer_from_offset(i32 %108)
  %110 = call i1 @c_isTaintedPointerToTaintedMem(i8* %109)
  br i1 %110, label %_Dynamic_check.succeeded65, label %_Dynamic_check.failed64

_Dynamic_check.succeeded65:                       ; preds = %_Dynamic_check.succeeded62
  %111 = bitcast i8* %109 to %Tstruct.Spl_json_object_t_t*
  %112 = ptrtoint i8* %107 to i32
  %113 = call i8* @c_fetch_pointer_from_offset(i32 %112)
  %114 = call i1 @c_isTaintedPointerToTaintedMem(i8* %113)
  br i1 %114, label %_Dynamic_check.succeeded67, label %_Dynamic_check.failed66

_Dynamic_check.succeeded67:                       ; preds = %_Dynamic_check.succeeded65
  %call68 = call %Tstruct.Spl_json_value_t_t* bitcast (%Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_object_t_t*, i8*)* @json_object_get_value to %Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_object_t_t*, i8*)*)(%Tstruct.Spl_json_object_t_t* %111, i8* %113)
  %115 = bitcast %Tstruct.Spl_json_value_t_t* %call68 to %Tstruct.json_value_t_t*
  %116 = bitcast %Tstruct.json_value_t_t* %115 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %116, %Tstruct.Spl_json_value_t_t** %temp_schema_value, align 4
  %117 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %value_object, align 4
  %118 = load i8*, i8** %key, align 4
  %119 = ptrtoint %Tstruct.Spl_json_object_t_t* %117 to i32
  %120 = call i8* @c_fetch_pointer_from_offset(i32 %119)
  %121 = call i1 @c_isTaintedPointerToTaintedMem(i8* %120)
  br i1 %121, label %_Dynamic_check.succeeded70, label %_Dynamic_check.failed69

_Dynamic_check.succeeded70:                       ; preds = %_Dynamic_check.succeeded67
  %122 = bitcast i8* %120 to %Tstruct.Spl_json_object_t_t*
  ...
  br i1 %125, label %_Dynamic_check.succeeded72, label %_Dynamic_check.failed71

_Dynamic_check.succeeded72:                       ; preds = %_Dynamic_check.succeeded70
  %call73 = call %Tstruct.Spl_json_value_t_t* bitcast (%Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_object_t_t*, i8*)* @json_object_get_value to %Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_object_t_t*, i8*)*)(%Tstruct.Spl_json_object_t_t* %122, i8* %124)
  %126 = bitcast %Tstruct.Spl_json_value_t_t* %call73 to %Tstruct.json_value_t_t*
  %127 = bitcast %Tstruct.json_value_t_t* %126 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %127, %Tstruct.Spl_json_value_t_t** %temp_value, align 4
  %128 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %temp_value, align 4
  %129 = ptrtoint %Tstruct.Spl_json_value_t_t* %128 to i32
  %cmp74 = icmp eq i32 %129, 0
...
if.end76:                                         ; preds = %_Dynamic_check.succeeded72
  %130 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %temp_schema_value, align 4
  %131 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %temp_value, align 4
  %132 = ptrtoint %Tstruct.Spl_json_value_t_t* %130 to i32
  %133 = call i8* @c_fetch_pointer_from_offset(i32 %132)
  %134 = call i1 @c_isTaintedPointerToTaintedMem(i8* %133)
  br i1 %134, label %_Dynamic_check.succeeded78, label %_Dynamic_check.failed77

_Dynamic_check.succeeded78:                       ; preds = %if.end76
  %135 = bitcast i8* %133 to %Tstruct.Spl_json_value_t_t*
  %136 = ptrtoint %Tstruct.Spl_json_value_t_t* %131 to i32
  %137 = call i8* @c_fetch_pointer_from_offset(i32 %136)
  %138 = call i1 @c_isTaintedPointerToTaintedMem(i8* %137)
  br i1 %138, label %_Dynamic_check.succeeded80, label %_Dynamic_check.failed79

_Dynamic_check.succeeded80:                       ; preds = %_Dynamic_check.succeeded78
  %139 = bitcast i8* %137 to %Tstruct.Spl_json_value_t_t*
  %call81 = call i32 @json_validate(%Tstruct.Spl_json_value_t_t* %135, %Tstruct.Spl_json_value_t_t* %139)
...
_Dynamic_check.succeeded5:                        ; preds = %sw.bb
  ...
  %21 = bitcast %Tstruct.json_array_t_t* %20 to %Tstruct.Spl_json_array_t_t*
  store %Tstruct.Spl_json_array_t_t* %21, %Tstruct.Spl_json_array_t_t** %a_array, align 4
  %22 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %b.addr, align 4
...
_Dynamic_check.succeeded8:                        ; preds = %_Dynamic_check.succeeded5
  ...
  %call9 = call %Tstruct.Spl_json_array_t_t* bitcast (%Tstruct.Spl_json_array_t_t* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_array to %Tstruct.Spl_json_array_t_t* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %26)
  %27 = bitcast %Tstruct.Spl_json_array_t_t* %call9 to %Tstruct.json_array_t_t*
  %28 = bitcast %Tstruct.json_array_t_t* %27 to %Tstruct.Spl_json_array_t_t*
  store %Tstruct.Spl_json_array_t_t* %28, %Tstruct.Spl_json_array_t_t** %b_array, align 4
  %29 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %a_array, align 4
...
_Dynamic_check.succeeded11:                       ; preds = %_Dynamic_check.succeeded8
  ...
  %call12 = call i64 bitcast (i64 (%Tstruct.Spl_json_array_t_t*)* @json_array_get_count to i64 (%Tstruct.Spl_json_array_t_t*)*)(%Tstruct.Spl_json_array_t_t* %33)
  store i64 %call12, i64* %a_count, align 8
  %34 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %b_array, align 4
  %35 = ptrtoint %Tstruct.Spl_json_array_t_t* %34 to i32
  %36 = call i8* @c_fetch_pointer_from_offset(i32 %35)
  %37 = call i1 @c_isTaintedPointerToTaintedMem(i8* %36)
...
_Dynamic_check.succeeded14:                       ; preds = %_Dynamic_check.succeeded11
  %38 = bitcast i8* %36 to %Tstruct.Spl_json_array_t_t*
  %call15 = call i64 bitcast (i64 (%Tstruct.Spl_json_array_t_t*)* @json_array_get_count to i64 (%Tstruct.Spl_json_array_t_t*)*)(%Tstruct.Spl_json_array_t_t* %38)
  store i64 %call15, i64* %b_count, align 8
  %39 = load i64, i64* %a_count, align 8
  %40 = load i64, i64* %b_count, align 8
  %cmp16 = icmp ne i64 %39, %40
...
for.cond:                                         ; preds = %for.inc, %if.end18
  ...
  %42 = load i64, i64* %a_count, align 8
  %cmp19 = icmp ult i64 %41, %42
  br i1 %cmp19, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %43 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %a_array, align 4
  %44 = load i64, i64* %i, align 8
  %45 = ptrtoint %Tstruct.Spl_json_array_t_t* %43 to i32
  %46 = call i8* @c_fetch_pointer_from_offset(i32 %45)
  %47 = call i1 @c_isTaintedPointerToTaintedMem(i8* %46)
  br i1 %47, label %_Dynamic_check.succeeded21, label %_Dynamic_check.failed20

_Dynamic_check.succeeded21:                       ; preds = %for.body
  %48 = bitcast i8* %46 to %Tstruct.Spl_json_array_t_t*
  %call22 = call %Tstruct.Spl_json_value_t_t* bitcast (%Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_array_t_t*, i64)* @json_array_get_value to %Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_array_t_t*, i64)*)(%Tstruct.Spl_json_array_t_t* %48, i64 %44)
  %49 = bitcast %Tstruct.Spl_json_value_t_t* %call22 to %Tstruct.Spl_json_value_t_t*
  %50 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %b_array, align 4
  %51 = load i64, i64* %i, align 8
  %52 = ptrtoint %Tstruct.Spl_json_array_t_t* %50 to i32
  %53 = call i8* @c_fetch_pointer_from_offset(i32 %52)
  %54 = call i1 @c_isTaintedPointerToTaintedMem(i8* %53)
  br i1 %54, label %_Dynamic_check.succeeded24, label %_Dynamic_check.failed23

_Dynamic_check.succeeded24:                       ; preds = %_Dynamic_check.succeeded21
  %55 = bitcast i8* %53 to %Tstruct.Spl_json_array_t_t*
  %call25 = call %Tstruct.Spl_json_value_t_t* bitcast (%Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_array_t_t*, i64)* @json_array_get_value to %Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_array_t_t*, i64)*)(%Tstruct.Spl_json_array_t_t* %55, i64 %51)
  %56 = bitcast %Tstruct.Spl_json_value_t_t* %call25 to %Tstruct.Spl_json_value_t_t*
  %57 = ptrtoint %Tstruct.Spl_json_value_t_t* %49 to i32
  %58 = call i8* @c_fetch_pointer_from_offset(i32 %57)
  %59 = call i1 @c_isTaintedPointerToTaintedMem(i8* %58)
  br i1 %59, label %_Dynamic_check.succeeded27, label %_Dynamic_check.failed26

_Dynamic_check.succeeded27:                       ; preds = %_Dynamic_check.succeeded24
  %60 = bitcast i8* %58 to %Tstruct.Spl_json_value_t_t*
  %61 = ptrtoint %Tstruct.Spl_json_value_t_t* %56 to i32
  %62 = call i8* @c_fetch_pointer_from_offset(i32 %61)
  %63 = call i1 @c_isTaintedPointerToTaintedMem(i8* %62)
  br i1 %63, label %_Dynamic_check.succeeded29, label %_Dynamic_check.failed28

_Dynamic_check.succeeded29:                       ; preds = %_Dynamic_check.succeeded27
  %64 = bitcast i8* %62 to %Tstruct.Spl_json_value_t_t*
  %call30 = call i32 bitcast (i32 (%Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t*)* @json_value_equals to i32 (%Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %60, %Tstruct.Spl_json_value_t_t* %64)
...
sw.bb33:                                          ; preds = %if.end
  %66 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %a.addr, align 4
  %67 = ptrtoint %Tstruct.Spl_json_value_t_t* %66 to i32
  %68 = call i8* @c_fetch_pointer_from_offset(i32 %67)
  %69 = call i1 @c_isTaintedPointerToTaintedMem(i8* %68)
  br i1 %69, label %_Dynamic_check.succeeded35, label %_Dynamic_check.failed34

_Dynamic_check.succeeded35:                       ; preds = %sw.bb33
  %70 = bitcast i8* %68 to %Tstruct.Spl_json_value_t_t*
  %call36 = call %Tstruct.Spl_json_object_t_t* bitcast (%Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_object to %Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %70)
  %71 = bitcast %Tstruct.Spl_json_object_t_t* %call36 to %Tstruct.json_object_t_t*
  %72 = bitcast %Tstruct.json_object_t_t* %71 to %Tstruct.Spl_json_object_t_t*
  store %Tstruct.Spl_json_object_t_t* %72, %Tstruct.Spl_json_object_t_t** %a_object, align 4
  %73 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %b.addr, align 4
  %74 = ptrtoint %Tstruct.Spl_json_value_t_t* %73 to i32
  %75 = call i8* @c_fetch_pointer_from_offset(i32 %74)
  %76 = call i1 @c_isTaintedPointerToTaintedMem(i8* %75)
  br i1 %76, label %_Dynamic_check.succeeded38, label %_Dynamic_check.failed37

_Dynamic_check.succeeded38:                       ; preds = %_Dynamic_check.succeeded35
  %77 = bitcast i8* %75 to %Tstruct.Spl_json_value_t_t*
  %call39 = call %Tstruct.Spl_json_object_t_t* bitcast (%Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_object to %Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %77)
  %78 = bitcast %Tstruct.Spl_json_object_t_t* %call39 to %Tstruct.json_object_t_t*
  %79 = bitcast %Tstruct.json_object_t_t* %78 to %Tstruct.Spl_json_object_t_t*
  store %Tstruct.Spl_json_object_t_t* %79, %Tstruct.Spl_json_object_t_t** %b_object, align 4
  %80 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %a_object, align 4
  %81 = ptrtoint %Tstruct.Spl_json_object_t_t* %80 to i32
  %82 = call i8* @c_fetch_pointer_from_offset(i32 %81)
  %83 = call i1 @c_isTaintedPointerToTaintedMem(i8* %82)
  br i1 %83, label %_Dynamic_check.succeeded41, label %_Dynamic_check.failed40

_Dynamic_check.succeeded41:                       ; preds = %_Dynamic_check.succeeded38
  %84 = bitcast i8* %82 to %Tstruct.Spl_json_object_t_t*
  %call42 = call i64 bitcast (i64 (%Tstruct.Spl_json_object_t_t*)* @json_object_get_count to i64 (%Tstruct.Spl_json_object_t_t*)*)(%Tstruct.Spl_json_object_t_t* %84)
  store i64 %call42, i64* %a_count, align 8
  %85 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %b_object, align 4
  %86 = ptrtoint %Tstruct.Spl_json_object_t_t* %85 to i32
  %87 = call i8* @c_fetch_pointer_from_offset(i32 %86)
  %88 = call i1 @c_isTaintedPointerToTaintedMem(i8* %87)
  br i1 %88, label %_Dynamic_check.succeeded44, label %_Dynamic_check.failed43
...
_Dynamic_check.succeeded44:                       ; preds = %_Dynamic_check.succeeded41
  %89 = bitcast i8* %87 to %Tstruct.Spl_json_object_t_t*
  %call45 = call i64 bitcast (i64 (%Tstruct.Spl_json_object_t_t*)* @json_object_get_count to i64 (%Tstruct.Spl_json_object_t_t*)*)(%Tstruct.Spl_json_object_t_t* %89)
  store i64 %call45, i64* %b_count, align 8
  %90 = load i64, i64* %a_count, align 8
  %91 = load i64, i64* %b_count, align 8
  %cmp46 = icmp ne i64 %90, %91
...
for.cond49:                                       ; preds = %for.inc73, %if.end48
  %92 = load i64, i64* %i, align 8
  %93 = load i64, i64* %a_count, align 8
  %cmp50 = icmp ult i64 %92, %93
  br i1 %cmp50, label %for.body51, label %for.end75

for.body51:                                       ; preds = %for.cond49
  %94 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %a_object, align 4
  %95 = load i64, i64* %i, align 8
  %96 = ptrtoint %Tstruct.Spl_json_object_t_t* %94 to i32
  %97 = call i8* @c_fetch_pointer_from_offset(i32 %96)
  %98 = call i1 @c_isTaintedPointerToTaintedMem(i8* %97)
  br i1 %98, label %_Dynamic_check.succeeded53, label %_Dynamic_check.failed52

_Dynamic_check.succeeded53:                       ; preds = %for.body51
  %99 = bitcast i8* %97 to %Tstruct.Spl_json_object_t_t*
  %call54 = call i8* bitcast (i8* (%Tstruct.Spl_json_object_t_t*, i64)* @json_object_get_name to i8* (%Tstruct.Spl_json_object_t_t*, i64)*)(%Tstruct.Spl_json_object_t_t* %99, i64 %95)
  store i8* %call54, i8** %key, align 4
  %100 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %a_object, align 4
  %101 = load i8*, i8** %key, align 4
  %102 = ptrtoint %Tstruct.Spl_json_object_t_t* %100 to i32
  %103 = call i8* @c_fetch_pointer_from_offset(i32 %102)
  %104 = call i1 @c_isTaintedPointerToTaintedMem(i8* %103)
...
_Dynamic_check.succeeded56:                       ; preds = %_Dynamic_check.succeeded53
  ...
  %107 = call i8* @c_fetch_pointer_from_offset(i32 %106)
  %108 = call i1 @c_isTaintedPointerToTaintedMem(i8* %107)
  br i1 %108, label %_Dynamic_check.succeeded58, label %_Dynamic_check.failed57

_Dynamic_check.succeeded58:                       ; preds = %_Dynamic_check.succeeded56
  %call59 = call %Tstruct.Spl_json_value_t_t* bitcast (%Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_object_t_t*, i8*)* @json_object_get_value to %Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_object_t_t*, i8*)*)(%Tstruct.Spl_json_object_t_t* %105, i8* %107)
  %109 = bitcast %Tstruct.Spl_json_value_t_t* %call59 to %Tstruct.Spl_json_value_t_t*
  %110 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %b_object, align 4
  %111 = load i8*, i8** %key, align 4
...
_Dynamic_check.succeeded61:                       ; preds = %_Dynamic_check.succeeded58
  %115 = bitcast i8* %113 to %Tstruct.Spl_json_object_t_t*
  %116 = ptrtoint i8* %111 to i32
  %117 = call i8* @c_fetch_pointer_from_offset(i32 %116)
  %118 = call i1 @c_isTaintedPointerToTaintedMem(i8* %117)
  br i1 %118, label %_Dynamic_check.succeeded63, label %_Dynamic_check.failed62

_Dynamic_check.succeeded63:                       ; preds = %_Dynamic_check.succeeded61
  %call64 = call %Tstruct.Spl_json_value_t_t* bitcast (%Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_object_t_t*, i8*)* @json_object_get_value to %Tstruct.Spl_json_value_t_t* (%Tstruct.Spl_json_object_t_t*, i8*)*)(%Tstruct.Spl_json_object_t_t* %115, i8* %117)
  %119 = bitcast %Tstruct.Spl_json_value_t_t* %call64 to %Tstruct.Spl_json_value_t_t*
  %120 = ptrtoint %Tstruct.Spl_json_value_t_t* %109 to i32
  %121 = call i8* @c_fetch_pointer_from_offset(i32 %120)
  %122 = call i1 @c_isTaintedPointerToTaintedMem(i8* %121)
  br i1 %122, label %_Dynamic_check.succeeded66, label %_Dynamic_check.failed65

_Dynamic_check.succeeded66:                       ; preds = %_Dynamic_check.succeeded63
  %123 = bitcast i8* %121 to %Tstruct.Spl_json_value_t_t*
  %124 = ptrtoint %Tstruct.Spl_json_value_t_t* %119 to i32
  %125 = call i8* @c_fetch_pointer_from_offset(i32 %124)
  %126 = call i1 @c_isTaintedPointerToTaintedMem(i8* %125)
  br i1 %126, label %_Dynamic_check.succeeded68, label %_Dynamic_check.failed67
...
_Dynamic_check.succeeded68:                       ; preds = %_Dynamic_check.succeeded66
  ...
  %call69 = call i32 bitcast (i32 (%Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t*)* @json_value_equals to i32 (%Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %123, %Tstruct.Spl_json_value_t_t* %127)
...
sw.bb76:                                          ; preds = %if.end
  %129 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %a.addr, align 4
  %130 = ptrtoint %Tstruct.Spl_json_value_t_t* %129 to i32
  %131 = call i8* @c_fetch_pointer_from_offset(i32 %130)
  %132 = call i1 @c_isTaintedPointerToTaintedMem(i8* %131)
  br i1 %132, label %_Dynamic_check.succeeded78, label %_Dynamic_check.failed77

_Dynamic_check.succeeded78:                       ; preds = %sw.bb76
  %133 = bitcast i8* %131 to %Tstruct.Spl_json_value_t_t*
  %call79 = call i8* bitcast (i8* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_string to i8* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %133)
  store i8* %call79, i8** %a_string, align 4
  %134 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %b.addr, align 4
  ...
  br i1 %137, label %_Dynamic_check.succeeded81, label %_Dynamic_check.failed80

_Dynamic_check.succeeded81:                       ; preds = %_Dynamic_check.succeeded78
  %138 = bitcast i8* %136 to %Tstruct.Spl_json_value_t_t*
  %call82 = call i8* bitcast (i8* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_string to i8* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %138)
  store i8* %call82, i8** %b_string, align 4
  %139 = load i8*, i8** %a_string, align 4
  %140 = ptrtoint i8* %139 to i32
  %cmp83 = icmp eq i32 %140, 0
  br i1 %cmp83, label %if.then85, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %_Dynamic_check.succeeded81
  %141 = load i8*, i8** %b_string, align 4
  %142 = ptrtoint i8* %141 to i32
  %cmp84 = icmp eq i32 %142, 0
...
if.end86:                                         ; preds = %lor.lhs.false
  %143 = load i8*, i8** %a_string, align 4
  %144 = load i8*, i8** %b_string, align 4
  %145 = ptrtoint i8* %143 to i32
  %146 = call i8* @c_fetch_pointer_from_offset(i32 %145)
  %147 = call i1 @c_isTaintedPointerToTaintedMem(i8* %146)
  br i1 %147, label %_Dynamic_check.succeeded88, label %_Dynamic_check.failed87

_Dynamic_check.succeeded88:                       ; preds = %if.end86
  %148 = ptrtoint i8* %144 to i32
  %149 = call i8* @c_fetch_pointer_from_offset(i32 %148)
  %150 = call i1 @c_isTaintedPointerToTaintedMem(i8* %149)
  br i1 %150, label %_Dynamic_check.succeeded90, label %_Dynamic_check.failed89

_Dynamic_check.succeeded90:                       ; preds = %_Dynamic_check.succeeded88
  %call91 = call i32 @t_strcmp(i8* %146, i8* %149)
...
sw.bb93:                                          ; preds = %if.end
  %151 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %a.addr, align 4
  %152 = ptrtoint %Tstruct.Spl_json_value_t_t* %151 to i32
  %153 = call i8* @c_fetch_pointer_from_offset(i32 %152)
  %154 = call i1 @c_isTaintedPointerToTaintedMem(i8* %153)
  br i1 %154, label %_Dynamic_check.succeeded95, label %_Dynamic_check.failed94

_Dynamic_check.succeeded95:                       ; preds = %sw.bb93
  %155 = bitcast i8* %153 to %Tstruct.Spl_json_value_t_t*
  %call96 = call i32 bitcast (i32 (%Tstruct.Spl_json_value_t_t*)* @json_value_get_boolean to i32 (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %155)
  %156 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %b.addr, align 4
  %157 = ptrtoint %Tstruct.Spl_json_value_t_t* %156 to i32
  %158 = call i8* @c_fetch_pointer_from_offset(i32 %157)
  %159 = call i1 @c_isTaintedPointerToTaintedMem(i8* %158)
  br i1 %159, label %_Dynamic_check.succeeded98, label %_Dynamic_check.failed97

_Dynamic_check.succeeded98:                       ; preds = %_Dynamic_check.succeeded95
  %160 = bitcast i8* %158 to %Tstruct.Spl_json_value_t_t*
  %call99 = call i32 bitcast (i32 (%Tstruct.Spl_json_value_t_t*)* @json_value_get_boolean to i32 (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %160)
...
sw.bb102:                                         ; preds = %if.end
  %161 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %a.addr, align 4
  %162 = ptrtoint %Tstruct.Spl_json_value_t_t* %161 to i32
  %163 = call i8* @c_fetch_pointer_from_offset(i32 %162)
  %164 = call i1 @c_isTaintedPointerToTaintedMem(i8* %163)
  br i1 %164, label %_Dynamic_check.succeeded104, label %_Dynamic_check.failed103

_Dynamic_check.succeeded104:                      ; preds = %sw.bb102
  %165 = bitcast i8* %163 to %Tstruct.Spl_json_value_t_t*
  %call105 = call double bitcast (double (%Tstruct.Spl_json_value_t_t*)* @json_value_get_number to double (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %165)
  %166 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %b.addr, align 4
  %167 = ptrtoint %Tstruct.Spl_json_value_t_t* %166 to i32
  %168 = call i8* @c_fetch_pointer_from_offset(i32 %167)
  %169 = call i1 @c_isTaintedPointerToTaintedMem(i8* %168)
  br i1 %169, label %_Dynamic_check.succeeded107, label %_Dynamic_check.failed106

_Dynamic_check.succeeded107:                      ; preds = %_Dynamic_check.succeeded104
  %170 = bitcast i8* %168 to %Tstruct.Spl_json_value_t_t*
  %call108 = call double bitcast (double (%Tstruct.Spl_json_value_t_t*)* @json_value_get_number to double (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %170)
  %sub = fsub double %call105, %call108
  %171 = call double @llvm.fabs.f64(double %sub)
  %cmp109 = fcmp olt double %171, 0x3EB0C6F7A0B5ED8D
...
_Dynamic_check.succeeded:                         ; preds = %entry
  ...
  %6 = bitcast %Tstruct.Spl_json_object_t_t* %call to %Tstruct.Spl_json_object_t_t*
  ret %Tstruct.Spl_json_object_t_t* %6
...
_Dynamic_check.succeeded:                         ; preds = %entry
  ...
  %6 = bitcast %Tstruct.Spl_json_array_t_t* %call to %Tstruct.Spl_json_array_t_t*
  ret %Tstruct.Spl_json_array_t_t* %6
...
if.then:                                          ; preds = %lor.lhs.false, %entry
  ...
  store i8* (i64)* %2, i8* (i64)** @parson_tainted_malloc, align 8
  %3 = load void (i8*)*, void (i8*)** %free_fun.addr, align 4
  store void (i8*)* %3, void (i8*)** @parson_tainted_free, align 8
  br label %if.end
...
_Dynamic_check.succeeded6:                        ; preds = %_Dynamic_check.succeeded4
  ...
  %14 = bitcast %Tstruct.json_value_t_t* %13 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %14, %Tstruct.Spl_json_value_t_t** %output_value, align 4
  %15 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %output_value, align 4
  %16 = ptrtoint %Tstruct.Spl_json_value_t_t* %15 to i32
  %cmp = icmp eq i32 %16, 0
  br i1 %cmp, label %if.then, label %if.end
...
if.then:                                          ; preds = %_Dynamic_check.succeeded6
  ...
  %18 = load i8*, i8** %str_cpy, align 4
  %19 = ptrtoint i8* %17 to i32
  %20 = call i8* @c_fetch_pointer_from_offset(i32 %19)
  %21 = call i1 @c_isTaintedPointerToTaintedMem(i8* %20)
  br i1 %21, label %_Dynamic_check.succeeded11, label %_Dynamic_check.failed10
...
_Dynamic_check.succeeded13:                       ; preds = %_Dynamic_check.succeeded11
  %call14 = call i8* @t_strcpy(i8* %20, i8* %23)
  store %Tstruct.Spl_json_value_t_t* null, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
if.end:                                           ; preds = %_Dynamic_check.succeeded6
  %25 = load i8*, i8** %str_cpy, align 4
  %26 = ptrtoint i8* %25 to i32
  %27 = call i8* @c_fetch_pointer_from_offset(i32 %26)
  %28 = call i1 @c_isTaintedPointerToTaintedMem(i8* %27)
  br i1 %28, label %_Dynamic_check.succeeded16, label %_Dynamic_check.failed15
...
if.then20:                                        ; preds = %_Dynamic_check.succeeded16
  %30 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %output_value, align 4
  %31 = ptrtoint %Tstruct.Spl_json_value_t_t* %30 to i32
  %32 = call i8* @c_fetch_pointer_from_offset(i32 %31)
  %33 = call i1 @c_isTaintedPointerToTaintedMem(i8* %32)
  br i1 %33, label %_Dynamic_check.succeeded22, label %_Dynamic_check.failed21

_Dynamic_check.succeeded22:                       ; preds = %if.then20
  %34 = bitcast i8* %32 to %Tstruct.Spl_json_value_t_t*
  call void bitcast (void (%Tstruct.Spl_json_value_t_t*)* @json_value_free to void (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %34)
  %35 = load i8*, i8** %string.addr, align 4
  %36 = load i8*, i8** %str_cpy, align 4
  %37 = ptrtoint i8* %35 to i32
  %38 = call i8* @c_fetch_pointer_from_offset(i32 %37)
  %39 = call i1 @c_isTaintedPointerToTaintedMem(i8* %38)
  br i1 %39, label %_Dynamic_check.succeeded24, label %_Dynamic_check.failed23
...
_Dynamic_check.succeeded26:                       ; preds = %_Dynamic_check.succeeded24
  %call27 = call i8* @t_strcpy(i8* %38, i8* %41)
  store %Tstruct.Spl_json_value_t_t* null, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
if.end28:                                         ; preds = %_Dynamic_check.succeeded16
  %43 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %output_value, align 4
  %44 = ptrtoint %Tstruct.Spl_json_value_t_t* %43 to i32
  %45 = call i8* @c_fetch_pointer_from_offset(i32 %44)
  %46 = call i1 @c_isTaintedPointerToTaintedMem(i8* %45)
  br i1 %46, label %_Dynamic_check.succeeded30, label %_Dynamic_check.failed29

_Dynamic_check.succeeded30:                       ; preds = %if.end28
  %47 = bitcast i8* %45 to %Tstruct.Spl_json_value_t_t*
  %call31 = call %Tstruct.Spl_json_object_t_t* bitcast (%Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_object to %Tstruct.Spl_json_object_t_t* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %47)
  %48 = bitcast %Tstruct.Spl_json_object_t_t* %call31 to %Tstruct.json_object_t_t*
  %49 = bitcast %Tstruct.json_object_t_t* %48 to %Tstruct.Spl_json_object_t_t*
  store %Tstruct.Spl_json_object_t_t* %49, %Tstruct.Spl_json_object_t_t** %output_object, align 4
  %50 = load i8*, i8** %str_cpy, align 4
...
while.cond:                                       ; preds = %while.body, %_Dynamic_check.succeeded30
  %51 = load i8*, i8** %str_cpy, align 4
  %52 = ptrtoint i8* %51 to i32
  %53 = call i8* @c_fetch_pointer_from_offset(i32 %52)
  %54 = call i1 @c_isTaintedPointerToTaintedMem(i8* %53)
  br i1 %54, label %_Dynamic_check.succeeded33, label %_Dynamic_check.failed32
...
while.body:                                       ; preds = %_Dynamic_check.succeeded33
  ...
  %incdec.ptr36 = getelementptr inbounds i8, i8* %56, i32 1
...
while.end:                                        ; preds = %_Dynamic_check.succeeded33
  ...
  %59 = call i8* @c_fetch_pointer_from_offset(i32 %58)
  %60 = call i1 @c_isTaintedPointerToTaintedMem(i8* %59)
  br i1 %60, label %_Dynamic_check.succeeded38, label %_Dynamic_check.failed37
...
if.then42:                                        ; preds = %_Dynamic_check.succeeded38
  ...
  %incdec.ptr43 = getelementptr inbounds i8, i8* %62, i32 1
  store i8* %incdec.ptr43, i8** %str_cpy, align 4
  %63 = load i8*, i8** %string.addr, align 4
  %64 = load i8*, i8** %str_cpy, align 4
  %65 = ptrtoint i8* %63 to i32
  %66 = call i8* @c_fetch_pointer_from_offset(i32 %65)
  %67 = call i1 @c_isTaintedPointerToTaintedMem(i8* %66)
  br i1 %67, label %_Dynamic_check.succeeded45, label %_Dynamic_check.failed44

_Dynamic_check.succeeded45:                       ; preds = %if.then42
  %68 = ptrtoint i8* %64 to i32
  %69 = call i8* @c_fetch_pointer_from_offset(i32 %68)
  %70 = call i1 @c_isTaintedPointerToTaintedMem(i8* %69)
  br i1 %70, label %_Dynamic_check.succeeded47, label %_Dynamic_check.failed46

_Dynamic_check.succeeded47:                       ; preds = %_Dynamic_check.succeeded45
  %call48 = call i8* @t_strcpy(i8* %66, i8* %69)
  %71 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %output_value, align 4
  store %Tstruct.Spl_json_value_t_t* %71, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
while.cond50:                                     ; preds = %while.end202, %if.end49
  %72 = load i8*, i8** %str_cpy, align 4
  %73 = ptrtoint i8* %72 to i32
  %74 = call i8* @c_fetch_pointer_from_offset(i32 %73)
  %75 = call i1 @c_isTaintedPointerToTaintedMem(i8* %74)
  br i1 %75, label %_Dynamic_check.succeeded52, label %_Dynamic_check.failed51
...
while.body56:                                     ; preds = %_Dynamic_check.succeeded52
  %77 = load i8*, i8** %str_cpy, align 4
  %78 = ptrtoint i8* %77 to i32
  %79 = call i8* @c_fetch_pointer_from_offset(i32 %78)
  %80 = call i1 @c_isTaintedPointerToTaintedMem(i8* %79)
  br i1 %80, label %_Dynamic_check.succeeded58, label %_Dynamic_check.failed57

_Dynamic_check.succeeded58:                       ; preds = %while.body56
  %call59 = call i8* @get_quoted_string(i8* %79, i8* (i8*, i64)* @process_string)
  store i8* %call59, i8** %new_key, align 4
  %81 = load i8*, i8** %new_key, align 4
  %82 = ptrtoint i8* %81 to i32
  %cmp60 = icmp eq i32 %82, 0
  br i1 %cmp60, label %if.then62, label %if.end70

if.then62:                                        ; preds = %_Dynamic_check.succeeded58
  %83 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %output_value, align 4
  %84 = ptrtoint %Tstruct.Spl_json_value_t_t* %83 to i32
  %85 = call i8* @c_fetch_pointer_from_offset(i32 %84)
  %86 = call i1 @c_isTaintedPointerToTaintedMem(i8* %85)
  br i1 %86, label %_Dynamic_check.succeeded64, label %_Dynamic_check.failed63

_Dynamic_check.succeeded64:                       ; preds = %if.then62
  %87 = bitcast i8* %85 to %Tstruct.Spl_json_value_t_t*
  call void bitcast (void (%Tstruct.Spl_json_value_t_t*)* @json_value_free to void (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %87)
  %88 = load i8*, i8** %string.addr, align 4
  %89 = load i8*, i8** %str_cpy, align 4
  %90 = ptrtoint i8* %88 to i32
  %91 = call i8* @c_fetch_pointer_from_offset(i32 %90)
  %92 = call i1 @c_isTaintedPointerToTaintedMem(i8* %91)
  br i1 %92, label %_Dynamic_check.succeeded66, label %_Dynamic_check.failed65

_Dynamic_check.succeeded66:                       ; preds = %_Dynamic_check.succeeded64
  %93 = ptrtoint i8* %89 to i32
  %94 = call i8* @c_fetch_pointer_from_offset(i32 %93)
  %95 = call i1 @c_isTaintedPointerToTaintedMem(i8* %94)
  br i1 %95, label %_Dynamic_check.succeeded68, label %_Dynamic_check.failed67

_Dynamic_check.succeeded68:                       ; preds = %_Dynamic_check.succeeded66
  %call69 = call i8* @t_strcpy(i8* %91, i8* %94)
  store %Tstruct.Spl_json_value_t_t* null, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
while.cond71:                                     ; preds = %while.body77, %if.end70
  ...
  %98 = call i8* @c_fetch_pointer_from_offset(i32 %97)
  %99 = call i1 @c_isTaintedPointerToTaintedMem(i8* %98)
  br i1 %99, label %_Dynamic_check.succeeded73, label %_Dynamic_check.failed72
...
while.body77:                                     ; preds = %_Dynamic_check.succeeded73
  ...
  %incdec.ptr78 = getelementptr inbounds i8, i8* %101, i32 1
...
while.end79:                                      ; preds = %_Dynamic_check.succeeded73
  ...
  br i1 %105, label %_Dynamic_check.succeeded81, label %_Dynamic_check.failed80
...
if.then85:                                        ; preds = %_Dynamic_check.succeeded81
  %107 = load i8*, i8** %new_key, align 4
  %_Dynamic_check.is_null = icmp eq i8* %107, null
  br i1 %_Dynamic_check.is_null, label %_Dynamic_check.success, label %_Dynamic_check.subsumption

_Dynamic_check.subsumption:                       ; preds = %if.then85
  %108 = load i8*, i8** %new_key, align 4
  %109 = load i8*, i8** %new_key, align 4
  %add.ptr = getelementptr inbounds i8, i8* %109, i64 0
  %_Dynamic_check.non_null = icmp ne i8* %107, null
...
_Dynamic_check.succeeded87:                       ; preds = %_Dynamic_check.subsumption
  %add.ptr88 = getelementptr inbounds i8, i8* %107, i64 0
  %110 = call i64 @c_TPtoO(i8* %108)
  %111 = inttoptr i64 %110 to i8*
  %112 = call i64 @c_TPtoO(i8* %107)
  %113 = inttoptr i64 %112 to i8*
  %_Dynamic_check.lower = icmp ule i8* %111, %113
  %114 = call i64 @c_TPtoO(i8* %add.ptr88)
  %115 = inttoptr i64 %114 to i8*
  %116 = call i64 @c_TPtoO(i8* %add.ptr)
  %117 = inttoptr i64 %116 to i8*
  %_Dynamic_check.upper = icmp ule i8* %115, %117
  %_Dynamic_check.cast = and i1 %_Dynamic_check.lower, %_Dynamic_check.upper
...
_Dynamic_check.succeeded91:                       ; preds = %_Dynamic_check.success
  ...
  br i1 %124, label %_Dynamic_check.succeeded93, label %_Dynamic_check.failed92
...
_Dynamic_check.succeeded93:                       ; preds = %_Dynamic_check.succeeded91
  ...
  %129 = call i8* @c_fetch_pointer_from_offset(i32 %128)
  %130 = call i1 @c_isTaintedPointerToTaintedMem(i8* %129)
  br i1 %130, label %_Dynamic_check.succeeded95, label %_Dynamic_check.failed94

_Dynamic_check.succeeded95:                       ; preds = %_Dynamic_check.succeeded93
  %131 = ptrtoint i8* %127 to i32
  %132 = call i8* @c_fetch_pointer_from_offset(i32 %131)
  %133 = call i1 @c_isTaintedPointerToTaintedMem(i8* %132)
  br i1 %133, label %_Dynamic_check.succeeded97, label %_Dynamic_check.failed96

_Dynamic_check.succeeded97:                       ; preds = %_Dynamic_check.succeeded95
  %call98 = call i8* @t_strcpy(i8* %129, i8* %132)
  store %Tstruct.Spl_json_value_t_t* null, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
if.end99:                                         ; preds = %_Dynamic_check.succeeded81
  %134 = load i8*, i8** %str_cpy, align 4
  %incdec.ptr100 = getelementptr inbounds i8, i8* %134, i32 1
  store i8* %incdec.ptr100, i8** %str_cpy, align 4
  %135 = load i8*, i8** %str_cpy, align 4
  %136 = load i64, i64* %nesting.addr, align 8
  ...
  br i1 %139, label %_Dynamic_check.succeeded102, label %_Dynamic_check.failed101

_Dynamic_check.succeeded102:                      ; preds = %if.end99
  %call103 = call %Tstruct.Spl_json_value_t_t* @parse_value(i8* %138, i64 %136)
  %140 = bitcast %Tstruct.Spl_json_value_t_t* %call103 to %Tstruct.json_value_t_t*
  %141 = bitcast %Tstruct.json_value_t_t* %140 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %141, %Tstruct.Spl_json_value_t_t** %new_value, align 4
  ...
  %cmp104 = icmp eq i32 %143, 0
  br i1 %cmp104, label %if.then106, label %if.end128

if.then106:                                       ; preds = %_Dynamic_check.succeeded102
  %144 = load i8*, i8** %new_key, align 4
  %_Dynamic_check.is_null107 = icmp eq i8* %144, null
...
_Dynamic_check.subsumption108:                    ; preds = %if.then106
  %145 = load i8*, i8** %new_key, align 4
  %146 = load i8*, i8** %new_key, align 4
  %add.ptr109 = getelementptr inbounds i8, i8* %146, i64 0
  %_Dynamic_check.non_null110 = icmp ne i8* %144, null
...
_Dynamic_check.succeeded112:                      ; preds = %_Dynamic_check.subsumption108
  %add.ptr113 = getelementptr inbounds i8, i8* %144, i64 0
  %147 = call i64 @c_TPtoO(i8* %145)
  %148 = inttoptr i64 %147 to i8*
  %149 = call i64 @c_TPtoO(i8* %144)
  %150 = inttoptr i64 %149 to i8*
  %_Dynamic_check.lower114 = icmp ule i8* %148, %150
  %151 = call i64 @c_TPtoO(i8* %add.ptr113)
  %152 = inttoptr i64 %151 to i8*
  %153 = call i64 @c_TPtoO(i8* %add.ptr109)
  %154 = inttoptr i64 %153 to i8*
  %_Dynamic_check.upper115 = icmp ule i8* %152, %154
...
_Dynamic_check.success118:                        ; preds = %_Dynamic_check.succeeded112, %if.then106
  %155 = ptrtoint i8* %144 to i32
  %156 = call i8* @c_fetch_pointer_from_offset(i32 %155)
  %157 = call i1 @c_isTaintedPointerToTaintedMem(i8* %156)
  br i1 %157, label %_Dynamic_check.succeeded120, label %_Dynamic_check.failed119

_Dynamic_check.succeeded120:                      ; preds = %_Dynamic_check.success118
  call void @t_free(i8* %156)
  %158 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %output_value, align 4
  ...
  br i1 %161, label %_Dynamic_check.succeeded122, label %_Dynamic_check.failed121

_Dynamic_check.succeeded122:                      ; preds = %_Dynamic_check.succeeded120
  %162 = bitcast i8* %160 to %Tstruct.Spl_json_value_t_t*
  call void bitcast (void (%Tstruct.Spl_json_value_t_t*)* @json_value_free to void (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %162)
  %163 = load i8*, i8** %string.addr, align 4
  %164 = load i8*, i8** %str_cpy, align 4
  %165 = ptrtoint i8* %163 to i32
  %166 = call i8* @c_fetch_pointer_from_offset(i32 %165)
  %167 = call i1 @c_isTaintedPointerToTaintedMem(i8* %166)
  br i1 %167, label %_Dynamic_check.succeeded124, label %_Dynamic_check.failed123

_Dynamic_check.succeeded124:                      ; preds = %_Dynamic_check.succeeded122
  %168 = ptrtoint i8* %164 to i32
  %169 = call i8* @c_fetch_pointer_from_offset(i32 %168)
  %170 = call i1 @c_isTaintedPointerToTaintedMem(i8* %169)
  br i1 %170, label %_Dynamic_check.succeeded126, label %_Dynamic_check.failed125

_Dynamic_check.succeeded126:                      ; preds = %_Dynamic_check.succeeded124
  %call127 = call i8* @t_strcpy(i8* %166, i8* %169)
  store %Tstruct.Spl_json_value_t_t* null, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
if.end128:                                        ; preds = %_Dynamic_check.succeeded102
  %171 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %output_object, align 4
  %172 = load i8*, i8** %new_key, align 4
  %173 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %new_value, align 4
  ...
  br i1 %176, label %_Dynamic_check.succeeded130, label %_Dynamic_check.failed129

_Dynamic_check.succeeded130:                      ; preds = %if.end128
  %177 = bitcast i8* %175 to %Tstruct.Spl_json_object_t_t*
  %178 = ptrtoint i8* %172 to i32
  %179 = call i8* @c_fetch_pointer_from_offset(i32 %178)
  %180 = call i1 @c_isTaintedPointerToTaintedMem(i8* %179)
  br i1 %180, label %_Dynamic_check.succeeded132, label %_Dynamic_check.failed131

_Dynamic_check.succeeded132:                      ; preds = %_Dynamic_check.succeeded130
  %181 = ptrtoint %Tstruct.Spl_json_value_t_t* %173 to i32
  %182 = call i8* @c_fetch_pointer_from_offset(i32 %181)
  %183 = call i1 @c_isTaintedPointerToTaintedMem(i8* %182)
  br i1 %183, label %_Dynamic_check.succeeded134, label %_Dynamic_check.failed133

_Dynamic_check.succeeded134:                      ; preds = %_Dynamic_check.succeeded132
  %184 = bitcast i8* %182 to %Tstruct.Spl_json_value_t_t*
  %call135 = call i32 bitcast (i32 (%Tstruct.json_object_t_t*, i8*, %Tstruct.json_value_t_t*)* @json_object_add to i32 (%Tstruct.Spl_json_object_t_t*, i8*, %Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_object_t_t* %177, i8* %179, %Tstruct.Spl_json_value_t_t* %184)
  %cmp136 = icmp eq i32 %call135, -1
  br i1 %cmp136, label %if.then138, label %if.end162

if.then138:                                       ; preds = %_Dynamic_check.succeeded134
  %185 = load i8*, i8** %new_key, align 4
  %_Dynamic_check.is_null139 = icmp eq i8* %185, null
...
_Dynamic_check.subsumption140:                    ; preds = %if.then138
  %186 = load i8*, i8** %new_key, align 4
  %187 = load i8*, i8** %new_key, align 4
  %add.ptr141 = getelementptr inbounds i8, i8* %187, i64 0
  %_Dynamic_check.non_null142 = icmp ne i8* %185, null
...
_Dynamic_check.succeeded144:                      ; preds = %_Dynamic_check.subsumption140
  %add.ptr145 = getelementptr inbounds i8, i8* %185, i64 0
  %188 = call i64 @c_TPtoO(i8* %186)
  %189 = inttoptr i64 %188 to i8*
  %190 = call i64 @c_TPtoO(i8* %185)
  %191 = inttoptr i64 %190 to i8*
  %_Dynamic_check.lower146 = icmp ule i8* %189, %191
  %192 = call i64 @c_TPtoO(i8* %add.ptr145)
  %193 = inttoptr i64 %192 to i8*
  %194 = call i64 @c_TPtoO(i8* %add.ptr141)
  %195 = inttoptr i64 %194 to i8*
  %_Dynamic_check.upper147 = icmp ule i8* %193, %195
...
_Dynamic_check.success150:                        ; preds = %_Dynamic_check.succeeded144, %if.then138
  %196 = ptrtoint i8* %185 to i32
  %197 = call i8* @c_fetch_pointer_from_offset(i32 %196)
  %198 = call i1 @c_isTaintedPointerToTaintedMem(i8* %197)
  br i1 %198, label %_Dynamic_check.succeeded152, label %_Dynamic_check.failed151

_Dynamic_check.succeeded152:                      ; preds = %_Dynamic_check.success150
  call void @t_free(i8* %197)
  %199 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %new_value, align 4
  %200 = ptrtoint %Tstruct.Spl_json_value_t_t* %199 to i32
  %201 = call i8* @c_fetch_pointer_from_offset(i32 %200)
  %202 = call i1 @c_isTaintedPointerToTaintedMem(i8* %201)
  br i1 %202, label %_Dynamic_check.succeeded154, label %_Dynamic_check.failed153

_Dynamic_check.succeeded154:                      ; preds = %_Dynamic_check.succeeded152
  %203 = bitcast i8* %201 to %Tstruct.Spl_json_value_t_t*
  call void bitcast (void (%Tstruct.Spl_json_value_t_t*)* @json_value_free to void (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %203)
  %204 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %output_value, align 4
  %205 = ptrtoint %Tstruct.Spl_json_value_t_t* %204 to i32
  %206 = call i8* @c_fetch_pointer_from_offset(i32 %205)
  %207 = call i1 @c_isTaintedPointerToTaintedMem(i8* %206)
  br i1 %207, label %_Dynamic_check.succeeded156, label %_Dynamic_check.failed155

_Dynamic_check.succeeded156:                      ; preds = %_Dynamic_check.succeeded154
  %208 = bitcast i8* %206 to %Tstruct.Spl_json_value_t_t*
  call void bitcast (void (%Tstruct.Spl_json_value_t_t*)* @json_value_free to void (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %208)
  %209 = load i8*, i8** %string.addr, align 4
  %210 = load i8*, i8** %str_cpy, align 4
  ...
  br i1 %213, label %_Dynamic_check.succeeded158, label %_Dynamic_check.failed157
...
_Dynamic_check.succeeded158:                      ; preds = %_Dynamic_check.succeeded156
  ...
  br i1 %216, label %_Dynamic_check.succeeded160, label %_Dynamic_check.failed159

_Dynamic_check.succeeded160:                      ; preds = %_Dynamic_check.succeeded158
  %call161 = call i8* @t_strcpy(i8* %212, i8* %215)
  store %Tstruct.Spl_json_value_t_t* null, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
if.end162:                                        ; preds = %_Dynamic_check.succeeded134
  %217 = load i8*, i8** %new_key, align 4
  %_Dynamic_check.is_null163 = icmp eq i8* %217, null
...
_Dynamic_check.subsumption164:                    ; preds = %if.end162
  %218 = load i8*, i8** %new_key, align 4
  %219 = load i8*, i8** %new_key, align 4
  %add.ptr165 = getelementptr inbounds i8, i8* %219, i64 0
  %_Dynamic_check.non_null166 = icmp ne i8* %217, null
...
_Dynamic_check.succeeded168:                      ; preds = %_Dynamic_check.subsumption164
  %add.ptr169 = getelementptr inbounds i8, i8* %217, i64 0
  %220 = call i64 @c_TPtoO(i8* %218)
  %221 = inttoptr i64 %220 to i8*
  %222 = call i64 @c_TPtoO(i8* %217)
  %223 = inttoptr i64 %222 to i8*
  %_Dynamic_check.lower170 = icmp ule i8* %221, %223
  %224 = call i64 @c_TPtoO(i8* %add.ptr169)
  %225 = inttoptr i64 %224 to i8*
  %226 = call i64 @c_TPtoO(i8* %add.ptr165)
  %227 = inttoptr i64 %226 to i8*
  %_Dynamic_check.upper171 = icmp ule i8* %225, %227
...
while.cond177:                                    ; preds = %while.body183, %_Dynamic_check.succeeded176
  ...
  br i1 %234, label %_Dynamic_check.succeeded179, label %_Dynamic_check.failed178

_Dynamic_check.succeeded179:                      ; preds = %while.cond177
  %235 = load i8, i8* %233, align 1
  %conv180 = zext i8 %235 to i32
...
while.body183:                                    ; preds = %_Dynamic_check.succeeded179
  %236 = load i8*, i8** %str_cpy, align 4
  %incdec.ptr184 = getelementptr inbounds i8, i8* %236, i32 1
...
while.end185:                                     ; preds = %_Dynamic_check.succeeded179
  %237 = load i8*, i8** %str_cpy, align 4
  ...
  br i1 %240, label %_Dynamic_check.succeeded187, label %_Dynamic_check.failed186

_Dynamic_check.succeeded187:                      ; preds = %while.end185
  %241 = load i8, i8* %239, align 1
  %conv188 = sext i8 %241 to i32
...
if.end192:                                        ; preds = %_Dynamic_check.succeeded187
  %242 = load i8*, i8** %str_cpy, align 4
  %incdec.ptr193 = getelementptr inbounds i8, i8* %242, i32 1
  store i8* %incdec.ptr193, i8** %str_cpy, align 4
  br label %while.cond194

while.cond194:                                    ; preds = %while.body200, %if.end192
  %243 = load i8*, i8** %str_cpy, align 4
  ...
  br i1 %246, label %_Dynamic_check.succeeded196, label %_Dynamic_check.failed195

_Dynamic_check.succeeded196:                      ; preds = %while.cond194
  %247 = load i8, i8* %245, align 1
  %conv197 = zext i8 %247 to i32
...
while.body200:                                    ; preds = %_Dynamic_check.succeeded196
  %248 = load i8*, i8** %str_cpy, align 4
  %incdec.ptr201 = getelementptr inbounds i8, i8* %248, i32 1
...
while.cond204:                                    ; preds = %while.body210, %while.end203
  %249 = load i8*, i8** %str_cpy, align 4
  ...
  br i1 %252, label %_Dynamic_check.succeeded206, label %_Dynamic_check.failed205

_Dynamic_check.succeeded206:                      ; preds = %while.cond204
  %253 = load i8, i8* %251, align 1
  %conv207 = zext i8 %253 to i32
...
while.body210:                                    ; preds = %_Dynamic_check.succeeded206
  %254 = load i8*, i8** %str_cpy, align 4
  %incdec.ptr211 = getelementptr inbounds i8, i8* %254, i32 1
...
while.end212:                                     ; preds = %_Dynamic_check.succeeded206
  %255 = load i8*, i8** %str_cpy, align 4
  ...
  br i1 %258, label %_Dynamic_check.succeeded214, label %_Dynamic_check.failed213

_Dynamic_check.succeeded214:                      ; preds = %while.end212
  %259 = load i8, i8* %257, align 1
  %conv215 = sext i8 %259 to i32
...
lor.lhs.false:                                    ; preds = %_Dynamic_check.succeeded214
  %260 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %output_object, align 4
  %261 = load %Tstruct.Spl_json_object_t_t*, %Tstruct.Spl_json_object_t_t** %output_object, align 4
  %262 = ptrtoint %Tstruct.Spl_json_object_t_t* %261 to i32
  %263 = call i8* @c_fetch_pointer_from_offset(i32 %262)
  %264 = call i1 @c_isTaintedPointerToTaintedMem(i8* %263)
  br i1 %264, label %_Dynamic_check.succeeded219, label %_Dynamic_check.failed218

_Dynamic_check.succeeded219:                      ; preds = %lor.lhs.false
  %265 = bitcast i8* %263 to %Tstruct.Spl_json_object_t_t*
  %call220 = call i64 bitcast (i64 (%Tstruct.Spl_json_object_t_t*)* @json_object_get_count to i64 (%Tstruct.Spl_json_object_t_t*)*)(%Tstruct.Spl_json_object_t_t* %265)
  %266 = ptrtoint %Tstruct.Spl_json_object_t_t* %260 to i32
  %267 = call i8* @c_fetch_pointer_from_offset(i32 %266)
  %268 = call i1 @c_isTaintedPointerToTaintedMem(i8* %267)
  br i1 %268, label %_Dynamic_check.succeeded222, label %_Dynamic_check.failed221

_Dynamic_check.succeeded222:                      ; preds = %_Dynamic_check.succeeded219
  %269 = bitcast i8* %267 to %Tstruct.Spl_json_object_t_t*
  %call223 = call i32 @json_object_resize(%Tstruct.Spl_json_object_t_t* %269, i64 %call220)
...
if.then226:                                       ; preds = %_Dynamic_check.succeeded222, %_Dynamic_check.succeeded214
  %270 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %output_value, align 4
  %271 = ptrtoint %Tstruct.Spl_json_value_t_t* %270 to i32
  %272 = call i8* @c_fetch_pointer_from_offset(i32 %271)
  %273 = call i1 @c_isTaintedPointerToTaintedMem(i8* %272)
  br i1 %273, label %_Dynamic_check.succeeded228, label %_Dynamic_check.failed227

_Dynamic_check.succeeded228:                      ; preds = %if.then226
  %274 = bitcast i8* %272 to %Tstruct.Spl_json_value_t_t*
  call void bitcast (void (%Tstruct.Spl_json_value_t_t*)* @json_value_free to void (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %274)
  %275 = load i8*, i8** %string.addr, align 4
  %276 = load i8*, i8** %str_cpy, align 4
  ...
  br i1 %279, label %_Dynamic_check.succeeded230, label %_Dynamic_check.failed229
...
_Dynamic_check.succeeded230:                      ; preds = %_Dynamic_check.succeeded228
  ...
  br i1 %282, label %_Dynamic_check.succeeded232, label %_Dynamic_check.failed231

_Dynamic_check.succeeded232:                      ; preds = %_Dynamic_check.succeeded230
  %call233 = call i8* @t_strcpy(i8* %278, i8* %281)
  store %Tstruct.Spl_json_value_t_t* null, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
if.end234:                                        ; preds = %_Dynamic_check.succeeded222
  %283 = load i8*, i8** %str_cpy, align 4
  %incdec.ptr235 = getelementptr inbounds i8, i8* %283, i32 1
  ...
  br i1 %288, label %_Dynamic_check.succeeded237, label %_Dynamic_check.failed236
...
_Dynamic_check.succeeded237:                      ; preds = %if.end234
  ...
  br i1 %291, label %_Dynamic_check.succeeded239, label %_Dynamic_check.failed238

_Dynamic_check.succeeded239:                      ; preds = %_Dynamic_check.succeeded237
  %call240 = call i8* @t_strcpy(i8* %287, i8* %290)
  %292 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %output_value, align 4
  store %Tstruct.Spl_json_value_t_t* %292, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
return:                                           ; preds = %_Dynamic_check.succeeded239, %_Dynamic_check.succeeded232, %_Dynamic_check.succeeded160, %_Dynamic_check.succeeded126, %_Dynamic_check.succeeded97, %_Dynamic_check.succeeded68, %_Dynamic_check.succeeded47, %_Dynamic_check.succeeded26, %_Dynamic_check.succeeded13
  %293 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %retval, align 4
  ret %Tstruct.Spl_json_value_t_t* %293
}
...
_Dynamic_check.succeeded30:                       ; preds = %if.end28
  %47 = bitcast i8* %45 to %Tstruct.Spl_json_value_t_t*
  %call31 = call %Tstruct.Spl_json_array_t_t* bitcast (%Tstruct.Spl_json_array_t_t* (%Tstruct.Spl_json_value_t_t*)* @json_value_get_array to %Tstruct.Spl_json_array_t_t* (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %47)
  %48 = bitcast %Tstruct.Spl_json_array_t_t* %call31 to %Tstruct.json_array_t_t*
  %49 = bitcast %Tstruct.json_array_t_t* %48 to %Tstruct.Spl_json_array_t_t*
  store %Tstruct.Spl_json_array_t_t* %49, %Tstruct.Spl_json_array_t_t** %output_array, align 4
  %50 = load i8*, i8** %str_cpy, align 4
  %incdec.ptr = getelementptr inbounds i8, i8* %50, i32 1
  store i8* %incdec.ptr, i8** %str_cpy, align 4
  br label %while.cond
...
while.body56:                                     ; preds = %_Dynamic_check.succeeded52
  %77 = load i8*, i8** %str_cpy, align 4
  %78 = load i64, i64* %nesting.addr, align 8
  %79 = ptrtoint i8* %77 to i32
  %80 = call i8* @c_fetch_pointer_from_offset(i32 %79)
  %81 = call i1 @c_isTaintedPointerToTaintedMem(i8* %80)
  br i1 %81, label %_Dynamic_check.succeeded58, label %_Dynamic_check.failed57

_Dynamic_check.succeeded58:                       ; preds = %while.body56
  %call59 = call %Tstruct.Spl_json_value_t_t* @parse_value(i8* %80, i64 %78)
  %82 = bitcast %Tstruct.Spl_json_value_t_t* %call59 to %Tstruct.json_value_t_t*
  %83 = bitcast %Tstruct.json_value_t_t* %82 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %83, %Tstruct.Spl_json_value_t_t** %new_array_value, align 4
  %84 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %new_array_value, align 4
  %85 = ptrtoint %Tstruct.Spl_json_value_t_t* %84 to i32
  %cmp60 = icmp eq i32 %85, 0
  br i1 %cmp60, label %if.then62, label %if.end70

if.then62:                                        ; preds = %_Dynamic_check.succeeded58
  %86 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %output_value, align 4
  %87 = ptrtoint %Tstruct.Spl_json_value_t_t* %86 to i32
  %88 = call i8* @c_fetch_pointer_from_offset(i32 %87)
  %89 = call i1 @c_isTaintedPointerToTaintedMem(i8* %88)
  br i1 %89, label %_Dynamic_check.succeeded64, label %_Dynamic_check.failed63

_Dynamic_check.succeeded64:                       ; preds = %if.then62
  %90 = bitcast i8* %88 to %Tstruct.Spl_json_value_t_t*
  call void bitcast (void (%Tstruct.Spl_json_value_t_t*)* @json_value_free to void (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %90)
  %91 = load i8*, i8** %string.addr, align 4
  %92 = load i8*, i8** %str_cpy, align 4
  %93 = ptrtoint i8* %91 to i32
  %94 = call i8* @c_fetch_pointer_from_offset(i32 %93)
  %95 = call i1 @c_isTaintedPointerToTaintedMem(i8* %94)
  br i1 %95, label %_Dynamic_check.succeeded66, label %_Dynamic_check.failed65

_Dynamic_check.succeeded66:                       ; preds = %_Dynamic_check.succeeded64
  %96 = ptrtoint i8* %92 to i32
  %97 = call i8* @c_fetch_pointer_from_offset(i32 %96)
  %98 = call i1 @c_isTaintedPointerToTaintedMem(i8* %97)
  br i1 %98, label %_Dynamic_check.succeeded68, label %_Dynamic_check.failed67

_Dynamic_check.succeeded68:                       ; preds = %_Dynamic_check.succeeded66
  %call69 = call i8* @t_strcpy(i8* %94, i8* %97)
  store %Tstruct.Spl_json_value_t_t* null, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
if.end70:                                         ; preds = %_Dynamic_check.succeeded58
  %99 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %output_array, align 4
  %100 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %new_array_value, align 4
  %101 = ptrtoint %Tstruct.Spl_json_array_t_t* %99 to i32
  %102 = call i8* @c_fetch_pointer_from_offset(i32 %101)
  %103 = call i1 @c_isTaintedPointerToTaintedMem(i8* %102)
  br i1 %103, label %_Dynamic_check.succeeded72, label %_Dynamic_check.failed71

_Dynamic_check.succeeded72:                       ; preds = %if.end70
  %104 = bitcast i8* %102 to %Tstruct.Spl_json_array_t_t*
  %105 = ptrtoint %Tstruct.Spl_json_value_t_t* %100 to i32
  %106 = call i8* @c_fetch_pointer_from_offset(i32 %105)
  %107 = call i1 @c_isTaintedPointerToTaintedMem(i8* %106)
  br i1 %107, label %_Dynamic_check.succeeded74, label %_Dynamic_check.failed73

_Dynamic_check.succeeded74:                       ; preds = %_Dynamic_check.succeeded72
  %108 = bitcast i8* %106 to %Tstruct.Spl_json_value_t_t*
  %call75 = call i32 bitcast (i32 (%Tstruct.json_array_t_t*, %Tstruct.json_value_t_t*)* @json_array_add to i32 (%Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_array_t_t* %104, %Tstruct.Spl_json_value_t_t* %108)
...
if.then78:                                        ; preds = %_Dynamic_check.succeeded74
  ...
  %111 = call i8* @c_fetch_pointer_from_offset(i32 %110)
  %112 = call i1 @c_isTaintedPointerToTaintedMem(i8* %111)
  br i1 %112, label %_Dynamic_check.succeeded80, label %_Dynamic_check.failed79
...
_Dynamic_check.succeeded80:                       ; preds = %if.then78
  ...
  %114 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %output_value, align 4
  %115 = ptrtoint %Tstruct.Spl_json_value_t_t* %114 to i32
  %116 = call i8* @c_fetch_pointer_from_offset(i32 %115)
  %117 = call i1 @c_isTaintedPointerToTaintedMem(i8* %116)
  br i1 %117, label %_Dynamic_check.succeeded82, label %_Dynamic_check.failed81

_Dynamic_check.succeeded82:                       ; preds = %_Dynamic_check.succeeded80
  %118 = bitcast i8* %116 to %Tstruct.Spl_json_value_t_t*
  call void bitcast (void (%Tstruct.Spl_json_value_t_t*)* @json_value_free to void (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %118)
  %119 = load i8*, i8** %string.addr, align 4
  %120 = load i8*, i8** %str_cpy, align 4
  %121 = ptrtoint i8* %119 to i32
  %122 = call i8* @c_fetch_pointer_from_offset(i32 %121)
  %123 = call i1 @c_isTaintedPointerToTaintedMem(i8* %122)
  br i1 %123, label %_Dynamic_check.succeeded84, label %_Dynamic_check.failed83

_Dynamic_check.succeeded84:                       ; preds = %_Dynamic_check.succeeded82
  %124 = ptrtoint i8* %120 to i32
  %125 = call i8* @c_fetch_pointer_from_offset(i32 %124)
  %126 = call i1 @c_isTaintedPointerToTaintedMem(i8* %125)
  br i1 %126, label %_Dynamic_check.succeeded86, label %_Dynamic_check.failed85

_Dynamic_check.succeeded86:                       ; preds = %_Dynamic_check.succeeded84
  %call87 = call i8* @t_strcpy(i8* %122, i8* %125)
  store %Tstruct.Spl_json_value_t_t* null, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
while.cond89:                                     ; preds = %while.body95, %if.end88
  ...
  %129 = call i8* @c_fetch_pointer_from_offset(i32 %128)
  %130 = call i1 @c_isTaintedPointerToTaintedMem(i8* %129)
  br i1 %130, label %_Dynamic_check.succeeded91, label %_Dynamic_check.failed90

_Dynamic_check.succeeded91:                       ; preds = %while.cond89
  %131 = load i8, i8* %129, align 1
  %conv92 = zext i8 %131 to i32
...
while.body95:                                     ; preds = %_Dynamic_check.succeeded91
  %132 = load i8*, i8** %str_cpy, align 4
  %incdec.ptr96 = getelementptr inbounds i8, i8* %132, i32 1
...
while.end97:                                      ; preds = %_Dynamic_check.succeeded91
  ...
  br i1 %136, label %_Dynamic_check.succeeded99, label %_Dynamic_check.failed98

_Dynamic_check.succeeded99:                       ; preds = %while.end97
  %137 = load i8, i8* %135, align 1
  %conv100 = sext i8 %137 to i32
...
while.body112:                                    ; preds = %_Dynamic_check.succeeded108
  ...
  %incdec.ptr113 = getelementptr inbounds i8, i8* %144, i32 1
...
while.cond116:                                    ; preds = %while.body122, %while.end115
  %145 = load i8*, i8** %str_cpy, align 4
  %146 = ptrtoint i8* %145 to i32
  %147 = call i8* @c_fetch_pointer_from_offset(i32 %146)
  %148 = call i1 @c_isTaintedPointerToTaintedMem(i8* %147)
  br i1 %148, label %_Dynamic_check.succeeded118, label %_Dynamic_check.failed117

_Dynamic_check.succeeded118:                      ; preds = %while.cond116
  %149 = load i8, i8* %147, align 1
  %conv119 = zext i8 %149 to i32
...
while.body122:                                    ; preds = %_Dynamic_check.succeeded118
  %150 = load i8*, i8** %str_cpy, align 4
...
while.end124:                                     ; preds = %_Dynamic_check.succeeded118
  %151 = load i8*, i8** %str_cpy, align 4
  %152 = ptrtoint i8* %151 to i32
  %153 = call i8* @c_fetch_pointer_from_offset(i32 %152)
  %154 = call i1 @c_isTaintedPointerToTaintedMem(i8* %153)
  br i1 %154, label %_Dynamic_check.succeeded126, label %_Dynamic_check.failed125
...
lor.lhs.false:                                    ; preds = %_Dynamic_check.succeeded126
  %156 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %output_array, align 4
  %157 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %output_array, align 4
  %158 = ptrtoint %Tstruct.Spl_json_array_t_t* %157 to i32
  %159 = call i8* @c_fetch_pointer_from_offset(i32 %158)
  %160 = call i1 @c_isTaintedPointerToTaintedMem(i8* %159)
  br i1 %160, label %_Dynamic_check.succeeded131, label %_Dynamic_check.failed130

_Dynamic_check.succeeded131:                      ; preds = %lor.lhs.false
  %161 = bitcast i8* %159 to %Tstruct.Spl_json_array_t_t*
  %call132 = call i64 bitcast (i64 (%Tstruct.Spl_json_array_t_t*)* @json_array_get_count to i64 (%Tstruct.Spl_json_array_t_t*)*)(%Tstruct.Spl_json_array_t_t* %161)
  %162 = ptrtoint %Tstruct.Spl_json_array_t_t* %156 to i32
  %163 = call i8* @c_fetch_pointer_from_offset(i32 %162)
  %164 = call i1 @c_isTaintedPointerToTaintedMem(i8* %163)
  br i1 %164, label %_Dynamic_check.succeeded134, label %_Dynamic_check.failed133

_Dynamic_check.succeeded134:                      ; preds = %_Dynamic_check.succeeded131
  %165 = bitcast i8* %163 to %Tstruct.Spl_json_array_t_t*
  %call135 = call i32 bitcast (i32 (%Tstruct.Spl_json_array_t_t*, i64)* @json_array_resize to i32 (%Tstruct.Spl_json_array_t_t*, i64)*)(%Tstruct.Spl_json_array_t_t* %165, i64 %call132)
  %cmp136 = icmp eq i32 %call135, -1
  br i1 %cmp136, label %if.then138, label %if.end146

if.then138:                                       ; preds = %_Dynamic_check.succeeded134, %_Dynamic_check.succeeded126
  %166 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %output_value, align 4
  %167 = ptrtoint %Tstruct.Spl_json_value_t_t* %166 to i32
  %168 = call i8* @c_fetch_pointer_from_offset(i32 %167)
  %169 = call i1 @c_isTaintedPointerToTaintedMem(i8* %168)
...
_Dynamic_check.succeeded140:                      ; preds = %if.then138
  %170 = bitcast i8* %168 to %Tstruct.Spl_json_value_t_t*
  call void bitcast (void (%Tstruct.Spl_json_value_t_t*)* @json_value_free to void (%Tstruct.Spl_json_value_t_t*)*)(%Tstruct.Spl_json_value_t_t* %170)
  %171 = load i8*, i8** %string.addr, align 4
  %172 = load i8*, i8** %str_cpy, align 4
...
if.end146:                                        ; preds = %_Dynamic_check.succeeded134
  %179 = load i8*, i8** %str_cpy, align 4
  %incdec.ptr147 = getelementptr inbounds i8, i8* %179, i32 1
  ...
  br i1 %184, label %_Dynamic_check.succeeded149, label %_Dynamic_check.failed148
...
_Dynamic_check.succeeded149:                      ; preds = %if.end146
  ...
  br i1 %187, label %_Dynamic_check.succeeded151, label %_Dynamic_check.failed150

_Dynamic_check.succeeded151:                      ; preds = %_Dynamic_check.succeeded149
  %call152 = call i8* @t_strcpy(i8* %183, i8* %186)
  %188 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %output_value, align 4
  store %Tstruct.Spl_json_value_t_t* %188, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
return:                                           ; preds = %_Dynamic_check.succeeded151, %_Dynamic_check.succeeded144, %_Dynamic_check.succeeded86, %_Dynamic_check.succeeded68, %_Dynamic_check.succeeded47, %_Dynamic_check.succeeded26, %_Dynamic_check.succeeded13
  %189 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %retval, align 4
  ret %Tstruct.Spl_json_value_t_t* %189
}
...
entry:
  ...
  %array.addr = alloca %Tstruct.Spl_json_array_t_t*, align 4
  %new_capacity.addr = alloca i64, align 8
  %new_items = alloca %Tstruct.json_value_t_t**, align 4
  %0 = bitcast %Tstruct.json_array_t_t* %array to %Tstruct.Spl_json_array_t_t*
  store %Tstruct.Spl_json_array_t_t* %0, %Tstruct.Spl_json_array_t_t** %array.addr, align 4
  store i64 %new_capacity, i64* %new_capacity.addr, align 8
  store %Tstruct.json_value_t_t** null, %Tstruct.json_value_t_t*** %new_items, align 4
  %1 = load i64, i64* %new_capacity.addr, align 8
  %cmp = icmp eq i64 %1, 0
  br i1 %cmp, label %if.then, label %lor.lhs.false
...
_Dynamic_check.succeeded:                         ; preds = %lor.lhs.false
  ...
  %count = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %7, i32 0, i32 2
...
if.end:                                           ; preds = %_Dynamic_check.succeeded
  %9 = load i64, i64* %new_capacity.addr, align 8
  %mul = mul i64 %9, 8
  %call = call i8* @t_malloc(i64 %mul)
  %10 = bitcast i8* %call to %Tstruct.json_value_t_t**
  store %Tstruct.json_value_t_t** %10, %Tstruct.json_value_t_t*** %new_items, align 4
  %11 = load %Tstruct.json_value_t_t**, %Tstruct.json_value_t_t*** %new_items, align 4
...
if.end6:                                          ; preds = %if.end
  ...
  %15 = call i8* @c_fetch_pointer_from_offset(i32 %14)
  %16 = call i1 @c_isTaintedPointerToTaintedMem(i8* %15)
  br i1 %16, label %_Dynamic_check.succeeded8, label %_Dynamic_check.failed7
...
_Dynamic_check.succeeded8:                        ; preds = %if.end6
  ...
  %18 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.Spl_json_value_t_t*** %items9, align 4
...
land.lhs.true:                                    ; preds = %_Dynamic_check.succeeded8
  ...
  %22 = call i8* @c_fetch_pointer_from_offset(i32 %21)
  %23 = call i1 @c_isTaintedPointerToTaintedMem(i8* %22)
  br i1 %23, label %_Dynamic_check.succeeded13, label %_Dynamic_check.failed12

_Dynamic_check.succeeded13:                       ; preds = %land.lhs.true
  %24 = bitcast i8* %22 to %Tstruct.Spl_json_array_t_t*
  %count14 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %24, i32 0, i32 2
  %25 = load i32, i32* %count14, align 8
  %cmp15 = icmp ugt i32 %25, 0
  br i1 %cmp15, label %if.then17, label %if.end72

if.then17:                                        ; preds = %_Dynamic_check.succeeded13
  %26 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.json_value_t_t*** %new_items, align 4
  %_Dynamic_check.is_null = icmp eq %Tstruct.Spl_json_value_t_t** %26, %Tstruct.json_value_t_t** null
  br i1 %_Dynamic_check.is_null, label %_Dynamic_check.success, label %_Dynamic_check.subsumption

_Dynamic_check.subsumption:                       ; preds = %if.then17
  %27 = load %Tstruct.json_value_t_t**, %Tstruct.json_value_t_t*** %new_items, align 4
  %28 = bitcast %Tstruct.json_value_t_t** %27 to i8*
  %29 = load %Tstruct.json_value_t_t**, %Tstruct.json_value_t_t*** %new_items, align 4
  %30 = bitcast %Tstruct.json_value_t_t** %29 to i8*
  %31 = load i64, i64* %new_capacity.addr, align 8
  %mul18 = mul i64 %31, 8
...
_Dynamic_check.succeeded20:                       ; preds = %_Dynamic_check.subsumption
  %add.ptr = getelementptr inbounds i8, i8* %30, i64 %mul18
  %32 = bitcast %Tstruct.Spl_json_value_t_t** %26 to i8*
  %33 = bitcast %Tstruct.Spl_json_value_t_t** %26 to i8*
...
_Dynamic_check.succeeded22:                       ; preds = %_Dynamic_check.succeeded20
  %38 = bitcast i8* %36 to %Tstruct.Spl_json_array_t_t*
  %count23 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %38, i32 0, i32 2
  %39 = load i32, i32* %count23, align 8
  %conv24 = zext i32 %39 to i64
  %mul25 = mul i64 %conv24, 8
  %_Dynamic_check.non_null26 = icmp ne i8* %33, null
...
_Dynamic_check.succeeded28:                       ; preds = %_Dynamic_check.succeeded22
  %add.ptr29 = getelementptr inbounds i8, i8* %33, i64 %mul25
  %40 = call i64 @c_TPtoO(i8* %28)
  %41 = inttoptr i64 %40 to i8*
  %42 = call i64 @c_TPtoO(i8* %32)
  %43 = inttoptr i64 %42 to i8*
  %_Dynamic_check.lower = icmp ule i8* %41, %43
  %44 = call i64 @c_TPtoO(i8* %add.ptr29)
  %45 = inttoptr i64 %44 to i8*
  %46 = call i64 @c_TPtoO(i8* %add.ptr)
  %47 = inttoptr i64 %46 to i8*
  %_Dynamic_check.upper = icmp ule i8* %45, %47
  %_Dynamic_check.cast = and i1 %_Dynamic_check.lower, %_Dynamic_check.upper
...
_Dynamic_check.success:                           ; preds = %_Dynamic_check.succeeded28, %if.then17
  ...
  %50 = call i8* @c_fetch_pointer_from_offset(i32 %49)
  %51 = call i1 @c_isTaintedPointerToTaintedMem(i8* %50)
  br i1 %51, label %_Dynamic_check.succeeded32, label %_Dynamic_check.failed31

_Dynamic_check.succeeded32:                       ; preds = %_Dynamic_check.success
  %52 = bitcast i8* %50 to %Tstruct.Spl_json_array_t_t*
  %items33 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %52, i32 0, i32 1
  %items34 = bitcast i32* %items33 to %Tstruct.Spl_json_value_t_t***
  %53 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.Spl_json_value_t_t*** %items34, align 4
  %_Dynamic_check.is_null35 = icmp eq %Tstruct.Spl_json_value_t_t** %53, null
...
_Dynamic_check.subsumption36:                     ; preds = %_Dynamic_check.succeeded32
  ...
  %56 = call i8* @c_fetch_pointer_from_offset(i32 %55)
  %57 = call i1 @c_isTaintedPointerToTaintedMem(i8* %56)
  br i1 %57, label %_Dynamic_check.succeeded38, label %_Dynamic_check.failed37

_Dynamic_check.succeeded38:                       ; preds = %_Dynamic_check.subsumption36
  %58 = bitcast i8* %56 to %Tstruct.Spl_json_array_t_t*
  %items39 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %58, i32 0, i32 1
  %items40 = bitcast i32* %items39 to %Tstruct.Spl_json_value_t_t***
  %59 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.Spl_json_value_t_t*** %items40, align 4
  ...
  %62 = call i8* @c_fetch_pointer_from_offset(i32 %61)
  %63 = call i1 @c_isTaintedPointerToTaintedMem(i8* %62)
  br i1 %63, label %_Dynamic_check.succeeded42, label %_Dynamic_check.failed41

_Dynamic_check.succeeded42:                       ; preds = %_Dynamic_check.succeeded38
  %64 = bitcast i8* %62 to %Tstruct.Spl_json_array_t_t*
  %items43 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %64, i32 0, i32 1
  %items44 = bitcast i32* %items43 to %Tstruct.Spl_json_value_t_t***
  %65 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.Spl_json_value_t_t*** %items44, align 4
  %66 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %array.addr, align 4
  %67 = ptrtoint %Tstruct.Spl_json_array_t_t* %66 to i32
  %68 = call i8* @c_fetch_pointer_from_offset(i32 %67)
  %69 = call i1 @c_isTaintedPointerToTaintedMem(i8* %68)
  br i1 %69, label %_Dynamic_check.succeeded46, label %_Dynamic_check.failed45

_Dynamic_check.succeeded46:                       ; preds = %_Dynamic_check.succeeded42
  %70 = bitcast i8* %68 to %Tstruct.Spl_json_array_t_t*
  %capacity = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %70, i32 0, i32 3
  %71 = load i32, i32* %capacity, align 4
  %idx.ext = zext i32 %71 to i64
  %add.ptr47 = getelementptr inbounds %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %65, i64 %idx.ext
  %72 = bitcast %Tstruct.Spl_json_value_t_t** %53 to i8*
  %73 = bitcast i8* %72 to %Tstruct.Spl_json_value_t_t**
  %74 = bitcast %Tstruct.Spl_json_value_t_t** %53 to i8*
  ...
  %77 = call i8* @c_fetch_pointer_from_offset(i32 %76)
  %78 = call i1 @c_isTaintedPointerToTaintedMem(i8* %77)
  br i1 %78, label %_Dynamic_check.succeeded49, label %_Dynamic_check.failed48

_Dynamic_check.succeeded49:                       ; preds = %_Dynamic_check.succeeded46
  %79 = bitcast i8* %77 to %Tstruct.Spl_json_array_t_t*
  %count50 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %79, i32 0, i32 2
  %80 = load i32, i32* %count50, align 8
  %conv51 = zext i32 %80 to i64
  %mul52 = mul i64 %conv51, 8
  %_Dynamic_check.non_null53 = icmp ne i8* %74, null
  br i1 %_Dynamic_check.non_null53, label %_Dynamic_check.succeeded55, label %_Dynamic_check.failed54

_Dynamic_check.succeeded55:                       ; preds = %_Dynamic_check.succeeded49
  %add.ptr56 = getelementptr inbounds i8, i8* %74, i64 %mul52
  %81 = bitcast i8* %add.ptr56 to %Tstruct.Spl_json_value_t_t**
  %82 = bitcast %Tstruct.Spl_json_value_t_t** %59 to i8*
  %83 = call i64 @c_TPtoO(i8* %82)
  %84 = inttoptr i64 %83 to %Tstruct.Spl_json_value_t_t**
  %85 = bitcast %Tstruct.Spl_json_value_t_t** %73 to i8*
  %86 = call i64 @c_TPtoO(i8* %85)
  %87 = inttoptr i64 %86 to %Tstruct.Spl_json_value_t_t**
  %_Dynamic_check.lower57 = icmp ule %Tstruct.Spl_json_value_t_t** %84, %87
  %88 = bitcast %Tstruct.Spl_json_value_t_t** %81 to i8*
  %89 = call i64 @c_TPtoO(i8* %88)
  %90 = inttoptr i64 %89 to %Tstruct.Spl_json_value_t_t**
  %91 = bitcast %Tstruct.Spl_json_value_t_t** %add.ptr47 to i8*
  %92 = call i64 @c_TPtoO(i8* %91)
  %93 = inttoptr i64 %92 to %Tstruct.Spl_json_value_t_t**
  %_Dynamic_check.upper58 = icmp ule %Tstruct.Spl_json_value_t_t** %90, %93
  %_Dynamic_check.cast59 = and i1 %_Dynamic_check.lower57, %_Dynamic_check.upper58
  br i1 %_Dynamic_check.cast59, label %_Dynamic_check.success61, label %_Dynamic_check.failed60

_Dynamic_check.success61:                         ; preds = %_Dynamic_check.succeeded55, %_Dynamic_check.succeeded32
  %94 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %array.addr, align 4
  %95 = ptrtoint %Tstruct.Spl_json_array_t_t* %94 to i32
  %96 = call i8* @c_fetch_pointer_from_offset(i32 %95)
  %97 = call i1 @c_isTaintedPointerToTaintedMem(i8* %96)
  br i1 %97, label %_Dynamic_check.succeeded63, label %_Dynamic_check.failed62

_Dynamic_check.succeeded63:                       ; preds = %_Dynamic_check.success61
  %98 = bitcast i8* %96 to %Tstruct.Spl_json_array_t_t*
  %count64 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %98, i32 0, i32 2
  %99 = load i32, i32* %count64, align 8
  %conv65 = zext i32 %99 to i64
  %mul66 = mul i64 %conv65, 8
  %100 = ptrtoint %Tstruct.Spl_json_value_t_t** %26 to i32
  %101 = call i8* @c_fetch_pointer_from_offset(i32 %100)
  %102 = call i1 @c_isTaintedPointerToTaintedMem(i8* %101)
  br i1 %102, label %_Dynamic_check.succeeded68, label %_Dynamic_check.failed67

_Dynamic_check.succeeded68:                       ; preds = %_Dynamic_check.succeeded63
  %103 = bitcast i8* %101 to %Tstruct.Spl_json_value_t_t**
  %104 = bitcast %Tstruct.Spl_json_value_t_t** %103 to i8*
  %105 = ptrtoint %Tstruct.Spl_json_value_t_t** %53 to i32
  %106 = call i8* @c_fetch_pointer_from_offset(i32 %105)
  %107 = call i1 @c_isTaintedPointerToTaintedMem(i8* %106)
  br i1 %107, label %_Dynamic_check.succeeded70, label %_Dynamic_check.failed69

_Dynamic_check.succeeded70:                       ; preds = %_Dynamic_check.succeeded68
  %108 = bitcast i8* %106 to %Tstruct.Spl_json_value_t_t**
  %109 = bitcast %Tstruct.Spl_json_value_t_t** %108 to i8*
  %call71 = call i8* @t_memcpy(i8* %104, i8* %109, i64 %mul66)
  %110 = bitcast i8* %call71 to %Tstruct.json_value_t_t**
  br label %if.end72
...
if.end72:                                         ; preds = %_Dynamic_check.succeeded70, %_Dynamic_check.succeeded13, %_Dynamic_check.succeeded8
  ...
  %112 = ptrtoint %Tstruct.Spl_json_array_t_t* %111 to i32
  %113 = call i8* @c_fetch_pointer_from_offset(i32 %112)
  %114 = call i1 @c_isTaintedPointerToTaintedMem(i8* %113)
  br i1 %114, label %_Dynamic_check.succeeded74, label %_Dynamic_check.failed73

_Dynamic_check.succeeded74:                       ; preds = %if.end72
  %115 = bitcast i8* %113 to %Tstruct.Spl_json_array_t_t*
  %items75 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %115, i32 0, i32 1
  %items76 = bitcast i32* %items75 to %Tstruct.Spl_json_value_t_t***
  %116 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.Spl_json_value_t_t*** %items76, align 4
  %117 = ptrtoint %Tstruct.Spl_json_value_t_t** %116 to i32
  %118 = call i8* @c_fetch_pointer_from_offset(i32 %117)
  %119 = call i1 @c_isTaintedPointerToTaintedMem(i8* %118)
  br i1 %119, label %_Dynamic_check.succeeded78, label %_Dynamic_check.failed77

_Dynamic_check.succeeded78:                       ; preds = %_Dynamic_check.succeeded74
  %120 = bitcast i8* %118 to %Tstruct.Spl_json_value_t_t**
  %121 = bitcast %Tstruct.Spl_json_value_t_t** %120 to i8*
  call void @t_free(i8* %121)
  %122 = load i64, i64* %new_capacity.addr, align 8
  %conv79 = trunc i64 %122 to i32
  %123 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %array.addr, align 4
  %124 = ptrtoint %Tstruct.Spl_json_array_t_t* %123 to i32
  %125 = call i8* @c_fetch_pointer_from_offset(i32 %124)
  %126 = call i1 @c_isTaintedPointerToTaintedMem(i8* %125)
  br i1 %126, label %_Dynamic_check.succeeded81, label %_Dynamic_check.failed80

_Dynamic_check.succeeded81:                       ; preds = %_Dynamic_check.succeeded78
  %127 = bitcast i8* %125 to %Tstruct.Spl_json_array_t_t*
  %capacity82 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %127, i32 0, i32 3
  store i32 %conv79, i32* %capacity82, align 4
  %128 = load %Tstruct.json_value_t_t**, %Tstruct.json_value_t_t*** %new_items, align 4
  %129 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %array.addr, align 4
  %130 = ptrtoint %Tstruct.Spl_json_array_t_t* %129 to i32
  %131 = call i8* @c_fetch_pointer_from_offset(i32 %130)
  %132 = call i1 @c_isTaintedPointerToTaintedMem(i8* %131)
...
_Dynamic_check.succeeded84:                       ; preds = %_Dynamic_check.succeeded81
  %133 = bitcast i8* %131 to %Tstruct.Spl_json_array_t_t*
  %items85 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %133, i32 0, i32 1
  %items86 = bitcast i32* %items85 to %Tstruct.Spl_json_value_t_t***
  %134 = bitcast %Tstruct.json_value_t_t** %128 to %Tstruct.Spl_json_value_t_t**
  store %Tstruct.Spl_json_value_t_t** %134, %Tstruct.Spl_json_value_t_t*** %items86, align 4
  store i32 0, i32* %retval, align 4
  br label %return
...
if.then:                                          ; preds = %_Dynamic_check.succeeded
  ...
  %24 = bitcast %Tstruct.Spl_json_value_t_t* %call7 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %24, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
if.end:                                           ; preds = %_Dynamic_check.succeeded
  %25 = load i8*, i8** %string.addr, align 4
  %26 = load i8*, i8** %str_cpy, align 4
  %27 = ptrtoint i8* %25 to i64
  %28 = call i8* @c_ConditionalTaintedOff2Ptr(i64 %27)
  %29 = ptrtoint i8* %26 to i64
  %30 = call i8* @c_ConditionalTaintedOff2Ptr(i64 %29)
  %call8 = call i8* @t_strcpy(i8* %28, i8* %30)
  store %Tstruct.Spl_json_value_t_t* null, %Tstruct.Spl_json_value_t_t** %retval, align 8
  br label %return
...
_Dynamic_check.succeeded18:                       ; preds = %if.end16
  ...
  %38 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value.addr, align 4
  %39 = ptrtoint %Tstruct.Spl_json_value_t_t* %38 to i32
  %40 = call i8* @c_fetch_pointer_from_offset(i32 %39)
  %41 = call i1 @c_isTaintedPointerToTaintedMem(i8* %40)
  br i1 %41, label %_Dynamic_check.succeeded21, label %_Dynamic_check.failed20

_Dynamic_check.succeeded21:                       ; preds = %_Dynamic_check.succeeded18
  %42 = bitcast i8* %40 to %Tstruct.Spl_json_value_t_t*
  %parent = getelementptr inbounds %Tstruct.Spl_json_value_t_t, %Tstruct.Spl_json_value_t_t* %42, i32 0, i32 0
  %parent22 = bitcast i32* %parent to %Tstruct.Spl_json_value_t_t**
  %43 = bitcast %Tstruct.json_value_t_t* %37 to %Tstruct.Spl_json_value_t_t*
  store %Tstruct.Spl_json_value_t_t* %43, %Tstruct.Spl_json_value_t_t** %parent22, align 8
  %44 = load %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %value.addr, align 4
  ...
  %47 = call i8* @c_fetch_pointer_from_offset(i32 %46)
  %48 = call i1 @c_isTaintedPointerToTaintedMem(i8* %47)
  br i1 %48, label %_Dynamic_check.succeeded24, label %_Dynamic_check.failed23

_Dynamic_check.succeeded24:                       ; preds = %_Dynamic_check.succeeded21
  %49 = bitcast i8* %47 to %Tstruct.Spl_json_array_t_t*
  %items = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %49, i32 0, i32 1
  %items25 = bitcast i32* %items to %Tstruct.Spl_json_value_t_t***
  %50 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.Spl_json_value_t_t*** %items25, align 4
  %51 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %array.addr, align 4
  %52 = ptrtoint %Tstruct.Spl_json_array_t_t* %51 to i32
  %53 = call i8* @c_fetch_pointer_from_offset(i32 %52)
  %54 = call i1 @c_isTaintedPointerToTaintedMem(i8* %53)
  br i1 %54, label %_Dynamic_check.succeeded27, label %_Dynamic_check.failed26

_Dynamic_check.succeeded27:                       ; preds = %_Dynamic_check.succeeded24
  %55 = bitcast i8* %53 to %Tstruct.Spl_json_array_t_t*
  %count28 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %55, i32 0, i32 2
  %56 = load i32, i32* %count28, align 8
  %idxprom = zext i32 %56 to i64
  %57 = ptrtoint %Tstruct.Spl_json_value_t_t** %50 to i32
  %58 = call i8* @c_fetch_pointer_from_offset(i32 %57)
  %59 = call i1 @c_isTaintedPointerToTaintedMem(i8* %58)
  br i1 %59, label %_Dynamic_check.succeeded30, label %_Dynamic_check.failed29

_Dynamic_check.succeeded30:                       ; preds = %_Dynamic_check.succeeded27
  %60 = bitcast i8* %58 to %Tstruct.Spl_json_value_t_t**
  %61 = bitcast %Tstruct.Spl_json_value_t_t** %60 to i32*
  %arrayidx = getelementptr inbounds i32, i32* %61, i64 %idxprom
  %62 = bitcast i32* %arrayidx to %Tstruct.Spl_json_value_t_t**
  %63 = bitcast %Tstruct.Spl_json_value_t_t** %62 to i8*
  %64 = call i64 @c_TPtoO(i8* %63)
  %65 = inttoptr i64 %64 to %Tstruct.Spl_json_value_t_t**
  %66 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %array.addr, align 4
  %67 = ptrtoint %Tstruct.Spl_json_array_t_t* %66 to i32
  %68 = call i8* @c_fetch_pointer_from_offset(i32 %67)
  %69 = call i1 @c_isTaintedPointerToTaintedMem(i8* %68)
  br i1 %69, label %_Dynamic_check.succeeded32, label %_Dynamic_check.failed31

_Dynamic_check.succeeded32:                       ; preds = %_Dynamic_check.succeeded30
  %70 = bitcast i8* %68 to %Tstruct.Spl_json_array_t_t*
  %items33 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %70, i32 0, i32 1
  %items34 = bitcast i32* %items33 to %Tstruct.Spl_json_value_t_t***
  %71 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.Spl_json_value_t_t*** %items34, align 4
  %72 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %array.addr, align 4
...
_Dynamic_check.succeeded36:                       ; preds = %_Dynamic_check.succeeded32
  %76 = bitcast i8* %74 to %Tstruct.Spl_json_array_t_t*
  %items37 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %76, i32 0, i32 1
  %items38 = bitcast i32* %items37 to %Tstruct.Spl_json_value_t_t***
  %77 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.Spl_json_value_t_t*** %items38, align 4
  %78 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %array.addr, align 4
  %79 = ptrtoint %Tstruct.Spl_json_array_t_t* %78 to i32
  %80 = call i8* @c_fetch_pointer_from_offset(i32 %79)
  %81 = call i1 @c_isTaintedPointerToTaintedMem(i8* %80)
  br i1 %81, label %_Dynamic_check.succeeded40, label %_Dynamic_check.failed39

_Dynamic_check.succeeded40:                       ; preds = %_Dynamic_check.succeeded36
  %82 = bitcast i8* %80 to %Tstruct.Spl_json_array_t_t*
  %capacity41 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %82, i32 0, i32 3
  %83 = load i32, i32* %capacity41, align 4
  %idx.ext = zext i32 %83 to i64
  %add.ptr = getelementptr inbounds %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %77, i64 %idx.ext
  %84 = bitcast %Tstruct.Spl_json_value_t_t** %77 to i32*
  %85 = getelementptr inbounds i32, i32* %84, i64 %idx.ext
  %86 = bitcast i32* %85 to %Tstruct.Spl_json_value_t_t**
  %87 = bitcast %Tstruct.Spl_json_value_t_t** %86 to i8*
  %88 = call i64 @c_TPtoO(i8* %87)
  %89 = inttoptr i64 %88 to %Tstruct.Spl_json_value_t_t**
  %90 = bitcast %Tstruct.Spl_json_value_t_t** %71 to i8*
  %91 = call i64 @c_TPtoO(i8* %90)
  %92 = inttoptr i64 %91 to %Tstruct.Spl_json_value_t_t**
  %_Dynamic_check.lower = icmp ule %Tstruct.Spl_json_value_t_t** %92, %65
  %_Dynamic_check.upper = icmp ult %Tstruct.Spl_json_value_t_t** %65, %89
  %_Dynamic_check.range = and i1 %_Dynamic_check.lower, %_Dynamic_check.upper
  br i1 %_Dynamic_check.range, label %_Dynamic_check.succeeded43, label %_Dynamic_check.failed42

_Dynamic_check.succeeded43:                       ; preds = %_Dynamic_check.succeeded40
  store %Tstruct.Spl_json_value_t_t* %44, %Tstruct.Spl_json_value_t_t** %62, align 8
  %93 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %array.addr, align 4
  %94 = ptrtoint %Tstruct.Spl_json_array_t_t* %93 to i32
  %95 = call i8* @c_fetch_pointer_from_offset(i32 %94)
  %96 = call i1 @c_isTaintedPointerToTaintedMem(i8* %95)
  br i1 %96, label %_Dynamic_check.succeeded45, label %_Dynamic_check.failed44

_Dynamic_check.succeeded45:                       ; preds = %_Dynamic_check.succeeded43
  %97 = bitcast i8* %95 to %Tstruct.Spl_json_array_t_t*
  %count46 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %97, i32 0, i32 2
  %98 = load i32, i32* %count46, align 8
  %inc = add i32 %98, 1
