...
entry:
  ...
  store %Tstruct.Spl_json_array_t_t* %0, %Tstruct.Spl_json_array_t_t** %array.addr, align 4
  store i64 %new_capacity, i64* %new_capacity.addr, align 8
  %1 = bitcast %Tstruct.json_value_t_t*** %new_items to i32*
...
if.end:                                           ; preds = %_Dynamic_check.succeeded
  ...
  %13 = bitcast %Tstruct.json_value_t_t*** %new_items to i32*
  store i32 %12, i32* %13, align 4
  %14 = load %Tstruct.json_value_t_t**, %Tstruct.json_value_t_t*** %new_items, align 4
...
_Dynamic_check.succeeded8:                        ; preds = %if.end6
  ...
  %items = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %20, i32 0, i32 1
  %items9 = bitcast i32* %items to %Tstruct.Spl_json_value_t_t***
  %21 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.Spl_json_value_t_t*** %items9, align 4
...
land.lhs.true:                                    ; preds = %_Dynamic_check.succeeded8
  ...
  %25 = call i8* @c_fetch_pointer_from_offset(i32 %24)
  %26 = call i1 @c_isTaintedPointerToTaintedMem(i8* %25)
  br i1 %26, label %_Dynamic_check.succeeded13, label %_Dynamic_check.failed12

_Dynamic_check.succeeded13:                       ; preds = %land.lhs.true
  %27 = bitcast i8* %25 to %Tstruct.Spl_json_array_t_t*
  %count14 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %27, i32 0, i32 2
  %28 = load i32, i32* %count14, align 8
  %cmp15 = icmp ugt i32 %28, 0
  br i1 %cmp15, label %if.then17, label %if.end72

if.then17:                                        ; preds = %_Dynamic_check.succeeded13
  %29 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.json_value_t_t*** %new_items, align 4
  %_Dynamic_check.is_null = icmp eq %Tstruct.Spl_json_value_t_t** %29, %Tstruct.json_value_t_t** null
  br i1 %_Dynamic_check.is_null, label %_Dynamic_check.success, label %_Dynamic_check.subsumption

_Dynamic_check.subsumption:                       ; preds = %if.then17
  %30 = load %Tstruct.json_value_t_t**, %Tstruct.json_value_t_t*** %new_items, align 4
  %31 = bitcast %Tstruct.json_value_t_t** %30 to i8*
  %32 = load %Tstruct.json_value_t_t**, %Tstruct.json_value_t_t*** %new_items, align 4
  %33 = bitcast %Tstruct.json_value_t_t** %32 to i8*
  %34 = load i64, i64* %new_capacity.addr, align 8
  %mul18 = mul i64 %34, 8
  %_Dynamic_check.non_null = icmp ne i8* %33, null
  br i1 %_Dynamic_check.non_null, label %_Dynamic_check.succeeded20, label %_Dynamic_check.failed19

_Dynamic_check.succeeded20:                       ; preds = %_Dynamic_check.subsumption
  %add.ptr = getelementptr inbounds i8, i8* %33, i64 %mul18
  %35 = bitcast %Tstruct.Spl_json_value_t_t** %29 to i8*
  %36 = bitcast %Tstruct.Spl_json_value_t_t** %29 to i8*
  %37 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %array.addr, align 4
  %38 = ptrtoint %Tstruct.Spl_json_array_t_t* %37 to i32
  %39 = call i8* @c_fetch_pointer_from_offset(i32 %38)
  %40 = call i1 @c_isTaintedPointerToTaintedMem(i8* %39)
...
_Dynamic_check.succeeded22:                       ; preds = %_Dynamic_check.succeeded20
  %41 = bitcast i8* %39 to %Tstruct.Spl_json_array_t_t*
  %count23 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %41, i32 0, i32 2
  %42 = load i32, i32* %count23, align 8
  %conv24 = zext i32 %42 to i64
  %mul25 = mul i64 %conv24, 8
  %_Dynamic_check.non_null26 = icmp ne i8* %36, null
...
_Dynamic_check.succeeded28:                       ; preds = %_Dynamic_check.succeeded22
  %add.ptr29 = getelementptr inbounds i8, i8* %36, i64 %mul25
  %43 = call i64 @c_TPtoO(i8* %31)
  %44 = inttoptr i64 %43 to i8*
  %45 = call i64 @c_TPtoO(i8* %35)
  %46 = inttoptr i64 %45 to i8*
  %_Dynamic_check.lower = icmp ule i8* %44, %46
  %47 = call i64 @c_TPtoO(i8* %add.ptr29)
  %48 = inttoptr i64 %47 to i8*
  %49 = call i64 @c_TPtoO(i8* %add.ptr)
  %50 = inttoptr i64 %49 to i8*
  %_Dynamic_check.upper = icmp ule i8* %48, %50
  %_Dynamic_check.cast = and i1 %_Dynamic_check.lower, %_Dynamic_check.upper
...
_Dynamic_check.success:                           ; preds = %_Dynamic_check.succeeded28, %if.then17
  ...
  %53 = call i8* @c_fetch_pointer_from_offset(i32 %52)
  %54 = call i1 @c_isTaintedPointerToTaintedMem(i8* %53)
  br i1 %54, label %_Dynamic_check.succeeded32, label %_Dynamic_check.failed31

_Dynamic_check.succeeded32:                       ; preds = %_Dynamic_check.success
  %55 = bitcast i8* %53 to %Tstruct.Spl_json_array_t_t*
  %items33 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %55, i32 0, i32 1
  %items34 = bitcast i32* %items33 to %Tstruct.Spl_json_value_t_t***
  %56 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.Spl_json_value_t_t*** %items34, align 4
  %_Dynamic_check.is_null35 = icmp eq %Tstruct.Spl_json_value_t_t** %56, null
...
_Dynamic_check.succeeded38:                       ; preds = %_Dynamic_check.subsumption36
  ...
  %items39 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %61, i32 0, i32 1
  %items40 = bitcast i32* %items39 to %Tstruct.Spl_json_value_t_t***
  %62 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.Spl_json_value_t_t*** %items40, align 4
  ...
  %65 = call i8* @c_fetch_pointer_from_offset(i32 %64)
  %66 = call i1 @c_isTaintedPointerToTaintedMem(i8* %65)
  br i1 %66, label %_Dynamic_check.succeeded42, label %_Dynamic_check.failed41

_Dynamic_check.succeeded42:                       ; preds = %_Dynamic_check.succeeded38
  %67 = bitcast i8* %65 to %Tstruct.Spl_json_array_t_t*
  %items43 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %67, i32 0, i32 1
  %items44 = bitcast i32* %items43 to %Tstruct.Spl_json_value_t_t***
  %68 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.Spl_json_value_t_t*** %items44, align 4
  ...
  %71 = call i8* @c_fetch_pointer_from_offset(i32 %70)
  %72 = call i1 @c_isTaintedPointerToTaintedMem(i8* %71)
  br i1 %72, label %_Dynamic_check.succeeded46, label %_Dynamic_check.failed45

_Dynamic_check.succeeded46:                       ; preds = %_Dynamic_check.succeeded42
  %73 = bitcast i8* %71 to %Tstruct.Spl_json_array_t_t*
  %capacity = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %73, i32 0, i32 3
  %74 = load i32, i32* %capacity, align 4
  %idx.ext = zext i32 %74 to i64
  %add.ptr47 = getelementptr inbounds %Tstruct.Spl_json_value_t_t*, %Tstruct.Spl_json_value_t_t** %68, i64 %idx.ext
  %75 = bitcast %Tstruct.Spl_json_value_t_t** %56 to i8*
  %76 = bitcast i8* %75 to %Tstruct.Spl_json_value_t_t**
  %77 = bitcast %Tstruct.Spl_json_value_t_t** %56 to i8*
  ...
  %80 = call i8* @c_fetch_pointer_from_offset(i32 %79)
  %81 = call i1 @c_isTaintedPointerToTaintedMem(i8* %80)
  br i1 %81, label %_Dynamic_check.succeeded49, label %_Dynamic_check.failed48

_Dynamic_check.succeeded49:                       ; preds = %_Dynamic_check.succeeded46
  %82 = bitcast i8* %80 to %Tstruct.Spl_json_array_t_t*
  %count50 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %82, i32 0, i32 2
  %83 = load i32, i32* %count50, align 8
  %conv51 = zext i32 %83 to i64
  %mul52 = mul i64 %conv51, 8
  %_Dynamic_check.non_null53 = icmp ne i8* %77, null
  br i1 %_Dynamic_check.non_null53, label %_Dynamic_check.succeeded55, label %_Dynamic_check.failed54

_Dynamic_check.succeeded55:                       ; preds = %_Dynamic_check.succeeded49
  %add.ptr56 = getelementptr inbounds i8, i8* %77, i64 %mul52
  %84 = bitcast i8* %add.ptr56 to %Tstruct.Spl_json_value_t_t**
  %85 = bitcast %Tstruct.Spl_json_value_t_t** %62 to i8*
  %86 = call i64 @c_TPtoO(i8* %85)
  %87 = inttoptr i64 %86 to %Tstruct.Spl_json_value_t_t**
  %88 = bitcast %Tstruct.Spl_json_value_t_t** %76 to i8*
  %89 = call i64 @c_TPtoO(i8* %88)
  %90 = inttoptr i64 %89 to %Tstruct.Spl_json_value_t_t**
  %_Dynamic_check.lower57 = icmp ule %Tstruct.Spl_json_value_t_t** %87, %90
  %91 = bitcast %Tstruct.Spl_json_value_t_t** %84 to i8*
  %92 = call i64 @c_TPtoO(i8* %91)
  %93 = inttoptr i64 %92 to %Tstruct.Spl_json_value_t_t**
  %94 = bitcast %Tstruct.Spl_json_value_t_t** %add.ptr47 to i8*
  %95 = call i64 @c_TPtoO(i8* %94)
  %96 = inttoptr i64 %95 to %Tstruct.Spl_json_value_t_t**
  %_Dynamic_check.upper58 = icmp ule %Tstruct.Spl_json_value_t_t** %93, %96
  %_Dynamic_check.cast59 = and i1 %_Dynamic_check.lower57, %_Dynamic_check.upper58
...
_Dynamic_check.success61:                         ; preds = %_Dynamic_check.succeeded55, %_Dynamic_check.succeeded32
  %97 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %array.addr, align 4
  %98 = ptrtoint %Tstruct.Spl_json_array_t_t* %97 to i32
  %99 = call i8* @c_fetch_pointer_from_offset(i32 %98)
  %100 = call i1 @c_isTaintedPointerToTaintedMem(i8* %99)
  br i1 %100, label %_Dynamic_check.succeeded63, label %_Dynamic_check.failed62

_Dynamic_check.succeeded63:                       ; preds = %_Dynamic_check.success61
  %101 = bitcast i8* %99 to %Tstruct.Spl_json_array_t_t*
  %count64 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %101, i32 0, i32 2
  %102 = load i32, i32* %count64, align 8
  %conv65 = zext i32 %102 to i64
  %mul66 = mul i64 %conv65, 8
  %103 = ptrtoint %Tstruct.Spl_json_value_t_t** %29 to i32
  %104 = call i8* @c_fetch_pointer_from_offset(i32 %103)
  %105 = call i1 @c_isTaintedPointerToTaintedMem(i8* %104)
  br i1 %105, label %_Dynamic_check.succeeded68, label %_Dynamic_check.failed67

_Dynamic_check.succeeded68:                       ; preds = %_Dynamic_check.succeeded63
  %106 = bitcast i8* %104 to %Tstruct.Spl_json_value_t_t**
  %107 = bitcast %Tstruct.Spl_json_value_t_t** %106 to i8*
  %108 = ptrtoint %Tstruct.Spl_json_value_t_t** %56 to i32
  %109 = call i8* @c_fetch_pointer_from_offset(i32 %108)
  %110 = call i1 @c_isTaintedPointerToTaintedMem(i8* %109)
  br i1 %110, label %_Dynamic_check.succeeded70, label %_Dynamic_check.failed69

_Dynamic_check.succeeded70:                       ; preds = %_Dynamic_check.succeeded68
  %111 = bitcast i8* %109 to %Tstruct.Spl_json_value_t_t**
  %112 = bitcast %Tstruct.Spl_json_value_t_t** %111 to i8*
  %call71 = call i8* @t_memcpy(i8* %107, i8* %112, i64 %mul66)
  %113 = bitcast i8* %call71 to %Tstruct.json_value_t_t**
  br label %if.end72
...
if.end72:                                         ; preds = %_Dynamic_check.succeeded70, %_Dynamic_check.succeeded13, %_Dynamic_check.succeeded8
  %114 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %array.addr, align 4
  %115 = ptrtoint %Tstruct.Spl_json_array_t_t* %114 to i32
  %116 = call i8* @c_fetch_pointer_from_offset(i32 %115)
  %117 = call i1 @c_isTaintedPointerToTaintedMem(i8* %116)
  br i1 %117, label %_Dynamic_check.succeeded74, label %_Dynamic_check.failed73

_Dynamic_check.succeeded74:                       ; preds = %if.end72
  %118 = bitcast i8* %116 to %Tstruct.Spl_json_array_t_t*
  %items75 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %118, i32 0, i32 1
  %items76 = bitcast i32* %items75 to %Tstruct.Spl_json_value_t_t***
  %119 = load %Tstruct.Spl_json_value_t_t**, %Tstruct.Spl_json_value_t_t*** %items76, align 4
  %120 = ptrtoint %Tstruct.Spl_json_value_t_t** %119 to i32
  %121 = call i8* @c_fetch_pointer_from_offset(i32 %120)
  %122 = call i1 @c_isTaintedPointerToTaintedMem(i8* %121)
  br i1 %122, label %_Dynamic_check.succeeded78, label %_Dynamic_check.failed77

_Dynamic_check.succeeded78:                       ; preds = %_Dynamic_check.succeeded74
  %123 = bitcast i8* %121 to %Tstruct.Spl_json_value_t_t**
  %124 = bitcast %Tstruct.Spl_json_value_t_t** %123 to i8*
  call void @t_free(i8* %124)
  %125 = load i64, i64* %new_capacity.addr, align 8
  %conv79 = trunc i64 %125 to i32
  %126 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %array.addr, align 4
  %127 = ptrtoint %Tstruct.Spl_json_array_t_t* %126 to i32
  %128 = call i8* @c_fetch_pointer_from_offset(i32 %127)
  %129 = call i1 @c_isTaintedPointerToTaintedMem(i8* %128)
  br i1 %129, label %_Dynamic_check.succeeded81, label %_Dynamic_check.failed80

_Dynamic_check.succeeded81:                       ; preds = %_Dynamic_check.succeeded78
  %130 = bitcast i8* %128 to %Tstruct.Spl_json_array_t_t*
  %capacity82 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %130, i32 0, i32 3
  store i32 %conv79, i32* %capacity82, align 4
  %131 = load %Tstruct.json_value_t_t**, %Tstruct.json_value_t_t*** %new_items, align 4
  %132 = load %Tstruct.Spl_json_array_t_t*, %Tstruct.Spl_json_array_t_t** %array.addr, align 4
  %133 = ptrtoint %Tstruct.Spl_json_array_t_t* %132 to i32
  %134 = call i8* @c_fetch_pointer_from_offset(i32 %133)
  %135 = call i1 @c_isTaintedPointerToTaintedMem(i8* %134)
  br i1 %135, label %_Dynamic_check.succeeded84, label %_Dynamic_check.failed83

_Dynamic_check.succeeded84:                       ; preds = %_Dynamic_check.succeeded81
  %136 = bitcast i8* %134 to %Tstruct.Spl_json_array_t_t*
  %items85 = getelementptr inbounds %Tstruct.Spl_json_array_t_t, %Tstruct.Spl_json_array_t_t* %136, i32 0, i32 1
  %items86 = bitcast i32* %items85 to %Tstruct.Spl_json_value_t_t***
  %137 = bitcast %Tstruct.json_value_t_t** %131 to %Tstruct.Spl_json_value_t_t**
  %138 = ptrtoint %Tstruct.Spl_json_value_t_t** %137 to i32
  %139 = bitcast %Tstruct.Spl_json_value_t_t*** %items86 to i32*
